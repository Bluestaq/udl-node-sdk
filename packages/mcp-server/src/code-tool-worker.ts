...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: Unifieddatalibrary)`
    : `const run: (${functionSource.client}: Unifieddatalibrary) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.closelyspacedobjects.count',
    'client.closelyspacedobjects.create',
    'client.closelyspacedobjects.createBulk',
    'client.closelyspacedobjects.list',
    'client.closelyspacedobjects.queryHelp',
    'client.closelyspacedobjects.retrieve',
    'client.closelyspacedobjects.tuple',
    'client.closelyspacedobjects.unvalidatedPublish',
    'client.closelyspacedobjects.history.aodr',
    'client.closelyspacedobjects.history.count',
    'client.closelyspacedobjects.history.list',
