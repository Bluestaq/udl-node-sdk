...
export const metadata: Metadata = {
  ...
  operationId: 'filedrop_udl_emireport_post_id',
};

export const tool: Tool = {
  name: 'unvalidated_publish_emireport',
  description:
    'Service operation to take multiple EMIReport records as a POST body and ingest into the database. This operation is intended to be used for automated feeds into UDL. A specific role is required to perform this service operation. Please contact the UDL team for assistance.\n',
  inputSchema: {
    type: 'object',
    properties: {
      body: {
        ...
        items: {
          ...
          properties: {
            ...
            idOnOrbit: {
              type: 'string',
              description:
                'Unique identifier of the affected on-orbit object. For the public catalog, the idOnOrbit is typically the satellite number as a string, but may be a UUID for analyst or other unknown or untracked satellites.',
            },
            intercept: {
              type: 'boolean',
              description:
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.emireport.unvalidatedPublish(body).asResponse();
