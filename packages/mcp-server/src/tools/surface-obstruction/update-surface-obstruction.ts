...
export const tool: Tool = {
  name: 'update_surface_obstruction',
  description:
  ...
  inputSchema: {
    ...
    required: ['path_id', 'classificationMarking', 'dataMode', 'idSurface', 'source'],
  },
  annotations: {
    idempotentHint: true,
  },
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.surfaceObstruction.update(id, body).asResponse();
