...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['path_id', 'classificationMarking', 'dataMode', 'idEngine', 'source'],
  },
  annotations: {
    idempotentHint: true,
  },
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.engineDetails.update(id, body).asResponse();
