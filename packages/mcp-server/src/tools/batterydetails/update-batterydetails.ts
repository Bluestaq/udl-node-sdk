...
export const tool: Tool = {
  name: 'update_batterydetails',
  description:
    'Service operation to update a single BatteryDetails. A Battery record may have multiple details records from several sources. A specific role is required to perform this service operation. Please contact the UDL team for assistance.',
  inputSchema: {
    type: 'object',
    properties: {
      path_id: {
    ...
    required: ['path_id', 'classificationMarking', 'dataMode', 'idBattery', 'source'],
  },
  annotations: {
    idempotentHint: true,
  },
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.batterydetails.update(id, body).asResponse();
