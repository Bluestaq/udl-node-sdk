...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/udl/video/getPlayerStreamingInfo',
};

export const tool: Tool = {
  name: 'get_player_streaming_info_video',
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.video.getPlayerStreamingInfo(body));
};
