...
export const tool: Tool = {
  name: 'update_mission_assignment',
  description:
  ...
  inputSchema: {
    ...
    required: ['path_id', 'classificationMarking', 'dataMode', 'mad', 'source', 'ts'],
  },
  annotations: {
    idempotentHint: true,
  },
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.missionAssignment.update(id, body).asResponse();
