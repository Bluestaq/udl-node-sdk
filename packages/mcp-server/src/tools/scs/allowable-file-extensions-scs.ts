...
export const tool: Tool = {
  ...
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nReturns a list of the allowed filename extensions.\n\n# Response Schema\n```json\n{\n  $ref: '#/$defs/sc_allowable_file_extensions_response',\n  $defs: {\n    sc_allowable_file_extensions_response: {\n      type: 'array',\n      items: {\n        type: 'string'\n      }\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      jq_filter: {
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await maybeFilter(jq_filter, await client.scs.allowableFileExtensions()));
  } catch (error) {
