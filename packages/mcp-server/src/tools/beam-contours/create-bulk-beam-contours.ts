...
export const tool: Tool = {
  name: 'create_bulk_beam_contours',
  description:
    ...
    properties: {
      body: {
        ...
        items: {
          ...
          required: ['classificationMarking', 'dataMode', 'idBeam', 'source', 'type'],
        },
      },
      jq_filter: {
        type: 'string',
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.beamContours.createBulk(body).asResponse();
