...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['path_id', 'classificationMarking', 'dataMode', 'rptCreatedTime', 'source'],
    $defs: {
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.logisticsSupport.update(id, body).asResponse();
