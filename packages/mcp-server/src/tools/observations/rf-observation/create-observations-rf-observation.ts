...
export const tool: Tool = {
  name: 'create_observations_rf_observation',
  description:
  ...
  inputSchema: {
    ...
    properties: {
      ...
      spectrumAnalyzerPower: {
        type: 'number',
        description: 'Measured spectrum analyzer power of the center carrier frequency in decibel watts.',
      },
      startFrequency: {
        type: 'number',
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.observations.rfObservation.create(body).asResponse();
