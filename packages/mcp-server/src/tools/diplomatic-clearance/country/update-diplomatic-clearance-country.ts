...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['path_id', 'classificationMarking', 'countryCode', 'dataMode', 'lastChangedDate', 'source'],
  },
  annotations: {
    idempotentHint: true,
  },
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.diplomaticClearance.country.update(id, body).asResponse();
