...
export const tool: Tool = {
  name: 'unvalidated_publish_diplomatic_clearance_country',
  description:
    ...
    properties: {
      body: {
        ...
        items: {
          ...
          required: ['classificationMarking', 'countryCode', 'dataMode', 'lastChangedDate', 'source'],
        },
      },
    },
    required: ['body'],
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.diplomaticClearance.country.unvalidatedPublish(body).asResponse();
