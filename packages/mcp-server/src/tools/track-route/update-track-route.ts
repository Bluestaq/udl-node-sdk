...
export const tool: Tool = {
  name: 'update_track_route',
  description:
    'Service operation to update a single trackroute record. A specific role is required to perform this service operation. Please contact the UDL team for assistance.',
  inputSchema: {
    type: 'object',
    properties: {
      path_id: {
    ...
    required: ['path_id', 'classificationMarking', 'dataMode', 'lastUpdateDate', 'source', 'type'],
  },
  annotations: {
    idempotentHint: true,
  },
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.trackRoute.update(id, body).asResponse();
