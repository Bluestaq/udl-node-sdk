...
export const tool: Tool = {
  name: 'unvalidated_publish_collect_responses',
  description:
    ...
    properties: {
      body: {
        ...
        items: {
          ...
          required: ['classificationMarking', 'dataMode', 'idRequest', 'source'],
        },
      },
      jq_filter: {
        type: 'string',
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.collectResponses.unvalidatedPublish(body).asResponse();
