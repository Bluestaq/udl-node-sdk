...
export const tool: Tool = {
  name: 'update_rf_emitter_staging',
  description:
    'Service operation to update a single RFEmitterStaging record. A specific role is required to perform this service operation. Please contact the UDL team for assistance.',
  inputSchema: {
    type: 'object',
    properties: {
      path_id: {
    ...
    required: ['path_id', 'classificationMarking', 'name', 'source'],
  },
  annotations: {
    idempotentHint: true,
  },
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.rfEmitter.staging.update(id, body).asResponse();
