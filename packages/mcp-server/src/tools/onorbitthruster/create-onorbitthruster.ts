...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['classificationMarking', 'dataMode', 'idEngine', 'idOnOrbit', 'source'],
    $defs: {
      engine_ingest: {
        type: 'object',
        description:
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.onorbitthruster.create(body).asResponse();
