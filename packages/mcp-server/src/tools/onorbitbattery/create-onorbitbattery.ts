...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['classificationMarking', 'dataMode', 'idBattery', 'idOnOrbit', 'source'],
    $defs: {
      battery_ingest: {
        type: 'object',
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.onorbitbattery.create(body).asResponse();
