...
export const tool: Tool = {
  name: 'unvalidated_publish_air_operations_airspace_control_orders',
  description:
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.airOperations.airspaceControlOrders.unvalidatedPublish(body).asResponse();
