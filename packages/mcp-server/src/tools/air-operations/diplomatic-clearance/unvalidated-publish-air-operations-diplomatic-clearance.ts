...
export const tool: Tool = {
  name: 'unvalidated_publish_air_operations_diplomatic_clearance',
  description:
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.airOperations.diplomaticClearance.unvalidatedPublish(body).asResponse();
