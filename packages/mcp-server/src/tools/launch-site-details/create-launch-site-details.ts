...
export const tool: Tool = {
  name: 'create_launch_site_details',
  description:
  ...
  inputSchema: {
    ...
    required: ['classificationMarking', 'dataMode', 'idLaunchSite', 'source'],
    $defs: {
      location_ingest: {
        type: 'object',
        description:
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.launchSiteDetails.create(body).asResponse();
