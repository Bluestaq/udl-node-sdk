...
export const tool: Tool = {
  name: 'update_aircraft_status_remarks',
  description:
  ...
  inputSchema: {
    ...
    required: ['path_id', 'classificationMarking', 'dataMode', 'idAircraftStatus', 'source', 'text'],
  },
  annotations: {
    idempotentHint: true,
  },
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.aircraftStatusRemarks.update(id, body).asResponse();
