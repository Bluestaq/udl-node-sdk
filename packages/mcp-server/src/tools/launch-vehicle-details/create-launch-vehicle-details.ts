...
export const tool: Tool = {
  name: 'create_launch_vehicle_details',
  description:
  ...
  inputSchema: {
    ...
    required: ['classificationMarking', 'dataMode', 'idLaunchVehicle', 'source'],
  },
};

export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  const body = args as any;
  const response = await client.launchVehicleDetails.create(body).asResponse();
