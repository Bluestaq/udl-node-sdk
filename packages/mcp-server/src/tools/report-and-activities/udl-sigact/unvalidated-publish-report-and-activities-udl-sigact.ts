...
export const tool: Tool = {
  name: 'unvalidated_publish_report_and_activities_udl_sigact',
  description:
    ...
    properties: {
      body: {
        ...
        items: {
          ...
          required: ['classificationMarking', 'dataMode', 'reportDate', 'source'],
        },
      },
    },
    required: ['body'],
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.reportAndActivities.udlSigact.unvalidatedPublish(body).asResponse();
