...
export const tool: Tool = {
  name: 'create_link_status_datalink',
  description:
  ...
  inputSchema: {
    ...
    properties: {
      ...
      multiDuty: {
        ...
        items: {
          ...
          properties: {
            ...
            rank: {
              type: 'string',
              description: 'The rank or position of the person to be contacted for multilink coordination.',
            },
            unitDes: {
              type: 'string',
              description:
      ...
      pocCallSign: {
        type: 'string',
        description: 'The unit identifier or call sign of the point of contact for this data link message.',
      },
      pocLat: {
        type: 'number',
        description:
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.linkStatus.datalink.create(body).asResponse();
