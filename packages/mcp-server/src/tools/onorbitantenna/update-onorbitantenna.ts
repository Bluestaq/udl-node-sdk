...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['path_id', 'classificationMarking', 'dataMode', 'idAntenna', 'idOnOrbit', 'source'],
    $defs: {
      antenna_ingest: {
        type: 'object',
        description:
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.onorbitantenna.update(id, body).asResponse();
