...
export const tool: Tool = {
  name: 'update_rf_band',
  description:
    'Service operation to update a single RFBand record. A specific role is required to perform this service operation. Please contact the UDL team for assistance.',
  inputSchema: {
    type: 'object',
    properties: {
      path_id: {
    ...
    required: ['path_id', 'classificationMarking', 'dataMode', 'idEntity', 'name', 'source'],
  },
  annotations: {
    idempotentHint: true,
  },
