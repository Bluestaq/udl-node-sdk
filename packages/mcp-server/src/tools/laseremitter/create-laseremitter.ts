...
export const tool: Tool = {
  name: 'create_laseremitter',
  description:
    'Service operation to take a single LaserEmitter record as a POST body and ingest into the database. A specific role is required to perform this service operation. Please contact the UDL team for assistance.',
  inputSchema: {
    type: 'object',
    properties: {
    ...
    required: ['classificationMarking', 'dataMode', 'laserName', 'laserType', 'source'],
    $defs: {
      entity_ingest: {
        type: 'object',
        description:
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.laseremitter.create(body).asResponse();
