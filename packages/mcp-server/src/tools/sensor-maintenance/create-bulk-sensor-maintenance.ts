...
export const tool: Tool = {
  name: 'create_bulk_sensor_maintenance',
  description:
  ...
  inputSchema: {
    ...
    properties: {
      ...
      origin: {
        type: 'string',
        description: 'Origin of the SensorMaintenance data.',
      },
      source: {
        type: 'string',
        description: 'Source of the SensorMaintenance data.',
      },
      jq_filter: {
        type: 'string',
        title: 'jq Filter',
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.sensorMaintenance.createBulk(body).asResponse();
