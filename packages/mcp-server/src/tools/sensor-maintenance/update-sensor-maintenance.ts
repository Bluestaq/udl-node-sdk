...
export const tool: Tool = {
  name: 'update_sensor_maintenance',
  description:
  ...
  inputSchema: {
    ...
    required: ['path_id', 'classificationMarking', 'dataMode', 'endTime', 'siteCode', 'source', 'startTime'],
  },
  annotations: {
    idempotentHint: true,
  },
...
export const handler = async (client: Unifieddatalibrary, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.sensorMaintenance.update(id, body).asResponse();
