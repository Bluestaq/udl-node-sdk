...
export class Sensorobservationtype extends APIResource {
  list(options?: Core.RequestOptions): Core.APIPromise<SensorobservationtypeListResponse> {
    return this._client.get('/udl/sensorobservationtype', options);
  }

  get(id: string, options?: Core.RequestOptions): Core.APIPromise<SensorobservationtypeGetResponse> {
    return this._client.get(`/udl/sensorobservationtype/${id}`, options);
  }
