...
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/tdoa-fdoa/diffofarrival/history';
import {
  History,
  HistoryAodrParams,
  HistoryListParams,
} from 'bluestaq@unified-data-library/resources/tdoa-fdoa/diffofarrival/history';
