 ...
 */
export interface MissileTrackFull {
  /**
   ...
   */
  vectors?: Array<MissileTrackFull.Vector>;
}

export namespace MissileTrackFull {
  /**
...
export declare namespace History {
  export { type MissileTrackFull as MissileTrackFull };
}
