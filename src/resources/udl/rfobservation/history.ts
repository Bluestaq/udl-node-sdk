...
export type RfobservationdetailsFullsOffsetPage = OffsetPage<RfobservationdetailsFull>;
 ...
 * frequencies[0]).
 */
export interface RfobservationdetailsFull {
  /**
...
export declare namespace History {
  export { type RfobservationdetailsFull as RfobservationdetailsFull };
}
