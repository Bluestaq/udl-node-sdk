...
export type ManeuverFullsOffsetPage = OffsetPage<ManeuverFull>;
...
export interface ManeuverFull {
   ...
   */
  postEventElset?: ManeuverFull.PostEventElset;
   ...
   * provider.
   */
  postEventStateVector?: ManeuverFull.PostEventStateVector;
   ...
   * consists of identification data, the classical elements and drag parameters.
   */
  preEventElset?: ManeuverFull.PreEventElset;
   ...
   * provider.
   */
  preEventStateVector?: ManeuverFull.PreEventStateVector;
