...
export class Navigationalobstruction extends APIResource {
   ...
   * for assistance.
   */
  update(params: NavigationalobstructionUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/navigationalobstruction/${path_id}`, {
...
export interface NavigationalobstructionUpdateParams {
  /**
   * Path param: The ID of the navigational obstruction to update.
   */
  path_id: string;
  ...
  /**
   * Body param: Start date of this obstruction data set's currency, in ISO 8601
   * date-only format.
   */
  cycleDate: string;
  ...
  /**
   * Body param: The ID of this obstacle.
   */
  obstacleId: string;

  /**
   * Body param: Type of obstacle (e.g. P for point, V for vector, L for line).
   */
  obstacleType: string;
  ...
  /**
   * Body param: Indicates if this obstacle record is Active (A) or Deleted (D).
   */
  actDelCode?: string;

  /**
   * Body param: The Aeronautical Information Regulation and Control (AIRAC) cycle of
   * this obstruction data set. The format is YYNN where YY is the last two digits of
   * the year and NN is the cycle number.
   */
  airacCycle?: number;

  /**
   * Body param: The baseline Aeronautical Information Regulation and Control (AIRAC)
   * cycle for change sets only. The format is YYNN where YY is the last two digits
   * of the year and NN is the cycle number.
   */
  baseAiracCycle?: number;

  /**
   * Body param: Earliest record date possible in this obstruction data set (not the
   * earliest data item), in ISO 8601 date-only format (e.g. YYYY-MM-DD). If null,
   * this data set is assumed to be a full data pull of holdings until the
   * cutoffDate. If this field is populated, this data set only contains updates
   * since the last baseline data set.
   */
  baselineCutoffDate?: string;

  /**
   * Body param: WGS-84 latitude of the northeastern boundary for obstructions
   * contained in this data set, in degrees. -90 to 90 degrees (negative values south
   * of equator).
   */
  boundNELat?: number;

  /**
   * Body param: WGS-84 longitude of the northeastern boundary for obstructions
   * contained in this data set, in degrees. -180 to 180 degrees (negative values
   * west of Prime Meridian).
   */
  boundNELon?: number;

  /**
   * Body param: WGS-84 latitude of the southwestern boundary for obstructions
   * contained in this data set, in degrees. -90 to 90 degrees (negative values south
   * of equator).
   */
  boundSWLat?: number;
  ...
  /**
   * Body param: WGS-84 longitude of the southwestern boundary for obstructions
   * contained in this data set, in degrees. -180 to 180 degrees (negative values
   * west of Prime Meridian).
   */
  boundSWLon?: number;
  ...
  /**
   * Body param: The DoD Standard Country Code designator for the country issuing the
   * diplomatic clearance. This field will be set to "OTHR" if the source value does
   * not match a UDL Country code value (ISO-3166-ALPHA-2).
   */
  countryCode?: string;

  /**
   * Body param: Latest record date possible in this obstruction data set (not the
   * most recent data item), in ISO 8601 date-only format (e.g. YYYY-MM-DD).
   */
  cutoffDate?: string;

  /**
   * Body param: Remarks concerning this obstruction's data set.
   */
  dataSetRemarks?: string;

  /**
   * Body param: The organization that deleted this obstacle record.
   */
  deletingOrg?: string;

  /**
   * Body param: The organization that entered obstacle data other than the producer.
   */
  derivingOrg?: string;

  /**
   * Body param: The side or sides of this obstruction feature which produces the
   * greatest reflectivity potential.
   */
  directivityCode?: number;

  /**
   * Body param: The elevation at the point obstacle's location in feet.
   */
  elevation?: number;

  /**
   * Body param: The difference between the assigned elevation of this point and its
   * true elevation, in feet.
   */
  elevationAcc?: number;

  /**
   * Body param: Optional obstacle ID from external systems. This field has no
  ...
  /**
   * Body param: FACC (Feature and Attribute Coding Catalog) is a five-character code
   * for encoding real-world entities and objects. The first letter of the code is an
   * alphabetic value from "A" to "Z" which will map to a feature category. The
   * second character will map to a subcategory. Characters three to five are numeric
   * and range from 000 to 999. This value will provide a unit feature type
   * identification within the categories.
  ...
  /**
   * Body param: Identifying code for the type of this point obstacle.
   */
  featureCode?: string;

  /**
   * Body param: Description of this obstacle, corresponding to the FACC (Feature and
   * Attribute Coding Catalog) value.
   */
  featureDescription?: string;

  /**
   * Body param: Type name of point obstacle.
   */
  featureName?: string;
  ...
  /**
   * Body param: The height Above Ground Level (AGL) of the point obstacle in feet.
   */
  heightAGL?: number;

  /**
   * Body param: The accuracy of the height Above Ground Level (AGL) AGL value for
   * this point obstacle in feet.
   */
  heightAGLAcc?: number;

  /**
   * Body param: The height Above Mean Sea Level (AMSL) of the point obstacle in
   * feet.
   */
  heightMSL?: number;

  /**
   * Body param: The accuracy of the height Above Mean Sea Level (AMSL) value for
   * this point obstacle in feet.
   */
  heightMSLAcc?: number;

  /**
   * Body param: The difference between the recorded horizontal coordinates of this
   * point obstacle and its true position, in feet.
   */
  horizAcc?: number;

  /**
   * Body param: Code representing the mathematical model of Earth used to calculate
   * coordinates for this obstacle (e.g. WGS-84, U for undetermined, etc.). US Forces
   * use the World Geodetic System 1984 (WGS-84), but also use maps by allied
   * countries with local datums.
   */
  horizDatumCode?: string;

  /**
   * Body param: Date this obstacle was initially added to the data set, in ISO 8601
   * date-only format (ex. YYYY-MM-DD).
   */
  initRecordDate?: string;

  /**
   * Body param: This field provides an array of keys that can be added to any
   * obstruction feature to provide information that is not already supported. The
   * entries in this array must correspond to the position index in the values array.
   * This array must be the same length as values.
   */
  keys?: Array<string>;

  /**
   * Body param: Code specifying if this obstacle is lit (e.g. Y = Yes, N = No, U =
   * Unknown).
   */
  lightingCode?: string;

  /**
   * Body param: WGS-84 latitude of the northeastern point of the line, in degrees.
   * -90 to 90 degrees (negative values south of equator).
   */
  lineNELat?: number;

  /**
   * Body param: WGS-84 longitude of the northeastern point of the line, in degrees.
   * -180 to 180 degrees (negative values west of Prime Meridian).
   */
  lineNELon?: number;

  /**
   * Body param: The name of the line file associated with this obstruction data set.
   */
  linesFilename?: string;

  /**
   * Body param: WGS-84 latitude of the southwestern point of the line, in degrees.
   * -90 to 90 degrees (negative values south of equator).
   */
  lineSWLat?: number;

  /**
   * Body param: WGS-84 longitude of the southwestern point of the line, in degrees.
   * -180 to 180 degrees (negative values west of Prime Meridian).
   */
  lineSWLon?: number;

  /**
   * Body param: The minimum height Above Ground Level (AGL) of the shortest
   * obstruction contained in this data set, in feet.
   */
  minHeightAGL?: number;

  /**
   * Body param: Indicates if the feature has multiple obstructions (e.g. S = Single,
   * M = Multiple, U = Undetermined).
   */
  multObs?: string;

  /**
   * Body param: The date after which this obstruction data set’s currency is stale
   * and should be refreshed, in ISO 8601 date-only format (e.g. YYYY-MM-DD).
   */
  nextCycleDate?: string;

  /**
   * Body param: The number of line features associated with this obstruction data
   * set.
   */
  numLines?: number;

  /**
   * Body param: Indicates the number of obstructions associated with a feature.
   */
  numObs?: number;

  /**
   * Body param: The number of point features associated with this obstruction data
   * set.
   */
  numPoints?: number;

  /**
   * Body param: Remarks regarding this obstacle.
   */
  obstacleRemarks?: string;

  /**
   * Body param: The original ID for this obstacle.
   */
  origId?: string;
  ...
  /**
   * Body param: The DoD Standard Country Code designator for the country or
   * political entity that owns the data set associated with this obstruction. This
   * field will be set to "OTHR" if the source value does not match a UDL Country
   * code value (ISO-3166-ALPHA-2).
   */
  ownerCountryCode?: string;

  /**
   * Body param: WGS-84 latitude of this point obstacle, in degrees. -90 to 90
   * degrees (negative values south of equator).
   */
  pointLat?: number;

  /**
   * Body param: WGS-84 longitude of this point obstacle, in degrees. -180 to 180
   * degrees (negative values west of Prime Meridian).
   */
  pointLon?: number;

  /**
   * Body param: The name of the point file associated with this obstruction data
   * set.
   */
  pointsFilename?: string;

  /**
   * Body param: Code denoting the action, review, or process that updated this
   * obstacle.
   */
  processCode?: string;

  /**
   * Body param: Name of the agency that produced this obstruction data set.
   */
  producer?: string;

  /**
   * Body param: The Federal Information Processing Standards (FIPS) state/province
   * numeric code of this obstacle's location.
   */
  provinceCode?: string;

  /**
   * Body param: When horizontal and/or vertical accuracy requirements cannot be met
   * because of inadequate source material, this code indicates the quality of the
   * data.
   */
  quality?: string;

  /**
   * Body param: Date this obstacle data was revised, in ISO 8601 date-only format
   * (ex. YYYY-MM-DD).
   */
  revDate?: string;

  /**
   * Body param: ID of the end point of a line segment.
   */
  segEndPoint?: number;

  /**
   * Body param: Identifies the sequence number of a line segment.
   */
  segNum?: number;

  /**
   * Body param: ID of the starting point of a line segment.
   */
  segStartPoint?: number;

  /**
   * Body param: Source date of this obstacle data, in ISO 8601 date-only format (ex.
   * YYYY-MM-DD).
   */
  sourceDate?: string;

  /**
   * Body param: The surface material composition code of this point obstacle.
   */
  surfaceMatCode?: string;

  /**
   * Body param: The transaction type/code for this obstacle (e.g. "D", "N", "R",
   * "S", "V", "X").
   */
  transactionCode?: string;

  /**
   * Body param: Method used to confirm the existence of this obstacle.
   */
  validationCode?: number;

  /**
   * Body param: This field provides an array of values that can be added to any
   * obstruction feature to provide information that is not already supported. The
  ...
  /**
   * Body param: The name of the vector file associated with this obstruction data
   * set.
   */
  vectorsFilename?: string;

  /**
   * Body param: The World Aeronautical Chart (WAC) identifier for the area in which
   * this obstacle is located.
   */
  wac?: string;

  /**
   * Body param: This obstacle's World Area Code installation number (WAC-INNR).
   */
  wacINNR?: string;
}
