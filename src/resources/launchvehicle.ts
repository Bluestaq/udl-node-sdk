...
export class Launchvehicle extends APIResource {
   ...
   */
  update(params: LaunchvehicleUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/launchvehicle/${path_id}`, {
...
export interface LaunchvehicleUpdateParams {
  /**
   * Path param: The ID of the LaunchVehicle to update.
   */
  path_id: string;
  ...
  /**
   * Body param: Launch vehicle name.
   */
  name: string;
