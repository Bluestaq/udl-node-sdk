...
export class Solararraydetails extends APIResource {
   ...
   * sources.
   */
  update(params: SolararraydetailUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/solararraydetails/${path_id}`, {
   ...
   */
  get(id: string, options?: Core.RequestOptions): Core.APIPromise<SolararraydetailGetResponse> {
 ...
 * SolarArray may have multiple details records compiled by various sources.
 */
export interface SolararraydetailGetResponse {
  /**
   * Classification marking of the data in IC/CAPCO Portion-marked format.
   */
  classificationMarking: string;
   ...
   */
  manufacturerOrg?: SolararraydetailGetResponse.ManufacturerOrg;
...
export namespace SolararraydetailGetResponse {
  /**
   * An organization such as a corporation, manufacturer, consortium, government,
   * etc. An organization may have parent and child organizations as well as link to
   * a former organization if this org previously existed as another organization.
...
export interface SolararraydetailUpdateParams {
  /**
   * Path param: The ID of the SolarArrayDetails to update.
   */
  path_id: string;
  ...
  /**
   * Body param: Unique identifier of the parent SolarArray.
   */
  idSolarArray: string;
  ...
  /**
   * Body param: Solar Array area in square meters.
   */
  area?: number;

  /**
   * Body param: Solar array description/notes.
   */
  description?: string;

  /**
   * Body param: Solar array junction technology (e.g. Triple).
   */
  junctionTechnology?: string;

  /**
   * Body param: Unique identifier of the organization that manufactures the solar
   * array.
   */
  manufacturerOrgId?: string;
  ...
  /**
   * Body param: Solar Array span in meters.
   */
  span?: number;
  ...
  /**
   * Body param: Solar array technology (e.g. Ga-As).
   */
  technology?: string;

  /**
   * Body param: Type of solar array (e.g. U Shaped).
   */
  type?: string;
}
