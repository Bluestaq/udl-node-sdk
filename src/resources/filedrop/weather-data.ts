...
export type WeatherDataCreateParams = Array<WeatherDataCreateParams.Body>;

export namespace WeatherDataCreateParams {
  /**
...
export declare namespace WeatherData {
  export { type WeatherDataCreateParams as WeatherDataCreateParams };
}
