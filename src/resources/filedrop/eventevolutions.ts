...
export type EventevolutionCreateParams = Array<EventevolutionCreateParams.Body>;

export namespace EventevolutionCreateParams {
  /**
...
export declare namespace Eventevolutions {
  export { type EventevolutionCreateParams as EventevolutionCreateParams };
}
