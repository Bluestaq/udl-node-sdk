...
export type FlightplanCreateParams = Array<FlightplanCreateParams.Body>;
...
export declare namespace Flightplans {
  export { type FlightplanCreateParams as FlightplanCreateParams };
}
