...
export class Gnssrawif extends APIResource {
   ...
   */
  create(body: GnssrawifCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
...
export interface GnssrawifCreateParams {
  /**
...
export declare namespace Gnssrawif {
  export { type GnssrawifCreateParams as GnssrawifCreateParams };
}
