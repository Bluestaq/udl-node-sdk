...
export class Ephemeris extends APIResource {
   ...
   * </h3>
   */
  create(body: EphemerisCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
...
export interface EphemerisCreateParams {
   ...
   */
  ephemerisList?: Array<EphemerisCreateParams.EphemerisList>;
...
export namespace EphemerisCreateParams {
  /**
...
export declare namespace Ephemeris {
  export { type EphemerisCreateParams as EphemerisCreateParams };
}
