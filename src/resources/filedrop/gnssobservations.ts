...
export class Gnssobservations extends APIResource {
   ...
   */
  create(body: GnssobservationCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
...
export type GnssobservationCreateParams = Array<GnssobservationCreateParams.Body>;

export namespace GnssobservationCreateParams {
  /**
...
export declare namespace Gnssobservations {
  export { type GnssobservationCreateParams as GnssobservationCreateParams };
}
