...
export class OrbitTrack extends APIResource {
   ...
   */
  create(body: OrbitTrackCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
...
export type OrbitTrackCreateParams = Array<OrbitTrackCreateParams.Body>;

export namespace OrbitTrackCreateParams {
  /**
...
export declare namespace OrbitTrack {
  export { type OrbitTrackCreateParams as OrbitTrackCreateParams };
}
