...
export class Mti extends APIResource {
   ...
   */
  create(body: MtiCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
...
export type MtiCreateParams = Array<MtiCreateParams.Body>;

export namespace MtiCreateParams {
  /**
...
export declare namespace Mti {
  export { type MtiCreateParams as MtiCreateParams };
}
