...
export class StateVectors extends APIResource {
  /**
...
export type StateVectorCreateParams = Array<StateVectorCreateParams.Body>;

export namespace StateVectorCreateParams {
  /**
...
export declare namespace StateVectors {
  export { type StateVectorCreateParams as StateVectorCreateParams };
}
