...
export class Eo extends APIResource {
   ...
   */
  create(body: EoCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
...
export type EoCreateParams = Array<EoCreateParams.Body>;

export namespace EoCreateParams {
  /**
...
export declare namespace Eo {
  export { type EoCreateParams as EoCreateParams };
}
