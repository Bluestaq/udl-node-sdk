...
export class PassiveRadar extends APIResource {
  /**
   ...
   */
  create(body: PassiveRadarCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
...
export type PassiveRadarCreateParams = Array<PassiveRadarCreateParams.Body>;

export namespace PassiveRadarCreateParams {
  /**
...
export declare namespace PassiveRadar {
  export { type PassiveRadarCreateParams as PassiveRadarCreateParams };
}
