...
export class Rf extends APIResource {
  /**
   ...
   */
  create(body: RfCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
...
export type RfCreateParams = Array<RfCreateParams.Body>;

export namespace RfCreateParams {
  /**
...
export declare namespace Rf {
  export { type RfCreateParams as RfCreateParams };
}
