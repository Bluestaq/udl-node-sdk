...
export class Radar extends APIResource {
   ...
   */
  create(body: RadarCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
...
export type RadarCreateParams = Array<RadarCreateParams.Body>;

export namespace RadarCreateParams {
  /**
...
export declare namespace Radar {
  export { type RadarCreateParams as RadarCreateParams };
}
