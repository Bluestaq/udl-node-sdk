...
export class WeatherReports extends APIResource {
  /**
...
export type WeatherReportCreateParams = Array<WeatherReportCreateParams.Body>;

export namespace WeatherReportCreateParams {
  /**
...
export declare namespace WeatherReports {
  export { type WeatherReportCreateParams as WeatherReportCreateParams };
}
