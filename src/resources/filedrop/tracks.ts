...
export class Tracks extends APIResource {
   ...
   */
  create(body: TrackCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
...
export type TrackCreateParams = Array<TrackCreateParams.Body>;

export namespace TrackCreateParams {
  /**
...
export declare namespace Tracks {
  export { type TrackCreateParams as TrackCreateParams };
}
