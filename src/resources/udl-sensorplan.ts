...
export class UdlSensorplan extends APIResource {
  /**
   ...
   */
  create(body: UdlSensorplanCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
...
export type UdlSensorplanCreateParams = Array<UdlSensorplanCreateParams.Body>;

export namespace UdlSensorplanCreateParams {
  /**
...
export declare namespace UdlSensorplan {
  export { type UdlSensorplanCreateParams as UdlSensorplanCreateParams };
}
