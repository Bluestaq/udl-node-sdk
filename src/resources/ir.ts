...
export class Ir extends APIResource {
   ...
   */
  update(params: IrUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/ir/${path_id}`, {
...
export namespace IrCreateParams {
  /**
   * An entity is a generic representation of any object within a space/SSA system
   * such as sensors, on-orbit objects, RF Emitters, space craft buses, etc. An
   * entity can have an operating unit, a location (if terrestrial), and statuses.
...
export interface IrUpdateParams {
  /**
   * Path param: The ID of the IR to update.
   */
  path_id: string;
  ...
  /**
   * Body param: Name of the IR entity.
   */
  name: string;
  ...
  /**
   * Body param: Description of the IR entity.
   */
  description?: string;
   ...
   * and statuses.
   */
  entity?: IrUpdateParams.Entity;

  /**
   * Body param: ID of the parent entity for this IR.
   */
  idEntity?: string;
...
export namespace IrUpdateParams {
  /**
   * An entity is a generic representation of any object within a space/SSA system
   * such as sensors, on-orbit objects, RF Emitters, space craft buses, etc. An
   * entity can have an operating unit, a location (if terrestrial), and statuses.
