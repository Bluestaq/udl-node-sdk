...
export type SarobservationListResponse = Array<SarobservationListResponse.SarobservationListResponseItem>;

export namespace SarobservationListResponse {
  /**
   ...
   */
  export interface SarobservationListResponseItem {
    /**
...
export type SarobservationTupleResponse = Array<SarobservationHistoryAPI.SarobservationFull>;
...
export interface SarobservationListParams {
  /**
   * Collection start time in ISO 8601 UTC format with microsecond precision.
