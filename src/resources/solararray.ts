...
export class Solararray extends APIResource {
   ...
   */
  create(body: SolararrayCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
   ...
   */
  update(params: SolararrayUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/solararray/${path_id}`, {
   ...
   */
  list(options?: Core.RequestOptions): Core.APIPromise<SolararrayListResponse> {
  ...
  delete(id: string, options?: Core.RequestOptions): Core.APIPromise<void> {
    return this._client.delete(`/udl/solararray/${id}`, {
      ...options,
      headers: { Accept: '*/*', ...options?.headers },
    });
  }
   ...
   * path parameter.
   */
  get(id: string, options?: Core.RequestOptions): Core.APIPromise<SolararrayGetResponse> {
    return this._client.get(`/udl/solararray/${id}`, options);
  }
   ...
   */
  tuple(
    query: SolararrayTupleParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<SolararrayTupleResponse> {
...
export interface SolararrayGetResponse {
   ...
   */
  solarArrayDetails?: Array<SolararrayGetResponse.SolarArrayDetail>;
...
export namespace SolararrayGetResponse {
  /**
...
export namespace SolararrayTupleResponse {
  ...
  export interface SolararrayTupleResponseItem {
     ...
     * via the /udl/solararraydetails operations.
     */
    solarArrayDetails?: Array<SolararrayTupleResponseItem.SolarArrayDetail>;
  ...
  export namespace SolararrayTupleResponseItem {
    /**
     * Model representation of Information on spacecraft SolarArrayDetails. A
     * SolarArray may have multiple details records compiled by various sources.
     */
...
export interface SolararrayUpdateParams {
  /**
   * Path param: The ID of the SolarArray to update.
   */
  path_id: string;
