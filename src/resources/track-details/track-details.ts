...
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/track-details/history';
import {
  History,
  HistoryAodrParams,
  HistoryCountParams,
...
} from 'bluestaq@unified-data-library/resources/track-details/history';
 ...
 */
export interface TrackDetailListResponse {
  /**
