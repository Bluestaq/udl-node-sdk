...
export type SigactListResponse = Array<SigactListResponse.SigactListResponseItem>;
...
export namespace SigactListResponse {
   ...
   */
  export interface SigactListResponseItem {
    /**
     ...
     */
    relatedDocs?: Array<SigactListResponseItem.RelatedDoc>;
  ...
  export namespace SigactListResponseItem {
...
export type SigactTupleResponse = Array<SigactHistoryAPI.SigactFull>;

export interface SigactListParams {
  /**
