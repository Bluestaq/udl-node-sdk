...
export class History extends APIResource {
   ...
   * ```
   */
  list(query: HistoryListParams, options?: RequestOptions): PagePromise<SortiePprFullsOffsetPage, Shared.SortiePprFull> {
    return this._client.getAPIList('/udl/sortieppr/history', OffsetPage<Shared.SortiePprFull>, { query, ...options });
  }
  ...
  aodr(query: HistoryAodrParams, options?: RequestOptions): APIPromise<void> {
    return this._client.get('/udl/sortieppr/history/aodr', { query, ...options, headers: buildHeaders([{Accept: '*/*'}, options?.headers]) });
  }
  ...
  count(query: HistoryCountParams, options?: RequestOptions): APIPromise<string> {
    return this._client.get('/udl/sortieppr/history/count', { query, ...options, headers: buildHeaders([{Accept: 'text/plain'}, options?.headers]) });
  }
}
