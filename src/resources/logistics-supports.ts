...
export type LogisticsSupportCreateParams = Array<LogisticsSupportCreateParams.Body>;
...
export declare namespace LogisticsSupports {
  export { type LogisticsSupportCreateParams as LogisticsSupportCreateParams };
}
