...
export class Objectofinterest extends APIResource {
   ...
   * assistance.
   */
  update(params: ObjectofinterestUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/objectofinterest/${path_id}`, {
...
export interface ObjectofinterestUpdateParams {
  /**
   * Path param: The ID of the ObjectOfInterest to update.
   */
  path_id: string;
  ...
  /**
   * Body param: UUID of the parent Onorbit record.
   */
  idOnOrbit: string;

  /**
   * Body param: Sensor tasking start time for object of interest.
   */
  sensorTaskingStartTime: string;
  ...
  /**
   * Body param: Time of last status change of the object of interest event.
   */
  statusDate: string;
  ...
  /**
   * Body param: Optional array of Onorbit IDs (idOnOrbit) representing satellites
   * potentially affected by this object of interest.
   */
  affectedObjects?: Array<string>;

  /**
   * Body param: Last reported apogee. The Orbit point furthest from the center of
   * the earth in kilometers.
   */
  apogee?: number;

  /**
   * Body param: Last reported argument of perigee. The argument of perigee is the
   * angle in degrees formed between the perigee and the ascending node. If the
   * perigee would occur at the ascending node, the argument of perigee would be 0.
   */
  argOfPerigee?: number;

  /**
   * Body param: Last reported drag term for SGP4 orbital model, used for calculating
   * decay constants for altitude, eccentricity etc, measured in inverse earth radii.
   */
  bStar?: number;

  /**
   * Body param: Possible delta time applications for the object of interest, in
   * seconds.
   */
  deltaTs?: Array<number>;

  /**
   * Body param: Possible delta V applications for the object of interest, in km/sec.
   */
  deltaVs?: Array<number>;

  /**
   * Body param: Description of the object of interest event.
   */
  description?: string;

  /**
   * Body param: Last reported eccentricity of the object. The orbital eccentricity
   * of an astronomical object is a parameter that determines the amount by which its
   * orbit around another body deviates from a perfect circle. A value of 0 is a
   * circular orbit, values between 0 and 1 form an elliptic orbit, 1 is a parabolic
   * escape orbit, and greater than 1 is a hyperbolic escape orbit.
   */
  eccentricity?: number;

  /**
   * Body param: Last reported elset epoch time in ISO 8601 UTC time, with
   * microsecond precision.
   */
  elsetEpoch?: string;

  /**
   * Body param: Last reported inclination of the object. Inclination is the angle
   * between the equator and the orbit when looking from the center of the Earth. If
   * the orbit went exactly around the equator from left to right, then the
   * inclination would be 0. The inclination ranges from 0 to 180 degrees.
   */
  inclination?: number;

  /**
   * Body param: Last reported observation time in ISO 8601 UTC time, with
   * microsecond precision.
   */
  lastObTime?: string;

  /**
   * Body param: Last reported meanAnomaly. Mean anomoly is where the satellite is in
   * its orbital path. The mean anomaly ranges from 0 to 360 degrees. The mean
   * anomaly is referenced to the perigee. If the satellite were at the perigee, the
   * mean anomaly would be 0.
   */
  meanAnomaly?: number;

  /**
   * Body param: Last reported mean motion of the object. Mean motion is the angular
   * speed required for a body to complete one orbit, assuming constant speed in a
   * circular orbit which completes in the same time as the variable speed,
   * elliptical orbit of the actual body. Measured in revolutions per day.
   */
  meanMotion?: number;

  /**
   * Body param: Last reported 2nd derivative of the mean motion with respect to
   * time. Units are revolutions per day cubed.
   */
  meanMotionDDot?: number;

  /**
   * Body param: Last reported 1st derivative of the mean motion with respect to
   * time. Units are revolutions per day squared.
   */
  meanMotionDot?: number;

  /**
   * Body param: The time at which an attempted observation of the object of interest
   * noticed it was missing, in ISO 8601 UTC time, with microsecond precision.
   */
  missedObTime?: string;

  /**
   * Body param: Unique name of the object of interest event.
   */
  name?: string;
  ...
  /**
   * Body param: Last reported perigee. The orbit point nearest to the center of the
   * earth in kilometers.
   */
  perigee?: number;

  /**
   * Body param: Last reported orbit period. Period of the orbit is equal to inverse
   * of mean motion.
   */
  period?: number;

  /**
   * Body param: Priority of the object of interest as an integer (1=highest
   * priority).
   */
  priority?: number;

  /**
   * Body param: Last reported raan. Right ascension of the ascending node, or RAAN
   * is the angle as measured in degrees eastwards (or, as seen from the north,
   * counterclockwise) from the First Point of Aries to the ascending node, which is
   * where the orbit crosses the equator when traveling north.
   */
  raan?: number;

  /**
   * Body param: The last reported revolution number. The value is incremented when a
   * satellite crosses the equator on an ascending pass.
   */
  revNo?: number;
  ...
  /**
   * Body param: Last reported semi major axis, which is the sum of the periapsis and
   * apoapsis distances divided by two. For circular orbits, the semimajor axis is
   * the distance between the centers of the bodies, not the distance of the bodies
   * from the center of mass.
   */
  semiMajorAxis?: number;

  /**
   * Body param: Sensor tasking stop time for object of interest.
   */
  sensorTaskingStopTime?: string;

  /**
   * Body param: Status of the object of interest event (e.g. OPEN, CLOSED,
   * CANCELLED).
   */
  status?: string;

  /**
   * Body param: Last reported state vector epoch time in ISO 8601 UTC time, with
   * microsecond precision.
   */
  svEpoch?: string;

  /**
   * Body param: Last reported x position of the object in km, in J2000 coordinates.
   */
  x?: number;

  /**
   * Body param: Last reported x velocity of the object in km/sec, in J2000
   * coordinates.
   */
  xvel?: number;

  /**
   * Body param: Last reported y position of the object in km, in J2000 coordinates.
   */
  y?: number;

  /**
   * Body param: Last reported y velocity of the object in km/sec, in J2000
   * coordinates.
   */
  yvel?: number;

  /**
   * Body param: Last reported z position of the object in km, in J2000 coordinates.
   */
  z?: number;

  /**
   * Body param: Last reported z velocity of the object in km/sec, in J2000
   * coordinates.
   */
  zvel?: number;
}
