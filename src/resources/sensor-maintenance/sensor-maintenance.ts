...
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/sensor-maintenance/history';
import {
  History,
  HistoryAodrParams,
  HistoryCountParams,
...
} from 'bluestaq@unified-data-library/resources/sensor-maintenance/history';
