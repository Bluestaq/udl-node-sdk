...
export class Launchsite extends APIResource {
   ...
   */
  update(params: LaunchsiteUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/launchsite/${path_id}`, {
...
export interface LaunchsiteUpdateParams {
  /**
   * Path param: The ID of the LaunchSite to update.
   */
  path_id: string;
  ...
  /**
   * Body param: Alternate launch site code.
   */
  altCode?: string;

  /**
   * Body param: Unique identifier of the parent site associated with this launch
   * site.
   */
  idSite?: string;
  ...
  /**
   * Body param: Abbreviated short name for the launch site.
   */
  shortCode?: string;
}
