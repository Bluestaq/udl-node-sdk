...
export class Seradataspacecraftdetails extends APIResource {
   ...
   * assistance.
   */
  update(params: SeradataspacecraftdetailUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/seradataspacecraftdetails/${path_id}`, {
...
export interface SeradataspacecraftdetailUpdateParams {
  /**
   * Path param: The ID of the SeradataSpacecraftDetails to update.
   */
  path_id: string;
  ...
  /**
   * Body param: Spacecraft additional missions and groups.
   */
  additionalMissionsGroups?: string;

  /**
   * Body param: Spacecraft latest altitude in km.
   */
  altitude?: number;

  /**
   * Body param: Annual insured depreciaion factor as a percent fraction.
   */
  annualInsuredDepreciationFactor?: number;

  /**
   * Body param: Boolean indicating if the spacecraft annualInsuredDepreciationFactor
   * is estimated.
   */
  annualInsuredDepreciationFactorEstimated?: boolean;

  /**
   * Body param: Apogee in km.
   */
  apogee?: number;

  /**
   * Body param: Spacecraft Bus ID.
   */
  busId?: string;

  /**
   * Body param: Total capability lost as a percent fraction.
   */
  capabilityLost?: number;

  /**
   * Body param: Total capacity lost as a percent fraction.
   */
  capacityLost?: number;

  /**
   * Body param: NORAD satellite number if available.
   */
  catalogNumber?: number;

  /**
   * Body param: Spacecraft collision risk 1cm sqm latest.
   */
  collisionRiskCM?: number;

  /**
   * Body param: Spacecraft collision risk 1mm sqm latest.
   */
  collisionRiskMM?: number;

  /**
   * Body param: Boolean indicating if the spacecraft combined new cost is estimated.
   */
  combinedCostEstimated?: boolean;

  /**
   * Body param: Combined cost of spacecraft at new in M USD.
   */
  combinedNewCost?: number;

  /**
   * Body param: Boolean indicating if the launch was commercial.
   */
  commercialLaunch?: boolean;

  /**
   * Body param: Spacecraft constellation.
   */
  constellation?: string;

  /**
   * Body param: Boolean indicating if the spacecraft cost is estimated.
   */
  costEstimated?: boolean;

  /**
   * Body param: Cubesat dispenser type.
   */
  cubesatDispenserType?: string;

  /**
   * Body param: Current age in years.
   */
  currentAge?: number;

  /**
   * Body param: Spacecraft date of observation.
   */
  dateOfObservation?: string;

  /**
   * Body param: Description associated with the spacecraft.
   */
  description?: string;

  /**
   * Body param: Spacecraft design life in days.
   */
  designLife?: number;

  /**
   * Body param: Mass dry in kg.
   */
  dryMass?: number;

  /**
   * Body param: Spacecraft expected life in days.
   */
  expectedLife?: number;

  /**
   * Body param: WGS84 longitude of the spacecraft’s latest GEO position, in degrees.
   * -180 to 180 degrees (negative values west of Prime Meridian).
   */
  geoPosition?: number;

  /**
   * Body param: UUID of the parent Onorbit record, if available.
   */
  idOnOrbit?: string;

  /**
   * Body param: Seradata provided inclination in degrees.
   */
  inclination?: number;

  /**
   * Body param: Spacecraft total insurance losses as a fraction.
   */
  insuranceLossesTotal?: number;

  /**
   * Body param: Insurance notes for the spacecraft.
   */
  insuranceNotes?: string;

  /**
   * Body param: Insurance premium at launch in M USD.
   */
  insurancePremiumAtLaunch?: number;

  /**
   * Body param: Boolean indicating if the spacecraft insurancePremiumAtLaunch is
   * estimated.
   */
  insurancePremiumAtLaunchEstimated?: boolean;

  /**
   * Body param: Boolean indicating if the spacecraft was insured at launch.
   */
  insuredAtLaunch?: boolean;

  /**
   * Body param: Insured value of spacecraft at launch in M USD.
   */
  insuredValueAtLaunch?: number;

  /**
   * Body param: Boolean indicating if the spacecraft insured value at launch is
   * estimated.
   */
  insuredValueLaunchEstimated?: boolean;

  /**
   * Body param: Seradata international number.
   */
  intlNumber?: string;

  /**
   * Body param: Spacecraft latest latitude in degrees.
   */
  lat?: number;

  /**
   * Body param: Spacecraft launch arranger.
   */
  launchArranger?: string;

  /**
   * Body param: Spacecraft launch arranger country.
   */
  launchArrangerCountry?: string;

  /**
   * Body param: Seradata launch characteristic (e.g. Expendable, Reusable (New),
   * etc).
   */
  launchCharacteristic?: string;

  /**
   * Body param: Cost of launch in M USD.
   */
  launchCost?: number;

  /**
   * Body param: Boolean indicating if the spacecraft launch cost is estimated.
   */
  launchCostEstimated?: boolean;

  /**
   * Body param: Seradata launch country.
   */
  launchCountry?: string;

  /**
   * Body param: Launch date.
   */
  launchDate?: string;

  /**
   * Body param: Seradata remarks on launch date.
   */
  launchDateRemarks?: string;

  /**
   * Body param: Seradata launch ID.
   */
  launchId?: string;

  /**
   * Body param: Mass at launch in kg.
   */
  launchMass?: number;
  ...
  /**
   * Body param: Seradata launch number.
   */
  launchNumber?: string;

  /**
   * Body param: Seradata launch provider.
   */
  launchProvider?: string;

  /**
   * Body param: Seradata launch provider country.
   */
  launchProviderCountry?: string;

  /**
   * Body param: Seradata launch vehicle family.
   */
  launchProviderFlightNumber?: string;

  /**
   * Body param: Seradata Launch Site ID.
   */
  launchSiteId?: string;

  /**
   * Body param: Launch Site Name.
   */
  launchSiteName?: string;

  /**
   * Body param: Seradata launch type (e.g. Launched, Future, etc).
   */
  launchType?: string;
  ...
  /**
   * Body param: Boolean indicating if the spacecraft was leased.
   */
  leased?: boolean;

  /**
   * Body param: Spacecraft life lost as a percent fraction.
   */
  lifeLost?: number;

  /**
   * Body param: Spacecraft latest longitude in degrees.
   */
  lon?: number;

  /**
   * Body param: Mass category (e.g. 2500 - 3500kg - Large Satellite, 10 - 100 kg -
   * Microsatellite, etc).
   */
  massCategory?: string;

  /**
   * Body param: Spacecraft name at launch.
   */
  nameAtLaunch?: string;

  /**
   * Body param: Cost of spacecraft at new in M USD.
   */
  newCost?: number;

  /**
   * Body param: Notes on the spacecraft.
   */
  notes?: string;

  /**
   * Body param: Number of humans carried on spacecraft.
   */
  numHumans?: number;

  /**
   * Body param: Spacecraft operator name.
   */
  operator?: string;

  /**
   * Body param: Spacecraft operator country.
   */
  operatorCountry?: string;

  /**
   * Body param: Spacecraft orbit category (e.g GEO, LEO, etc).
   */
  orbitCategory?: string;

  /**
   * Body param: Spacecraft sub orbit category (e.g LEO - Sun-synchronous,
   * Geostationary, etc).
   */
  orbitSubCategory?: string;

  /**
   * Body param: Spacecraft order date.
   */
  orderDate?: string;
  ...
  /**
   * Body param: Spacecraft owner name.
   */
  owner?: string;

  /**
   * Body param: Spacecraft owner country.
   */
  ownerCountry?: string;

  /**
   * Body param: Perigee in km.
   */
  perigee?: number;

  /**
   * Body param: Spacecraft period in minutes.
   */
  period?: number;

  /**
   * Body param: Spacecraft primary mission and group.
   */
  primaryMissionGroup?: string;

  /**
   * Body param: UUID of the prime manufacturer organization, if available.
   */
  primeManufacturerOrgId?: string;

  /**
   * Body param: Spacecraft program name.
   */
  programName?: string;

  /**
   * Body param: Spacecraft quantity.
   */
  quantity?: number;

  /**
   * Body param: Spacecraft reusable flights.
   */
  reusableFlights?: string;

  /**
   * Body param: Spacecraft reused hull name.
   */
  reusedHullName?: string;

  /**
   * Body param: Seradata sector (e.g. Commercial, Military, Civil/Other).
   */
  sector?: string;

  /**
   * Body param: Spacecraft serial number.
   */
  serialNumber?: string;

  /**
   * Body param: Spacecraft stabilizer (e.g. 3-Axis, Gravity Gradiant, etc).
   */
  stabilizer?: string;

  /**
   * Body param: Spacecraft status (e.g. Inactive - Retired, Inactive - Re-entered,
   * Active, etc).
   */
  status?: string;

  /**
   * Body param: Number of insurance claims for this spacecraft.
   */
  totalClaims?: number;

  /**
   * Body param: Number of fatalities related to this spacecraft.
   */
  totalFatalities?: number;

  /**
   * Body param: Number of injuries related to this spacecraft.
   */
  totalInjuries?: number;
  ...
  /**
   * Body param: Youtube link of launch.
   */
  youtubeLaunchLink?: string;
}
