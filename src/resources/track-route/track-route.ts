 ...
 */
export interface AltitudeBlocksIngest {
  /**
 ...
 */
export interface PointOfContactIngest {
  /**
 ...
 */
export interface RoutePointsIngest {
  /**
 ...
 */
export interface TrackRouteIngest {
  /**
   ...
   * Minimum and maximum altitude bounds for the track.
   */
  altitudeBlocks?: Array<AltitudeBlocksIngest>;
   ...
   * Point of contacts for scheduling or modifying the route.
   */
  poc?: Array<PointOfContactIngest>;
   ...
   * Points identified within the route.
   */
  routePoints?: Array<RoutePointsIngest>;
