...
export class Statevector extends APIResource {
   ...
   */
  fileCreate(body: StatevectorFileCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
...
export type StatevectorListResponse = Array<StatevectorListResponse.StatevectorListResponseItem>;

export namespace StatevectorListResponse {
  /**
   * This service provides operations for querying and manipulation of state vectors
   * for OnOrbit objects. State vectors are cartesian vectors of position (r) and
   * velocity (v) that, together with their time (epoch) (t), uniquely determine the
   ...
   * provider.
   */
  export interface StatevectorListResponseItem {
    /**
     * Classification marking of the data in IC/CAPCO Portion-marked format.
     */
    classificationMarking: string;
...
export type StatevectorCreateBulkParams = Array<StatevectorCreateBulkParams.Body>;

export namespace StatevectorCreateBulkParams {
  /**
   * This service provides operations for querying and manipulation of state vectors
   * for OnOrbit objects. State vectors are cartesian vectors of position (r) and
   * velocity (v) that, together with their time (epoch) (t), uniquely determine the
...
export type StatevectorFileCreateParams = Array<StatevectorFileCreateParams.Body>;

export namespace StatevectorFileCreateParams {
  /**
   * This service provides operations for querying and manipulation of state vectors
   * for OnOrbit objects. State vectors are cartesian vectors of position (r) and
   * velocity (v) that, together with their time (epoch) (t), uniquely determine the
