...
export type CurrentListResponse = Array<CurrentListResponse.CurrentListResponseItem>;

export namespace CurrentListResponse {
  /**
   ...
   * provider.
   */
  export interface CurrentListResponseItem {
    /**
