...
export class Status extends APIResource {
   ...
   */
  update(params: StatusUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/status/${path_id}`, {
...
export interface StatusUpdateParams {
  ...
  /**
   * Body param: Unique identifier of the parent entity.
   */
  idEntity: string;
  ...
  /**
   * Body param: Comments describing the status creation and or updates to an entity.
   */
  notes?: string;

  /**
   * Body param: Operation capability of the entity, if applicable (e.g. FMC, NMC,
   * PMC, UNK).
   */
  opsCap?: 'FMC' | 'NMC' | 'PMC' | 'UNK';
  ...
  /**
   * Body param: Overall state of the entity, if applicable (e.g. UNKNOWN, DEAD,
   * ACTIVE, RF ACTIVE, STANDBY).
   */
  state?: 'UNKNOWN' | 'DEAD' | 'ACTIVE' | 'RF ACTIVE' | 'STANDBY';
  ...
  /**
   * Body param: System capability of the entity, if applicable (e.g. FMC, NMC, PMC,
   * UNK).
   */
  sysCap?: 'FMC' | 'NMC' | 'PMC' | 'UNK';
}
