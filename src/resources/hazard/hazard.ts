...
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/hazard/history';
import {
  History,
  HistoryAodrParams,
  HistoryCountParams,
...
} from 'bluestaq@unified-data-library/resources/hazard/history';
...
export class Hazard extends APIResource {
   ...
   * for await (const hazardListResponse of client.hazard.list({
   ...
   * @example
   * ```ts
   * await client.hazard.createBulk({
   *   body: [
   *     {
   *       alarms: ['Alarm1', 'Alarm2'],
   *       alarmValues: [2.7, 2.9],
