...
export type HazardListResponse = Array<HazardListResponse.HazardListResponseItem>;

export namespace HazardListResponse {
  /**
   ...
   */
  export interface HazardListResponseItem {
    /**
...
export type HazardTupleResponse = Array<HazardHistoryAPI.HazardFull>;
