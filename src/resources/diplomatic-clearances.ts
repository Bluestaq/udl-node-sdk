...
export type DiplomaticClearanceCreateParams = Array<DiplomaticClearanceCreateParams.Body>;
...
export declare namespace DiplomaticClearances {
  export { type DiplomaticClearanceCreateParams as DiplomaticClearanceCreateParams };
}
