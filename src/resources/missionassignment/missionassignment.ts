...
export class Missionassignment extends APIResource {
   ...
   * assistance.
   */
  update(params: MissionassignmentUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/missionassignment/${path_id}`, {
...
export interface MissionassignmentUpdateParams {
  /**
   * Path param: The ID of the MissionAssignment to update.
   */
  path_id: string;
  ...
  /**
   * Body param: The mission assignment discrete value.
   */
  mad: string;
  ...
  /**
   * Body param: The timestamp of the mission data, in ISO 8601 UTC format.
   */
  ts: string;
  ...
  /**
   * Body param: TARGET POSITION CONTINUATION WORD - number of associated dmpis.
   */
  c1associateddmpis?: number;

  /**
   * Body param: TARGET DATA CONTINUATION WORD - air specific type, see TABLE B-21.
   */
  c2air?: string;

  /**
   * Body param: TARGET DATA CONTINUATION WORD - altitude, 100 FT, 2047=NS.
   */
  c2alt?: number;

  /**
   * Body param: TARGET DATA CONTINUATION WORD - course in increments of 1 degree.
   */
  c2crs?: number;

  /**
   * Body param: TARGET DATA CONTINUATION WORD - exercise indicator.
   */
  c2exerciseindicator?: string;

  /**
   * Body param: TARGET DATA CONTINUATION WORD - method of fire.
   */
  c2exercisemof?: string;

  /**
   * Body param: TARGET DATA CONTINUATION WORD - identity.
   */
  c2id?: string;

  /**
   * Body param: TARGET DATA CONTINUATION WORD - identity amplifying descriptor.
   */
  c2idamplifyingdescriptor?: string;

  /**
   * Body param: TARGET DATA CONTINUATION WORD - land specific type, see TABLE B-21.
   */
  c2lnd?: string;

  /**
   * Body param: TARGET DATA CONTINUATION WORD - space specific type, see TABLE B-39.
   */
  c2spc?: string;

  /**
   * Body param: TARGET DATA CONTINUATION WORD - speed in 2 DM/HR, 2047=NS.
   */
  c2spd?: number;

  /**
   * Body param: TARGET DATA CONTINUATION WORD - special interest indicator.
   */
  c2specialinterestindicator?: string;

  /**
   * Body param: TARGET DATA CONTINUATION WORD - surface specific type, see TABLE
   * B-21.
   */
  c2sur?: string;

  /**
   * Body param: POINT LOCATION CONTINUATION WORD - elevation, 25 FT, 1023=NS.
   */
  c3elv?: number;

  /**
   * Body param: POINT LOCATION CONTINUATION WORD - latitude, 0.0013 MINUTE.
   */
  c3lat?: number;

  /**
   * Body param: POINT LOCATION CONTINUATION WORD - longitude, 0.0013 MINUTE.
   */
  c3lon?: number;

  /**
   * Body param: TARGET DATA CONTINUATION WORD - point type 1.
   */
  c3ptl?: string;

  /**
   * Body param: TARGET DATA CONTINUATION WORD - point number.
   */
  c3ptnum?: string;

  /**
   * Body param: SURFACE ATTACK CONTINUATION WORD - minute.
   */
  c4colon?: number;

  /**
   * Body param: SURFACE ATTACK CONTINUATION WORD - target defenses.
   */
  c4def?: string;

  /**
   * Body param: SURFACE ATTACK CONTINUATION WORD - run in heading, NS=511.
   */
  c4egress?: number;

  /**
   * Body param: SURFACE ATTACK CONTINUATION WORD - mode of delivery.
   */
  c4mod?: number;

  /**
   * Body param: SURFACE ATTACK CONTINUATION WORD - number of stores, NS=63.
   */
  c4numberofstores?: number;
  ...
  /**
   * Body param: SURFACE ATTACK CONTINUATION WORD - target type - see TABLE B-32.
   */
  c4tgt?: string;

  /**
   * Body param: SURFACE ATTACK CONTINUATION WORD - time discrete.
   */
  c4timediscrete?: string;

  /**
   * Body param: SURFACE ATTACK CONTINUATION WORD - hour.
   */
  c4tm?: number;

  /**
   * Body param: SURFACE ATTACK CONTINUATION WORD - type of stores.
   */
  c4typeofstores?: number;

  /**
   * Body param: SURFACE ATTACK CONTINUATION WORD - seconds in increments of 1 sec.
   */
  c5colon?: number;

  /**
   * Body param: CONTINUATION WORD - used with c3_elv to double precision to approx 3
   * ft.
   */
  c5elevationlsbs?: number;

  /**
   * Body param: CONTINUATION WORD - hae adjustment, measured in 3.125 FT.
   */
  c5haeadj?: number;

  /**
   * Body param: CONTINUATION WORD - used with c3_lat to double precision to approx 4
   * ft.
   */
  c5latlsb?: number;

  /**
   * Body param: CONTINUATION WORD - used with c3_lon to double precision to approx 4
   * ft.
   */
  c5lonlsb?: number;

  /**
   * Body param: CONTINUATION WORD - target bearing.
   */
  c5tgtbrng?: number;

  /**
   * Body param: CONTINUATION WORD - time window.
   */
  c5tw?: number;

  /**
   * Body param: TARGETING CONTINUATION WORD - designator/seeker pulse code.
   */
  c6dspc?: string;

  /**
   * Body param: TARGETING CONTINUATION WORD - designator/seeker pulse code type.
   */
  c6dspct?: string;

  /**
   * Body param: TARGETING CONTINUATION WORD - first pulse/last pulse mode.
   */
  c6fplpm?: string;

  /**
   * Body param: TARGETING CONTINUATION WORD - index number, related, 0=NS.
   */
  c6intel?: number;

  /**
   * Body param: TARGETING CONTINUATION WORD - laser illuminator code.
   */
  c6laser?: number;

  /**
   * Body param: TARGETING CONTINUATION WORD - long pulse mode.
   */
  c6longpm?: string;

  /**
   * Body param: TARGETING CONTINUATION WORD - track number, related to 3.
   */
  c6tnr3?: number;

  /**
   * Body param: THIRD PARTY CONTINUATION WORD - elevation angle, 2.
   */
  c7elang2?: number;

  /**
   * Body param: THIRD PARTY CONTINUATION WORD - index number, third party.
   */
  c7in3p?: number;

  /**
   * Body param: THIRD PARTY CONTINUATION WORD - track number, index originator.
   */
  c7tnor?: string;
  ...
  /**
   * Body param: Index number.
   */
  index?: number;

  /**
   * Body param: WGS84 latitude, in degrees. -90 to 90 degrees (negative values south
   * of equator).
   */
  lat?: number;

  /**
   * Body param: WGS84 longitude, in degrees. -180 to 180 degrees (negative values
   * west of Prime Meridian).
   */
  lon?: number;

  /**
   * Body param: Origin of index number.
   */
  orginx?: string;
  ...
  /**
   * Body param: Receipt/Compliance, values from TABLE B-9.
   */
  rc?: string;

  /**
   * Body param: Recurrence rate, receipt/compliance.
   */
  rr?: number;
  ...
  /**
   * Body param: Track number objective.
   */
  tno?: string;

  /**
   * Body param: The track ID that the status is referencing, addressee.
   */
  trkId?: string;

  /**
   * Body param: Threat warning environment.
   */
  twenv?: string;
}
