...
export class Sortieppr extends APIResource {
   ...
   * assistance.
   */
  update(params: SortiepprUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/sortieppr/${path_id}`, {
...
export interface SortiepprUpdateParams {
  /**
   * Path param: The ID of the SortiePPR entry to update.
   */
  path_id: string;
  ...
  /**
   * Body param: Unique identifier of the Aircraft Sortie associated with this prior
   * permission required (PPR) record.
   */
  idSortie: string;
  ...
  /**
   * Body param: Time the prior permission required (PPR) valid window ends, in ISO
  ...
  /**
   * Body param: Identifier of the prior permission required (PPR) grantor.
   */
  grantor?: string;

  /**
   * Body param: The prior permission required (PPR) number issued by the airfield
   * for a sortie.
   */
  number?: string;
  ...
  /**
   * Body param: Remarks concerning the prior permission required (PPR) for a sortie.
   */
  remarks?: string;

  /**
   * Body param: The username of the prior permission required (PPR) requestor.
   */
  requestor?: string;

  /**
   * Body param: Time the prior permission required (PPR) valid window begins, in ISO
   * 8601 UTC format with millisecond precision.
   */
  startTime?: string;

  /**
   * Body param: Type of prior permission required (PPR) for a sortie (M - Military
   * or C - Civilian). Enum: [M, C].
   */
  type?: 'M' | 'C';
}
