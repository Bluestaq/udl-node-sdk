...
export class Location extends APIResource {
   ...
   */
  get(id: string, options?: Core.RequestOptions): Core.APIPromise<LocationGetResponse> {
...
export type LocationTupleResponse = Array<LocationTupleResponse.LocationTupleResponseItem>;

export namespace LocationTupleResponse {
  /**
   * Model representation of a location, which is a specific fixed point on the earth
   * and is used to denote the locations of fixed sensors, operating units, etc.
   */
  export interface LocationTupleResponseItem {
    /**
     * Classification marking of the data in IC/CAPCO Portion-marked format.
     */
    classificationMarking: string;
