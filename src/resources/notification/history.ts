...
export class History extends APIResource {
   ...
   * ```
   */
  list(query: HistoryListParams, options?: RequestOptions): PagePromise<NotificationFullsOffsetPage, Shared.NotificationFull> {
    return this._client.getAPIList('/udl/notification/history', OffsetPage<Shared.NotificationFull>, { query, ...options });
  }
  ...
  aodr(query: HistoryAodrParams, options?: RequestOptions): APIPromise<void> {
    return this._client.get('/udl/notification/history/aodr', { query, ...options, headers: buildHeaders([{Accept: '*/*'}, options?.headers]) });
  }
  ...
  count(query: HistoryCountParams, options?: RequestOptions): APIPromise<string> {
    return this._client.get('/udl/notification/history/count', { query, ...options, headers: buildHeaders([{Accept: 'text/plain'}, options?.headers]) });
  }
}
