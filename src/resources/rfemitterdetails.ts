...
export class Rfemitterdetails extends APIResource {
   ...
   */
  update(params: RfemitterdetailUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/rfemitterdetails/${path_id}`, {
...
export interface RfemitterdetailUpdateParams {
  /**
   * Path param: The ID of the RFEmitterDetails to update.
   */
  path_id: string;
  ...
  /**
   * Body param: Unique identifier of the parent RF Emitter.
   */
  idRFEmitter: string;
  ...
  /**
   * Body param: Alternate facility name for this RF Emitter.
   */
  alternateFacilityName?: string;

  /**
   * Body param: Optional alternate name or alias for this RF Emitter.
   */
  altName?: string;

  /**
   * Body param: For parabolic/dish antennas, the diameter of the antenna in meters.
   */
  antennaDiameter?: number;

  /**
   * Body param: Array with 1-2 values specifying the length and width (for
   * rectangular) and just length for dipole antennas in meters.
   */
  antennaSize?: Array<number>;

  /**
   * Body param: Barrage noise bandwidth in Mhz.
   */
  barrageNoiseBandwidth?: number;

  /**
   * Body param: Detailed description of the RF Emitter.
   */
  description?: string;

  /**
   * Body param: Designator of this RF Emitter.
   */
  designator?: string;

  /**
   * Body param: Doppler noise value in Mhz.
   */
  dopplerNoise?: number;

  /**
   * Body param: Digital Form Radio Memory instantaneous bandwidth in Mhz.
   */
  drfmInstantaneousBandwidth?: number;

  /**
   * Body param: Family of this RF Emitter type.
   */
  family?: string;

  /**
   * Body param: Unique identifier of the organization which manufactures this RF
   * Emitter.
   */
  manufacturerOrgId?: string;

  /**
   * Body param: Notes on the RF Emitter.
   */
  notes?: string;

  /**
   * Body param: Number of bits.
   */
  numBits?: number;

  /**
   * Body param: Number of channels.
   */
  numChannels?: number;
  ...
  /**
   * Body param: Unique identifier of the location of the production facility for
   * this RF Emitter.
   */
  productionFacilityLocationId?: string;

  /**
   * Body param: Name of the production facility for this RF Emitter.
   */
  productionFacilityName?: string;

  /**
   * Body param: Receiver bandwidth in Mhz.
   */
  receiverBandwidth?: number;

  /**
   * Body param: Receiver sensitivity in dBm.
   */
  receiverSensitivity?: number;

  /**
   * Body param: Type or name of receiver.
   */
  receiverType?: string;

  /**
   * Body param: Secondary notes on the RF Emitter.
   */
  secondaryNotes?: string;

  /**
   * Body param: Receiver sensitivity is the lowest power level at which the receiver
   * can detect an RF signal and demodulate data. Sensitivity is purely a receiver
   * specification and is independent of the transmitter. End sensitivity range, in
   * dBm.
   */
  systemSensitivityEnd?: number;
   ...
   * Body param: Receiver sensitivity is the lowest power level at which the receiver
   * can detect an RF signal and demodulate data. Sensitivity is purely a receiver
   * specification and is independent of the transmitter. Start sensitivity range, in
   * dBm.
   */
  systemSensitivityStart?: number;

  /**
   * Body param: Transmit power in Watts.
   */
  transmitPower?: number;

  /**
   * Body param: Transmitter bandwidth in Mhz.
   */
  transmitterBandwidth?: number;

  /**
   * Body param: Transmitter frequency in Mhz.
   */
  transmitterFrequency?: number;

  /**
   * Body param: Array of URLs containing additional information on this RF Emitter.
   */
  urls?: Array<string>;
}
