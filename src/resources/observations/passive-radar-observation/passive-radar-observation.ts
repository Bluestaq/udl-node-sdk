...
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/observations/passive-radar-observation/history';
import {
  History,
  HistoryAodrParams,
  HistoryCountParams,
...
} from 'bluestaq@unified-data-library/resources/observations/passive-radar-observation/history';
