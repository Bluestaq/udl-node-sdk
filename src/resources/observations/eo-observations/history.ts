...
export class History extends APIResource {
   ...
   * ```
   */
  list(query: HistoryListParams, options?: RequestOptions): PagePromise<EoObservationFullsOffsetPage, Shared.EoObservationFull> {
    return this._client.getAPIList('/udl/eoobservation/history', OffsetPage<Shared.EoObservationFull>, { query, ...options });
  }
  ...
  aodr(query: HistoryAodrParams, options?: RequestOptions): APIPromise<void> {
    return this._client.get('/udl/eoobservation/history/aodr', { query, ...options, headers: buildHeaders([{Accept: '*/*'}, options?.headers]) });
  }
  ...
  count(query: HistoryCountParams, options?: RequestOptions): APIPromise<string> {
    return this._client.get('/udl/eoobservation/history/count', { query, ...options, headers: buildHeaders([{Accept: 'text/plain'}, options?.headers]) });
  }
}
