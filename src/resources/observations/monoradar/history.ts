...
export class History extends APIResource {
   ...
   * for await (const historyListResponse of client.observations.monoradar.history.list(
  ...
  list(query: HistoryListParams, options?: RequestOptions): PagePromise<HistoryListResponsesOffsetPage, HistoryListResponse> {
    return this._client.getAPIList('/udl/monoradar/history', OffsetPage<HistoryListResponse>, { query, ...options });
  }
   ...
   * @example
   * ```ts
   * await client.observations.monoradar.history.aodr({
   *   ts: '2019-12-27T18:11:19.117Z',
   * });
   * ```
   */
  aodr(query: HistoryAodrParams, options?: RequestOptions): APIPromise<void> {
    return this._client.get('/udl/monoradar/history/aodr', { query, ...options, headers: buildHeaders([{Accept: '*/*'}, options?.headers]) });
  }
   ...
   * ```ts
   * const response =
   *   await client.observations.monoradar.history.count({
   *     ts: '2019-12-27T18:11:19.117Z',
   *   });
   * ```
   */
  count(query: HistoryCountParams, options?: RequestOptions): APIPromise<string> {
    return this._client.get('/udl/monoradar/history/count', { query, ...options, headers: buildHeaders([{Accept: 'text/plain'}, options?.headers]) });
  }
}
