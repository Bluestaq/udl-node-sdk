...
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/observations/monoradar/history';
import {
  History,
  HistoryAodrParams,
  HistoryCountParams,
...
} from 'bluestaq@unified-data-library/resources/observations/monoradar/history';
