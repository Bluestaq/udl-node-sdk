...
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/observations/radarobservation/history';
import {
  History,
  HistoryAodrParams,
  HistoryCountParams,
...
} from 'bluestaq@unified-data-library/resources/observations/radarobservation/history';
