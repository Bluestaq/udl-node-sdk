...
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/observations/rf-observation/history';
import {
  History,
  HistoryAodrParams,
  HistoryCountParams,
...
} from 'bluestaq@unified-data-library/resources/observations/rf-observation/history';
 ...
 * frequencies[0]).
 */
export interface RfObservationListResponse {
  /**
 ...
 * frequencies[0]).
 */
export interface RfObservationGetResponse {
  /**
   * Classification marking of the data in IC/CAPCO Portion-marked format.
   */
  classificationMarking: string;
...
export interface RfObservationListParams extends OffsetPageParams {
  /**
   * Ob detection time in ISO 8601 UTC with microsecond precision.
