...
export class UdlSgi extends APIResource {
  /**
   ...
   */
  create(body: UdlSgiCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
...
export type UdlSgiCreateParams = Array<UdlSgiCreateParams.Body>;

export namespace UdlSgiCreateParams {
  /**
...
export declare namespace UdlSgi {
  export { type UdlSgiCreateParams as UdlSgiCreateParams };
}
