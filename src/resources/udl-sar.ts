...
export class UdlSar extends APIResource {
  /**
   ...
   */
  create(body: UdlSarCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
...
export type UdlSarCreateParams = Array<UdlSarCreateParams.Body>;

export namespace UdlSarCreateParams {
  /**
...
export declare namespace UdlSar {
  export { type UdlSarCreateParams as UdlSarCreateParams };
}
