...
export class History extends APIResource {
   ...
   * for await (const historyListResponse of client.globalAtmosphericModel.history.list(
  ...
  list(query: HistoryListParams, options?: RequestOptions): PagePromise<HistoryListResponsesOffsetPage, HistoryListResponse> {
    return this._client.getAPIList('/udl/globalatmosphericmodel/history', OffsetPage<HistoryListResponse>, { query, ...options });
  }
   ...
   * @example
   * ```ts
   * await client.globalAtmosphericModel.history.aodr({
   *   ts: '2019-12-27T18:11:19.117Z',
   * });
   * ```
   */
  aodr(query: HistoryAodrParams, options?: RequestOptions): APIPromise<void> {
    return this._client.get('/udl/globalatmosphericmodel/history/aodr', { query, ...options, headers: buildHeaders([{Accept: '*/*'}, options?.headers]) });
  }
  ...
  count(query: HistoryCountParams, options?: RequestOptions): APIPromise<string> {
    return this._client.get('/udl/globalatmosphericmodel/history/count', { query, ...options, headers: buildHeaders([{Accept: 'text/plain'}, options?.headers]) });
  }
}
