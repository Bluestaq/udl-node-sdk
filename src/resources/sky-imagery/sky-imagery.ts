...
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/sky-imagery/history';
import {
  History,
  HistoryAodrParams,
  HistoryCountParams,
 ...
 * content must be downloaded individually by ID using the 'getFile' operation.
 */
export interface SkyImageryGetResponse {
  /**
   * Classification marking of the data in IC/CAPCO Portion-marked format.
   */
  classificationMarking: string;
...
export namespace SkyImageryTupleResponse {
   ...
   * content must be downloaded individually by ID using the 'getFile' operation.
   */
  export interface SkyImageryTupleResponseItem {
    /**
     * Classification marking of the data in IC/CAPCO Portion-marked format.
     */
    classificationMarking: string;
