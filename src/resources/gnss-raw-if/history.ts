...
import * as GnssrawifHistoryAPI from '../udl/gnssrawif/history';
...
export class History extends APIResource {
  ...
  count(query: HistoryCountParams, options?: RequestOptions): APIPromise<string> {
    return this._client.get('/udl/gnssrawif/history/count', {
      query,
      ...options,
  ...
  query(query: HistoryQueryParams, options?: RequestOptions): APIPromise<HistoryQueryResponse> {
    return this._client.get('/udl/gnssrawif/history', { query, ...options });
  }
}
