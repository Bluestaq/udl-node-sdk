...
export interface BatterydetailUpdateParams {
  ...
  /**
   * Body param: Depth of discharge as a percentage/fraction.
   */
  dischargeDepth?: number;

  /**
   * Body param: ID of the organization that manufactures the battery.
   */
  manufacturerOrgId?: string;

  /**
   * Body param: Battery model number or name.
   */
  model?: string;
  ...
  /**
   * Body param: Type of battery technology (e.g. Ni-Cd, Ni-H2, Li-ion, etc.).
   */
  technology?: string;
}
