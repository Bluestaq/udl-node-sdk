...
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/collect-requests/history';
import {
  History,
  HistoryAodrParams,
  HistoryCountParams,
  ...
  HistoryListParams,
} from 'bluestaq@unified-data-library/resources/collect-requests/history';
