...
export class CollectRequests extends APIResource {
  ...
  ): Core.APIPromise<Shared.CollectRequestFull> {
    const { path_id, body_id } = params;
    return this._client.get(`/udl/collectrequest/${path_id}`, options);
  }
  ...
  list(
    ...
    return this._client.get('/udl/collectrequest', options);
  }
   ...
   */
  count(params: CollectRequestCountParams, options?: Core.RequestOptions): Core.APIPromise<string> {
    const { startTime } = params;
  ...
  tuple(
    ...
    return this._client.get('/udl/collectrequest/tuple', options);
  }
}
...
export interface CollectRequestRetrieveParams {
  ...
  /**
   * Body param: The ID of the CollectRequest to retrieve.
   */
  body_id: string;
}
