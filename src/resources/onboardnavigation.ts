...
export type OnboardnavigationListResponse =
  Array<OnboardnavigationListResponse.OnboardnavigationListResponseItem>;

export namespace OnboardnavigationListResponse {
  /**
   ...
   */
  export interface OnboardnavigationListResponseItem {
    /**
...
export interface OnboardnavigationListParams {
  /**
   * Start time of the sensor data, in ISO 8601 UTC format.
