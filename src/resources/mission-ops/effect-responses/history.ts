 ...
 */
export interface EffectResponseFull {
  /**
   ...
   */
  actionsList?: Array<EffectResponseFull.ActionsList>;
   ...
   */
  coaMetrics?: Array<EffectResponseFull.CoaMetric>;
...
export namespace EffectResponseFull {
  /**
   * List of actions associated with this effect response.
   */
...
export declare namespace History {
  export { type EffectResponseFull as EffectResponseFull };
}
