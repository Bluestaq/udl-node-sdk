...
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/weather-data/history';
import {
  History,
  HistoryAodrParams,
  HistoryCountParams,
...
} from 'bluestaq@unified-data-library/resources/weather-data/history';
