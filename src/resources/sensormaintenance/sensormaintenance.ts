...
export class Sensormaintenance extends APIResource {
   ...
   * assistance.
   */
  update(params: SensormaintenanceUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/sensormaintenance/${path_id}`, {
...
export interface SensormaintenanceUpdateParams {
  /**
   * Path param: The ID of the SensorMaintenance to update.
   */
  path_id: string;
  ...
  /**
   * Body param: The planned outage end time in ISO8601 UTC format.
   */
  endTime: string;

  /**
   * Body param: The site to which this item applies. NOTE - this site code is COLT
   * specific and may not identically correspond to other UDL site IDs.
   */
  siteCode: string;
  ...
  /**
   * Body param: The planned outage start time in ISO8601 UTC format.
   */
  startTime: string;
  ...
  /**
   * Body param: Description of the activity taking place during this outage.
   */
  activity?: string;

  /**
   * Body param: The name of the approver.
   */
  approver?: string;

  /**
   * Body param: The name of the changer, if applicable.
   */
  changer?: string;

  /**
   * Body param: The duration of the planned outage, expressed as ddd:hh:mm.
   */
  duration?: string;

  /**
   * Body param: COLT EOWID.
   */
  eowId?: string;

  /**
   * Body param: The mission capability status of the equipment (e.g. FMC, NMC, PMC,
   * UNK, etc.).
   */
  equipStatus?: string;

  /**
   * Body param: UUID of the sensor.
   */
  idSensor?: string;

  /**
   * Body param: The sensor face(s) to which this COLT maintenance item applies, if
   * applicable.
   */
  impactedFaces?: string;

  /**
   * Body param: The internal COLT line number assigned to this item.
   */
  lineNumber?: string;

  /**
   * Body param: The Missile Defense operational capability of this maintenance item.
   * Typical values are G, Y, R, and - for non-applicable sites.
   */
  mdOpsCap?: string;

  /**
   * Body param: The Missile Warning operational capability of this maintenance item.
   * Typical values are G, Y, R, and - for non-applicable sites.
   */
  mwOpsCap?: string;
  ...
  /**
   * Body param: The priority of this maintenance item.
   */
  priority?: string;

  /**
   * Body param: The minimum time required to recall this activity, expressed as
   * ddd:hh:mm.
   */
  recall?: string;
  ...
  /**
   * Body param: Remarks concerning this outage.
   */
  remark?: string;

  /**
   * Body param: The name of the requestor.
   */
  requestor?: string;

  /**
   * Body param: The name of the resource(s) affected by this maintenance item.
   */
  resource?: string;

  /**
   * Body param: The revision number for this maintenance item.
   */
  rev?: string;

  /**
   * Body param: The Space Surveillance operational capability of this maintenance
   * item. Typical values are G, Y, R, and - for non-applicable sites.
   */
  ssOpsCap?: string;
}
