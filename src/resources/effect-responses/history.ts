...
import * as EffectResponsesAPI from '../mission-ops/effect-responses/effect-responses';
...
export class History extends APIResource {
  ...
  list(params: HistoryListParams, options?: Core.RequestOptions): Core.APIPromise<HistoryListResponse> {
    ...
    return this._client.get('/udl/effectresponse/history', options);
  }
...
export type HistoryListResponse = Array<EffectResponsesAPI.EffectResponse>;
