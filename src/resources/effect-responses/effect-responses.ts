...
import * as EffectResponsesEffectResponsesAPI from '../mission-ops/effect-responses/effect-responses';
...
export class EffectResponses extends APIResource {
  ...
  ): Core.APIPromise<EffectResponsesEffectResponsesAPI.EffectResponse> {
    const { path_id, body_id } = params;
    return this._client.get(`/udl/effectresponse/${path_id}`, options);
  }
  ...
  list(
    ...
    return this._client.get('/udl/effectresponse', options);
  }
   ...
   */
  count(params: EffectResponseCountParams, options?: Core.RequestOptions): Core.APIPromise<string> {
    const { createdAt } = params;
  ...
  tuple(
    ...
    return this._client.get('/udl/effectresponse/tuple', options);
  }
}

export type EffectResponseListResponse = Array<EffectResponsesEffectResponsesAPI.EffectResponseAbridged>;

export type EffectResponseCountResponse = string;

export type EffectResponseTupleResponse = Array<EffectResponsesEffectResponsesAPI.EffectResponse>;
...
export interface EffectResponseRetrieveParams {
  ...
  /**
   * Body param: The ID of the EffectResponse to retrieve.
   */
  body_id: string;
}
