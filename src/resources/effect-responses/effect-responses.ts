...
import * as EffectResponsesAPI from 'bluestaq@unified-data-library/resources/effect-responses/effect-responses';
import * as Shared from 'bluestaq@unified-data-library/resources/shared';
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/effect-responses/history';
import {
  History,
  HistoryAodrParams,
  HistoryCountParams,
...
} from 'bluestaq@unified-data-library/resources/effect-responses/history';
...
export class EffectResponses extends APIResource {
  ...
  list(
    ...
    options?: RequestOptions,
  ): PagePromise<EffectResponseListResponsesOffsetPage, EffectResponseListResponse> {
    return this._client.getAPIList('/udl/effectresponse', OffsetPage<EffectResponseListResponse>, {
      query,
      ...options,
    });
  }
