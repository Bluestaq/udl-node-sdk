...
export class AirEvents extends APIResource {
   ...
   * assistance.
   */
  update(params: AirEventUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/airevent/${path_id}`, {
   ...
   */
  list(options?: Core.RequestOptions): Core.APIPromise<AirEventListResponse> {
  ...
  delete(id: string, options?: Core.RequestOptions): Core.APIPromise<void> {
    return this._client.delete(`/udl/airevent/${id}`, {
      ...options,
      headers: { Accept: '*/*', ...options?.headers },
    });
  }
   ...
   */
  createBulk(body: AirEventCreateBulkParams, options?: Core.RequestOptions): Core.APIPromise<void> {
   ...
   * path parameter.
   */
  get(id: string, options?: Core.RequestOptions): Core.APIPromise<AirEventGetResponse> {
    return this._client.get(`/udl/airevent/${id}`, options);
  }
...
export type AirEventListResponse = Array<AirEventListResponse.AirEventListResponseItem>;
...
export namespace AirEventListResponse {
   ...
   * associated aircraft.
   */
  export interface AirEventListResponseItem {
    /**
     ...
     */
    receivers?: Array<AirEventListResponseItem.Receiver>;

    /**
     * Collection of remarks associated with this Air Event.
     */
    remarks?: Array<AirEventListResponseItem.Remark>;
     ...
     */
    tankers?: Array<AirEventListResponseItem.Tanker>;
  ...
  export namespace AirEventListResponseItem {
    /**
     * Collection of receiver aircraft associated with this Air Event.
     */
...
export interface AirEventUpdateParams {
  /**
   * Path param: The ID of the airevent record to update.
   */
  path_id: string;
  ...
  /**
   * Body param: Type of air event (e.g. FUEL TRANSFER, AIR DROP, etc).
   */
  type: string;

  /**
   * Body param: Unique identifier of the record, auto-generated by the system if not
   * provided on create operations.
   */
  body_id?: string;

  /**
   * Body param: The actual arrival time of the aircraft at the air event, in ISO
   * 8601 UTC format with millisecond precision.
   */
  actualArrTime?: string;

  /**
   * Body param: The actual departure time of the aircraft from the air event, in ISO
   * 8601 UTC format with millisecond precision.
   */
  actualDepTime?: string;

  /**
   * Body param: The Air Refueling Control Time is the planned time the tanker
   * aircraft will transfer fuel to the receiver aircraft, in ISO 8601 UTC format,
   * with millisecond precision.
   */
  arct?: string;

  /**
   * Body param: Type of process used by AMC to schedule this air refueling event.
  ...
  /**
   * Body param: The purpose of the air event at the arrival location. Can be either
   * descriptive text such as 'fuel onload' or a purpose code specified by the
   * provider, such as 'A'.
   */
  arrPurpose?: string;
  ...
  /**
   * Body param: Identifier of the air refueling track, if applicable.
   */
  arTrackId?: string;

  /**
   * Body param: Name of the air refueling track, if applicable.
   */
  arTrackName?: string;

  /**
   * Body param: Altitude of this air event, in feet.
   */
  baseAlt?: number;

  /**
   * Body param: Flag indicating that this air refueling event has been cancelled.
   */
  cancelled?: boolean;

  /**
   * Body param: The purpose of the air event at the departure location. Can be
   * either descriptive text such as 'fuel onload' or a purpose code specified by the
   * provider, such as 'A'.
   */
  depPurpose?: string;

  /**
   * Body param: The current estimated arrival time of the aircraft at the air event,
   * in ISO 8601 UTC format with millisecond precision.
   */
  estArrTime?: string;

  /**
   * Body param: The current estimated departure time of the aircraft from the air
   * event, in ISO 8601 UTC format with millisecond precision.
   */
  estDepTime?: string;

  /**
   * Body param: Optional air event ID from external systems. This field has no
  ...
  /**
   * Body param: Optional air refueling track ID from external systems. This field
   * has no meaning within UDL and is provided as a convenience for systems that
   * require tracking of an internal system generated ID.
   */
  externalARTrackId?: string;

  /**
   * Body param: The UDL unique identifier of the mission associated with this air
   * event.
   */
  idMission?: string;

  /**
   * Body param: The UDL unique identifier of the sortie associated with this air
   * event.
   */
  idSortie?: string;

  /**
   * Body param: Identifies the Itinerary point of a sortie where an air event
   * occurs.
   */
  legNum?: number;

  /**
   * Body param: The location representing this air event specified as a feature Id.
  ...
  /**
   * Body param: The number of tankers requested for an air refueling event.
   */
  numTankers?: number;
  ...
  /**
   * Body param: The scheduled arrival time of the aircraft at the air event, in ISO
   * 8601 UTC format with millisecond precision.
   */
  plannedArrTime?: string;

  /**
   * Body param: The scheduled departure time of the aircraft from the air event, in
   * ISO 8601 UTC format with millisecond precision.
   */
  plannedDepTime?: string;

  /**
   * Body param: Priority of this air event.
   */
  priority?: string;

  /**
   * Body param: Collection of receiver aircraft associated with this Air Event.
   */
  receivers?: Array<AirEventUpdateParams.Receiver>;

  /**
   * Body param: Collection of remarks associated with this Air Event.
   */
  remarks?: Array<AirEventUpdateParams.Remark>;

  /**
   * Body param: Flag indicating if the receiver unit has requested flying an air
   * refueling track in both directions.
   */
  revTrack?: boolean;

  /**
   * Body param: The Rendezvous Control Time is the planned time the tanker and
   * receiver aircraft will rendezvous for an en route type air refueling event, in
   * ISO 8601 UTC format, with millisecond precision.
   */
  rzct?: string;

  /**
   * Body param: Rendezvous point for the tanker and receiver during this air
   * refueling event. Possible values are AN (Anchor Nav Point), AP (Anchor Pattern),
   * CP (Control Point), ET (Entry Point), EX (Exit Point), IP (Initial Point), NC
   * (Nav Check Point).
   */
  rzPoint?: string;

  /**
   * Body param: Type of rendezvous used for this air refueling event. Possible
   * values are BUD (Buddy), EN (Enroute), GCI (Ground Control), PP (Point Parallel).
   */
  rzType?: string;

  /**
   * Body param: Flag indicating that the receiver unit has requested flying a short
   * portion of an air refueling track.
   */
  shortTrack?: boolean;

  /**
   * Body param: Status of this air refueling event track reservation. Receivers are
   * responsible for scheduling or reserving air refueling tracks. Possible values
   * are A (Altitude Reservation), R (Reserved), or Q (Questionable).
   */
  statusCode?: string;

  /**
   * Body param: Collection of tanker aircraft associated with this Air Event.
   */
  tankers?: Array<AirEventUpdateParams.Tanker>;

  /**
   * Body param: Length of time the receiver unit has requested for an air event, in
   * hours.
   */
  trackTime?: number;
}
...
export type AirEventCreateBulkParams = Array<AirEventCreateBulkParams.Body>;
