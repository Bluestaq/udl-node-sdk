...
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/star-catalog/history';
import { History, HistoryAodrParams } from 'bluestaq@unified-data-library/resources/star-catalog/history';
