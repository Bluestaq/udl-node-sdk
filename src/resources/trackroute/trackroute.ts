...
export class Trackroute extends APIResource {
   ...
   * assistance.
   */
  update(params: TrackrouteUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/trackroute/${path_id}`, {
...
export interface TrackrouteUpdateParams {
  /**
   * Path param: The ID of the TrackRoute to update.
   */
  path_id: string;
  ...
  /**
   * Body param: The last updated date of the track route in ISO 8601 UTC format with
  ...
  /**
   * Body param: The track route type represented by this record (ex. AIR REFUELING).
   */
  type: string;
  ...
  /**
   * Body param: Minimum and maximum altitude bounds for the track.
   */
  altitudeBlocks?: Array<TrackrouteUpdateParams.AltitudeBlock>;

  /**
   * Body param: The APN radar code sent and received by the aircraft for
   * identification.
   */
  apnSetting?: string;

  /**
   * Body param: The APX radar code sent and received by the aircraft for
   * identification.
   */
  apxBeaconCode?: string;

  /**
   * Body param: Air Refueling Track Control Center message.
   */
  artccMessage?: string;

  /**
   * Body param: The name of the creating organization of the track route.
   */
  creatingOrg?: string;

  /**
   * Body param: The principal compass direction (cardinal or ordinal) of the track
   * route.
   */
  direction?: string;

  /**
   * Body param: The date which the DAFIF track was last updated/validated in ISO
  ...
  /**
   * Body param: Used to show last time the track route was added to an itinerary in
   * ISO 8601 UTC format with millisecond precision.
   */
  lastUsedDate?: string;

  /**
   * Body param: Track location ID.
   */
  locationTrackId?: string;
  ...
  /**
   * Body param: Point of contacts for scheduling or modifying the route.
   */
  poc?: Array<TrackrouteUpdateParams.Poc>;

  /**
   * Body param: The primary UHF radio frequency used for the track route in
   * megahertz.
   */
  priFreq?: number;

  /**
   * Body param: The receiver tanker channel identifer for air refueling tracks.
   */
  receiverTankerCHCode?: string;

  /**
   * Body param: Region code indicating where the track resides as determined by the
   * data source.
   */
  regionCode?: string;

  /**
   * Body param: Region where the track resides.
   */
  regionName?: string;

  /**
   * Body param: Date the track needs to be reviewed for accuracy or deletion in ISO
   * 8601 UTC format with millisecond precision.
   */
  reviewDate?: string;

  /**
   * Body param: Points identified within the route.
   */
  routePoints?: Array<TrackrouteUpdateParams.RoutePoint>;

  /**
   * Body param: Point of contact for the air refueling track route scheduler.
   */
  schedulerOrgName?: string;

  /**
   * Body param: The unit responsible for scheduling the track route.
   */
  schedulerOrgUnit?: string;

  /**
   * Body param: The secondary UHF radio frequency used for the track route in
   * megahertz.
   */
  secFreq?: number;

  /**
   * Body param: Abbreviated name of the track.
   */
  shortName?: string;

  /**
   * Body param: Standard Indicator Code of the air refueling track.
   */
  sic?: string;

  /**
   * Body param: Identifier of the track.
   */
  trackId?: string;

  /**
   * Body param: Name of the track.
   */
  trackName?: string;

  /**
   * Body param: Type of process used by AMC to schedule an air refueling event.
