...
export class IonoObservations extends APIResource {
   ...
   */
  create(body: IonoObservationCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
...
export type IonoObservationCreateParams = Array<IonoObservationCreateParams.Body>;

export namespace IonoObservationCreateParams {
  /**
  ...
  export interface Body {
     ...
     * (lat, long, radii).
     */
    antennaElementPositionCoordinateSystem?: string;
...
export declare namespace IonoObservations {
  export { type IonoObservationCreateParams as IonoObservationCreateParams };
}
