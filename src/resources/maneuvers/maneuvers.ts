...
export class Maneuvers extends APIResource {
   ...
   * mechanism.
   */
  create(body: ManeuverCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
   ...
   */
  list(query: ManeuverListParams, options?: Core.RequestOptions): Core.APIPromise<ManeuverListResponse> {
    return this._client.get('/udl/maneuver', { query, ...options });
  }
   ...
   */
  count(query: ManeuverCountParams, options?: Core.RequestOptions): Core.APIPromise<string> {
   ...
   */
  createBulk(body: ManeuverCreateBulkParams, options?: Core.RequestOptions): Core.APIPromise<void> {
   ...
   */
  fileCreate(body: ManeuverFileCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
   ...
   * parameter.
   */
  get(id: string, options?: Core.RequestOptions): Core.APIPromise<ManeuverHistoryAPI.ManeuverFull> {
    return this._client.get(`/udl/maneuver/${id}`, options);
  }
...
export type ManeuverListResponse = Array<ManeuverListResponse.ManeuverListResponseItem>;
...
export namespace ManeuverListResponse {
   ...
   */
  export interface ManeuverListResponseItem {
    /**
     ...
     */
    postEventElset?: ElsetsAPI.ElsetAbridged;
     ...
     * provider.
     */
    postEventStateVector?: ManeuverListResponseItem.PostEventStateVector;
     ...
     * consists of identification data, the classical elements and drag parameters.
     */
    preEventElset?: ElsetsAPI.ElsetAbridged;
     ...
     * provider.
     */
    preEventStateVector?: ManeuverListResponseItem.PreEventStateVector;
  ...
  export namespace ManeuverListResponseItem {
    /**
     * This service provides operations for querying and manipulation of state vectors
     * for OnOrbit objects. State vectors are cartesian vectors of position (r) and
     * velocity (v) that, together with their time (epoch) (t), uniquely determine the
...
export type ManeuverTupleResponse = Array<ManeuverHistoryAPI.ManeuverFull>;
...
export interface ManeuverListParams {
  /**
   * Maneuver event start time in ISO 8601 UTC with microsecond precision. For
   * maneuvers without start and end times, the start time is considered to be the
...
export type ManeuverCreateBulkParams = Array<ManeuverCreateBulkParams.Body>;
...
export type ManeuverFileCreateParams = Array<ManeuverFileCreateParams.Body>;

export namespace ManeuverFileCreateParams {
  /**
   * Model representation of on-orbit object maneuver information for detected,
   * possible, and confirmed maneuvers.
   */
