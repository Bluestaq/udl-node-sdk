...
export namespace ManeuverListResponse {
  ...
  export interface ManeuverListResponseItem {
     ...
     * provider.
     */
    postEventStateVector?: StatevectorAPI.StateVectorAbridged;
     ...
     * provider.
     */
    preEventStateVector?: StatevectorAPI.StateVectorAbridged;
...
export interface ManeuverCreateParams {
   ...
   * consists of identification data, the classical elements and drag parameters.
   */
  postEventElset?: ElsetsAPI.ElsetIngest;
   ...
   * provider.
   */
  postEventStateVector?: StatevectorAPI.StateVectorIngest;
   ...
   * consists of identification data, the classical elements and drag parameters.
   */
  preEventElset?: ElsetsAPI.ElsetIngest;
   ...
   * provider.
   */
  preEventStateVector?: StatevectorAPI.StateVectorIngest;
