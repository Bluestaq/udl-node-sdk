...
export class Eventevolutions extends APIResource {
  ...
  ): Core.APIPromise<Shared.EventEvolutionFull> {
    const { path_id, body_id } = params;
    return this._client.get(`/udl/eventevolution/${path_id}`, options);
  }
  ...
  tuple(
    ...
    return this._client.get('/udl/eventevolution/tuple', options);
  }
}
 ...
 */
export interface EventEvolutionAbridged {
  /**
...
export interface EventevolutionRetrieveParams {
  ...
  /**
   * Body param: The ID of the EventEvolution to retrieve.
   */
  body_id: string;
}
...
Eventevolutions.History = History;

export declare namespace Eventevolutions {
  export {
