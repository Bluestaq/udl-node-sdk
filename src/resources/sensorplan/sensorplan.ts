...
export class Sensorplan extends APIResource {
   ...
   */
  update(params: SensorplanUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/sensorplan/${path_id}`, {
   ...
   */
  fileCreate(body: SensorplanFileCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
...
export interface SensorplanUpdateParams {
  /**
   * Path param: The ID of the SensorPlan to retrieve.
   */
  path_id: string;
  ...
  /**
   * Body param: The type of records that comprise this parent set (COLLECT,
   * CONTACT).
   */
  recType: string;
  ...
  /**
   * Body param: The start time of the plan or schedule, in ISO 8601 UTC format.
   */
  startTime: string;

  /**
   * Body param: The type of this sensor plan/schedule (PLAN, REQUEST, SCHEDULE).
   */
  type: string;
  ...
  /**
   * Body param: The list of collect requests belonging to the SensorPlan. Each
   * collect request is associated with a parent SensorPlan via the IdPlan. If
   * provided, the list must have the same size as reqTotal.
   */
  collectRequests?: Array<SensorplanUpdateParams.CollectRequest>;

  /**
   * Body param: The customer for this plan or schedule.
   */
  customer?: string;

  /**
   * Body param: The end time of the plan or schedule, in ISO 8601 UTC format.
   */
  endTime?: string;

  /**
   * Body param: Unique identifier of the requested/schedule/planned sensor
   * associated with this request.
   */
  idSensor?: string;

  /**
   * Body param: Name associated with this plan or schedule.
   */
  name?: string;
  ...
  /**
   * Body param: Optional identifier provided by the source to indicate the sensor
   * identifier requested/scheduled/planned for this request. This may be an internal
   * identifier and not necessarily a valid sensor ID.
   */
  origSensorId?: string;

  /**
   * Body param: The purpose/description of this plan or schedule.
   */
  purpose?: string;

  /**
   * Body param: The total number of requests contained in this plan or schedule.
  ...
  /**
   * Body param: The sensor or ground network associated with this plan or schedule.
   */
  senNetwork?: string;

  /**
   * Body param: The status of this plan or schedule (ACCEPTED, APPROVED, COMPLETED,
   * PROPOSED, REJECTED, REQUESTED, SCHEDULED).
   */
  status?: string;
...
export type SensorplanFileCreateParams = Array<SensorplanFileCreateParams.Body>;

export namespace SensorplanFileCreateParams {
  /**
   * A Plan is used to aggregate two or more of the same type of record to a parent
   * entity, with the planId (UUID) being included in all of the subordinate records,
   * enabling resolution back to the parent.
