...
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/mission-assignment/history';
import {
  History,
  HistoryAodrParams,
  HistoryCountParams,
...
} from 'bluestaq@unified-data-library/resources/mission-assignment/history';
