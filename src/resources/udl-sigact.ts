...
export class UdlSigact extends APIResource {
   ...
   */
  create(body: UdlSigactCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
...
export type UdlSigactCreateParams = Array<UdlSigactCreateParams.Body>;

export namespace UdlSigactCreateParams {
  /**
...
export declare namespace UdlSigact {
  export { type UdlSigactCreateParams as UdlSigactCreateParams };
}
