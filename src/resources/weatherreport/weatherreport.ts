...
export type WeatherreportListResponse = Array<WeatherreportListResponse.WeatherreportListResponseItem>;

export namespace WeatherreportListResponse {
  /**
   ...
   */
  export interface WeatherreportListResponseItem {
    /**
...
export interface WeatherreportListParams {
  /**
   * Datetime when a weather observation was made or forecast was issued in ISO 8601
