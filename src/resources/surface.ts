...
export class Surface extends APIResource {
   ...
   */
  update(params: SurfaceUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/surface/${path_id}`, {
...
export interface SurfaceUpdateParams {
  /**
   * Path param: The ID of the Surface to update.
   */
  path_id: string;
  ...
  /**
   * Body param: The surface name or identifier.
   */
  name: string;
  ...
  /**
   * Body param: The surface type of this record (e.g. RUNWAY, TAXIWAY, PARKING).
   */
  type: string;
  ...
  /**
   * Body param: Alternate site identifier provided by the source.
   */
  altSiteId?: string;

  /**
   * Body param: The surface condition (e.g. GOOD, FAIR, POOR, SERIOUS, FAILED,
   * CLOSED, UNKNOWN).
   */
  condition?: string;

  /**
   * Body param: The max weight allowable on this surface type for a DDT-type (double
   * dual tandem) landing gear configuration, in kilopounds (kip).Note: The
   * corresponding equivalent field is not converted by the UDL and may or may not be
   * supplied by the provider. The provider/consumer is responsible for all unit
   * conversions.
   */
  ...
  /**
   * Body param: The modified max weight allowable on this surface type for a
   * DDT-type (double dual tandem) landing gear configuration, in kilopounds (kip).
   */
  ddtWtKipMod?: number;

  /**
   * Body param: User input rationale for the manual modification of the prescribed
   * value indicating the max weight allowable on this surface for a DDT-type (double
   * dual tandem) landing gear configuration. For more information, contact the
   * provider source.
   */
  ddtWtKipModNote?: string;
  ...
  /**
   * Body param: The max weight allowable on this surface type for a DDT-type (double
   * dual tandem) landing gear configuration, in kilonewtons (kN).Note: The
   * corresponding equivalent field is not converted by the UDL and may or may not be
   * supplied by the provider. The provider/consumer is responsible for all unit
   * conversions.
   */
  ...
  /**
   * Body param: The max weight allowable on this surface type for an FAA 2D-type
   * (twin tandem) landing gear configuration, in kilopounds (kip).Note: The
   * corresponding equivalent field is not converted by the UDL and may or may not be
   * supplied by the provider. The provider/consumer is responsible for all unit
   * conversions.
  ...
  /**
   * Body param: The modified max weight allowable on this surface type for an FAA
   * 2D-type (twin tandem) landing gear configuration, in kilopounds (kip).
   */
  ddWtKipMod?: number;

  /**
   * Body param: User input rationale for the manual modification of the prescribed
   * value indicating the max weight allowable on this surface for an FAA 2D-type
   * (twin tandem) landing gear configuration. For more information, contact the
   * provider source.
   */
  ddWtKipModNote?: string;
  ...
  /**
   * Body param: The unique identifier of the Site record that contains location
   * information about this surface.
   */
  idSite?: string;

  /**
   * Body param: Load classification number or pavement rating which ranks aircraft
   * on a scale of 1 to 120.
   */
  lcn?: number;

  /**
   * Body param: The landing distance available for the runway, in feet. Applicable
   * for runway surface types only.
   */
  ldaFt?: number;

  /**
   * Body param: The landing distance available for the runway, in meters. Applicable
   * for runway surface types only.
   */
  ldaM?: number;

  /**
   * Body param: The length of the surface type, in feet. Applicable for runway and
   * parking surface types.
   */
  lengthFt?: number;

  /**
   * Body param: The length of the surface type, in meters. Applicable for runway and
   * parking surface types.
   */
  lengthM?: number;

  /**
   * Body param: Flag indicating the surface has lighting.
   */
  lighting?: boolean;

  /**
   * Body param: Flag indicating the runway has approach lights. Applicable for
   * runway surface types only.
   */
  lightsAPRCH?: boolean;

  /**
   * Body param: Flag indicating the runway has centerline lights. Applicable for
   * runway surface types only.
   */
  lightsCL?: boolean;

  /**
   * Body param: Flag indicating the runway has Optical Landing System (OLS) lights.
   * Applicable for runway surface types only.
   */
  lightsOLS?: boolean;

  /**
   * Body param: Flag indicating the runway has Precision Approach Path Indicator
   * (PAPI) lights. Applicable for runway surface types only.
   */
  lightsPAPI?: boolean;

  /**
   * Body param: Flag indicating the runway has Runway End Identifier Lights (REIL).
   * Applicable for runway surface types only.
   */
  lightsREIL?: boolean;

  /**
   * Body param: Flag indicating the runway has edge lighting. Applicable for runway
   * surface types only.
   */
  lightsRWY?: boolean;

  /**
   * Body param: Flag indicating the runway has Sequential Flashing (SEQFL) lights.
   * Applicable for runway surface types only.
   */
  lightsSEQFL?: boolean;

  /**
   * Body param: Flag indicating the runway has Touchdown Zone lights. Applicable for
   * runway surface types only.
   */
  lightsTDZL?: boolean;

  /**
   * Body param: Flag indicating the runway lighting is unknown. Applicable for
   * runway surface types only.
   */
  lightsUNKN?: boolean;

  /**
   * Body param: Flag indicating the runway has Visual Approach Slope Indicator
   * (VASI) lights. Applicable for runway surface types only.
   */
  lightsVASI?: boolean;

  /**
   * Body param: The surface material (e.g. Asphalt, Concrete, Dirt).
   */
  material?: string;

  /**
   * Body param: Flag indicating that one or more obstacles or obstructions exist in
   * the proximity of this surface.
   */
  obstacle?: boolean;
  ...
  /**
   * Body param: Pavement classification number (PCN) and tire pressure code.
   */
  pcn?: string;

  /**
   * Body param: Flag indicating this is the primary runway. Applicable for runway
   * surface types only.
   */
  primary?: boolean;

  /**
   * Body param: Raw weight bearing capacity value or pavement strength.
   */
  rawWBC?: string;

  /**
   * Body param: The max weight allowable on this surface type for an SBTT-type
   * (single belly twin tandem) landing gear configuration, in kilopounds (kip).Note:
  ...
  /**
   * Body param: The modified max weight allowable on this surface type for an
   * SBTT-type (single belly twin tandem) landing gear configuration, in kilopounds
   * (kip).
   */
  sbttWtKipMod?: number;
  ...
  /**
   * Body param: User input rationale for the manual modification of the prescribed
   * value indicating the max weight allowable on this surface for an SBTT-type
   * (single belly twin tandem) landing gear configuration. For more information,
  ...
  /**
   * Body param: The max weight allowable on this surface type for an SBTT-type
   * (single belly twin tandem) landing gear configuration, in kilonewtons (kN).Note:
   * The corresponding equivalent field is not converted by the UDL and may or may
   * not be supplied by the provider. The provider/consumer is responsible for all
   * unit conversions.
   */
  ...
  /**
   * Body param: The max weight allowable on this surface type for an ST-type (single
   * tandem) landing gear configuration, in kilopounds (kip).Note: The corresponding
   * equivalent field is not converted by the UDL and may or may not be supplied by
   * the provider. The provider/consumer is responsible for all unit conversions.
   */
  ...
  /**
   * Body param: The modified max weight allowable on this surface type for an
   * ST-type (single tandem) landing gear configuration, in kilopounds (kip).
   */
  stWtKipMod?: number;

  /**
   * Body param: User input rationale for the manual modification of the prescribed
   * value indicating the max weight allowable on this surface for an ST-type (single
   * tandem) landing gear configuration. For more information, contact the provider
   * source.
   */
  stWtKipModNote?: string;
  ...
  /**
   * Body param: The max weight allowable on this surface type for an S-type (single)
   * landing gear configuration, in kilopounds (kip). Note: The corresponding
   * equivalent field is not converted by the UDL and may or may not be supplied by
   * the provider. The provider/consumer is responsible for all unit conversions.
   */
  ...
  /**
   * Body param: The modified max weight allowable on this surface type for an S-type
   * (single) landing gear configuration, in kilopounds (kip).
   */
  sWtKipMod?: number;

  /**
   * Body param: User input rationale for the manual modification of the prescribed
   * value indicating the max weight allowable on this surface for an S-type (single)
   * landing gear configuration. For more information, contact the provider source.
   */
  sWtKipModNote?: string;
  ...
  /**
   * Body param: The max weight allowable on this surface type for a TDT-type (twin
   * delta tandem) landing gear configuration, in kilopounds (kip).Note: The
   * corresponding equivalent field is not converted by the UDL and may or may not be
   * supplied by the provider. The provider/consumer is responsible for all unit
   * conversions.
   */
  ...
  /**
   * Body param: The modified max weight allowable on this surface type for a
   * TDT-type (twin delta tandem) landing gear configuration, in kilopounds (kip).
   */
  tdtWtKipMod?: number;

  /**
   * Body param: User input rationale for the manual modification of the prescribed
   * value indicating the max weight allowable on this surface for a TDT-type (twin
   * delta tandem) landing gear configuration. For more information, contact the
   * provider source.
   */
  tdtWtKipModNote?: string;
  ...
  /**
   * Body param: The max weight allowable on this surface type for a TDT-type (twin
   * delta tandem) landing gear configuration, in kilonewtons (kN).Note: The
   * corresponding equivalent field is not converted by the UDL and may or may not be
   * supplied by the provider. The provider/consumer is responsible for all unit
   * conversions.
   */
  ...
  /**
   * Body param: The max weight allowable on this surface type for a TRT-type (triple
   * tandem) landing gear configuration, in kilopounds (kip).Note: The corresponding
   * equivalent field is not converted by the UDL and may or may not be supplied by
   * the provider. The provider/consumer is responsible for all unit conversions.
   */
  ...
  /**
   * Body param: The modified max weight allowable on this surface type for a
   * TRT-type (triple tandem) landing gear configuration, in kilopounds (kip).
   */
  trtWtKipMod?: number;

  /**
   * Body param: User input rationale for the manual modification of the prescribed
   * value indicating the max weight allowable on this surface for a TRT-type (triple
   * tandem) landing gear configuration. For more information, contact the provider
   * source.
   */
  trtWtKipModNote?: string;
  ...
  /**
   * Body param: The max weight allowable on this surface type for a GDSS TT-type
   * (twin tandem) landing gear configuration, in kilopounds (kip).Note: The
   * corresponding equivalent field is not converted by the UDL and may or may not be
   * supplied by the provider. The provider/consumer is responsible for all unit
   * conversions.
  ...
  /**
   * Body param: The modified max weight allowable on this surface type for a GDSS
   * TT-type (twin tandem) landing gear configuration, in kilopounds (kip).
   */
  ttWtKipMod?: number;

  /**
   * Body param: User input rationale for the manual modification of the prescribed
   * value indicating the max weight allowable on this surface for a GDSS TT-type
   * (twin tandem) landing gear configuration. For more information, contact the
   * provider source.
   */
  ttWtKipModNote?: string;
  ...
  /**
   * Body param: The max weight allowable on this surface type for a T-type (twin
   * (dual)) landing gear configuration, in kilopounds (kip).Note: The corresponding
   * equivalent field is not converted by the UDL and may or may not be supplied by
   * the provider. The provider/consumer is responsible for all unit conversions.
   */
  tWtKip?: number;
  ...
  /**
   * Body param: The modified max weight allowable on this surface type for a T-type
   * (twin (dual)) landing gear configuration, in kilopounds (kip).
   */
  tWtKipMod?: number;

  /**
   * Body param: User input rationale for the manual modification of the prescribed
   * value indicating the max weight allowable on this surface for a T-type
   * (twin(dual)) landing gear configuration. For more information, contact the
   * provider source.
   */
  tWtKipModNote?: string;
  ...
  /**
   * Body param: The max weight allowable on this surface type for a T-type (twin
   * (dual)) landing gear configuration, in kilonewtons (kN).Note: The corresponding
   * equivalent field is not converted by the UDL and may or may not be supplied by
   * the provider. The provider/consumer is responsible for all unit conversions.
   */
  tWtKN?: number;
  ...
  /**
   * Body param: The width of the surface type, in feet.
   */
  widthFt?: number;

  /**
   * Body param: The width of the surface type, in meters.
   */
  widthM?: number;
}
