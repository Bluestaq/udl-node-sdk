...
export class Onorbitsolararray extends APIResource {
   ...
   */
  update(params: OnorbitsolararrayUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/onorbitsolararray/${path_id}`, {
...
export interface OnorbitsolararrayUpdateParams {
  /**
   * Path param: The ID of the OnorbitSolarArray to update.
   */
  path_id: string;
  ...
  /**
   * Body param: ID of the SolarArray.
   */
  idSolarArray: string;
  ...
  /**
   * Body param: The number of solar arrays on the spacecraft of the type identified
   * by idSolarArray.
   */
  quantity?: number;

  /**
   * Body param: Model representation of information on on-orbit/spacecraft solar
   * arrays. A spacecraft may have multiple solar arrays and each solar array can
   * have multiple 'details' records compiled by different sources.
   */
