...
export class History extends APIResource {
  ...
  list(query: HistoryListParams, options?: Core.RequestOptions): Core.APIPromise<HistoryListResponse> {
    return this._client.get('/udl/isrcollection/history', { query, ...options });
  }
  ...
  aodr(query: HistoryAodrParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    return this._client.get('/udl/isrcollection/history/aodr', {
      query,
      ...options,
  ...
  count(query: HistoryCountParams, options?: Core.RequestOptions): Core.APIPromise<string> {
    return this._client.get('/udl/isrcollection/history/count', {
      query,
      ...options,
...
export type HistoryListResponse = Array<IsrcollectionHistoryAPI.IsrCollectionFull>;
