...
export class History extends APIResource {
  ...
  list(
    ...
    return this._client.getAPIList('/udl/isrcollection/history', OffsetPage<HistoryListResponse>, {
      query,
      ...options,
    });
  }
...
export interface HistoryListResponse {
   ...
   */
  collectionRequirements?: Array<HistoryListResponse.CollectionRequirement>;
