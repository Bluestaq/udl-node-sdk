...
export class History extends APIResource {
  ...
  list(query: HistoryListParams, options?: RequestOptions): PagePromise<HistoryListResponsesOffsetPage, HistoryListResponse> {
    return this._client.getAPIList('/udl/isrcollection/history', OffsetPage<HistoryListResponse>, { query, ...options });
  }
  ...
  aodr(query: HistoryAodrParams, options?: RequestOptions): APIPromise<void> {
    return this._client.get('/udl/isrcollection/history/aodr', { query, ...options, headers: buildHeaders([{Accept: '*/*'}, options?.headers]) });
  }
  ...
  count(query: HistoryCountParams, options?: RequestOptions): APIPromise<string> {
    return this._client.get('/udl/isrcollection/history/count', { query, ...options, headers: buildHeaders([{Accept: 'text/plain'}, options?.headers]) });
  }
}
...
export interface HistoryListResponse {
   ...
   */
  taskings?: Array<HistoryListResponse.Tasking>;

  /**
   * Object for data dissemination.
   */
  transit?: Array<HistoryListResponse.Transit>;
