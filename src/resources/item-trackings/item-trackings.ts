...
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/item-trackings/history';
import {
  History,
  HistoryCountParams,
...
} from 'bluestaq@unified-data-library/resources/item-trackings/history';
