...
export class Operatingunit extends APIResource {
   ...
   * @example
   * ```ts
   * const operatingunitFull = await client.operatingunit.get(
   *   'id',
   * );
   * ```
   */
   ...
   * @example
   * ```ts
   * const operatingunitFulls = await client.operatingunit.tuple(
   *   { columns: 'columns' },
   * );
   * ```
   */
 ...
 */
export interface OperatingunitListResponse {
  /**
