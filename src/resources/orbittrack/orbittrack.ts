...
export type OrbittrackListResponse = Array<OrbittrackListResponse.OrbittrackListResponseItem>;
...
export namespace OrbittrackListResponse {
   ...
   */
  export interface OrbittrackListResponseItem {
    /**
     ...
     */
    trackSensors?: Array<OrbittrackListResponseItem.TrackSensor>;
  ...
  export namespace OrbittrackListResponseItem {
    /**
...
export type OrbittrackTupleResponse = Array<OrbittrackHistoryAPI.OrbittrackFull>;

export interface OrbittrackListParams {
  /**
   * Track timestamp in ISO8601 UTC format, with microsecond precision.
