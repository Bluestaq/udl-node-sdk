...
export type EmitterGeolocationQueryResponse =
  Array<EmitterGeolocationQueryResponse.EmitterGeolocationQueryResponseItem>;

export namespace EmitterGeolocationQueryResponse {
  /**
   * Model representation of Emitter geolocation data for a signal of interest.
   */
  export interface EmitterGeolocationQueryResponseItem {
    /**
     * Classification marking of the data in IC/CAPCO Portion-marked format.
     */
    classificationMarking: string;
