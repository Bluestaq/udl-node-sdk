...
export class Monoradar extends APIResource {
   ...
   */
  list(query: MonoradarListParams, options?: Core.RequestOptions): Core.APIPromise<MonoradarListResponse> {
    return this._client.get('/udl/monoradar', { query, ...options });
  }
   ...
   */
  count(query: MonoradarCountParams, options?: Core.RequestOptions): Core.APIPromise<string> {
   ...
   */
  createBulk(body: MonoradarCreateBulkParams, options?: Core.RequestOptions): Core.APIPromise<void> {
   ...
   * hours ago.
   */
  tuple(query: MonoradarTupleParams, options?: Core.RequestOptions): Core.APIPromise<MonoradarTupleResponse> {
    return this._client.get('/udl/monoradar/tuple', { query, ...options });
  }
}

export type MonoradarListResponse = Array<MonoradarListResponse.MonoradarListResponseItem>;

export namespace MonoradarListResponse {
  /**
   ...
   * generate the record.
   */
  export interface MonoradarListResponseItem {
    /**
...
export interface MonoradarListParams {
  /**
   * Target detection time, in ISO 8601 UTC format with microsecond precision.
...
export type MonoradarCreateBulkParams = Array<MonoradarCreateBulkParams.Body>;
