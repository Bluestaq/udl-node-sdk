...
export class History extends APIResource {
  ...
  ): PagePromise<OnboardnavigationFullsOffsetPage, OnboardnavigationFull> {
    return this._client.getAPIList('/udl/onboardnavigation/history', OffsetPage<OnboardnavigationFull>, {
      query,
      ...options,
    });
  }
