...
import * as EquipmentRemarksAPI from 'bluestaq@unified-data-library/resources/equipment-remarks';
...
export class Equipment extends APIResource {
   ...
   * @example
   * ```ts
   * const response = await client.equipment.queryHelp();
   * ```
   */
  queryHelp(options?: RequestOptions): APIPromise<EquipmentQueryHelpResponse> {
    return this._client.get('/udl/equipment/queryhelp', options);
  }
