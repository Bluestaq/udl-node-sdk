...
export class UdlSkyimagery extends APIResource {
  /**
   ...
   */
  create(body: UdlSkyimageryCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
...
export interface UdlSkyimageryCreateParams {
  /**
   ...
   */
  eoObservations?: Array<UdlSkyimageryCreateParams.EoObservation>;
...
export namespace UdlSkyimageryCreateParams {
  /**
...
export declare namespace UdlSkyimagery {
  export { type UdlSkyimageryCreateParams as UdlSkyimageryCreateParams };
}
