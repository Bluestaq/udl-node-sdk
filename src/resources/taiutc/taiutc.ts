...
export class Taiutc extends APIResource {
   ...
   */
  update(params: TaiutcUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/taiutc/${path_id}`, {
...
export type TaiutcListResponse = Array<TaiutcListResponse.TaiutcListResponseItem>;

export namespace TaiutcListResponse {
  /**
   ...
   */
  export interface TaiutcListResponseItem {
    /**
...
export interface TaiutcUpdateParams {
  /**
   * Path param: The ID of the TAIUTC to update.
   */
  path_id: string;

  /**
   * Body param: Effective date/time for the leap second adjustment.
   */
  adjustmentDate: string;
  ...
  /**
   * Body param: Multiplication factor of the leap second adjustment.
   */
  multiplicationFactor?: number;
  ...
  /**
   * Body param: Total/cumulative offset between TAI and UTC time as of
   * adjustmentDate, in seconds.
   */
  taiUTC?: number;
}

export interface TaiutcListParams {
  /**
