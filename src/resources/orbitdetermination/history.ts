...
export class History extends APIResource {
   ...
   * for await (const historyListResponse of client.orbitdetermination.history.list()) {
   *   // ...
   * }
   * ```
   */
  list(query: HistoryListParams | null | undefined = {}, options?: RequestOptions): PagePromise<HistoryListResponsesOffsetPage, HistoryListResponse> {
    return this._client.getAPIList('/udl/orbitdetermination/history', OffsetPage<HistoryListResponse>, { query, ...options });
  }
   ...
   * @example
   * ```ts
   * await client.orbitdetermination.history.aodr();
   * ```
   */
  aodr(query: HistoryAodrParams | null | undefined = {}, options?: RequestOptions): APIPromise<void> {
    return this._client.get('/udl/orbitdetermination/history/aodr', { query, ...options, headers: buildHeaders([{Accept: '*/*'}, options?.headers]) });
  }
   ...
   * ```ts
   * const response =
   *   await client.orbitdetermination.history.count();
   * ```
   */
  count(query: HistoryCountParams | null | undefined = {}, options?: RequestOptions): APIPromise<string> {
    return this._client.get('/udl/orbitdetermination/history/count', { query, ...options, headers: buildHeaders([{Accept: 'text/plain'}, options?.headers]) });
  }
}
...
export interface HistoryListResponse {
   ...
   */
  aprioriElset?: HistoryListResponse.AprioriElset;
   ...
   * provider.
   */
  aprioriStateVector?: HistoryListResponse.AprioriStateVector;
