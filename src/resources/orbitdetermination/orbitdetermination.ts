...
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/orbitdetermination/history';
import {
  History,
  HistoryAodrParams,
  HistoryCountParams,
...
} from 'bluestaq@unified-data-library/resources/orbitdetermination/history';
 ...
 */
export interface OrbitdeterminationListResponse {
  /**
 ...
 * Perturbations or Special Perturbations orbital updates.
 */
export interface OrbitdeterminationGetResponse {
  /**
   * Classification marking of the data in IC/CAPCO Portion-marked format.
   */
  classificationMarking: string;
...
export namespace OrbitdeterminationGetResponse {
  /**
   * An element set is a collection of Keplerian orbital elements describing an orbit
   * of a particular satellite. The data is used along with an orbit propagator in
   * order to predict the motion of a satellite. The element set, or elset for short,
...
export namespace OrbitdeterminationTupleResponse {
   ...
   * Perturbations or Special Perturbations orbital updates.
   */
  export interface OrbitdeterminationTupleResponseItem {
    /**
     * Classification marking of the data in IC/CAPCO Portion-marked format.
     */
    classificationMarking: string;
     ...
     * consists of identification data, the classical elements and drag parameters.
     */
    aprioriElset?: OrbitdeterminationTupleResponseItem.AprioriElset;
     ...
     * provider.
     */
    aprioriStateVector?: OrbitdeterminationTupleResponseItem.AprioriStateVector;
  ...
  export namespace OrbitdeterminationTupleResponseItem {
    /**
     * An element set is a collection of Keplerian orbital elements describing an orbit
     * of a particular satellite. The data is used along with an orbit propagator in
     * order to predict the motion of a satellite. The element set, or elset for short,
...
export interface OrbitdeterminationCreateParams {
   ...
   * consists of identification data, the classical elements and drag parameters.
   */
  aprioriElset?: OrbitdeterminationCreateParams.AprioriElset;
   ...
   * provider.
   */
  aprioriStateVector?: OrbitdeterminationCreateParams.AprioriStateVector;
...
export namespace OrbitdeterminationCreateParams {
  /**
   * An element set is a collection of Keplerian orbital elements describing an orbit
   * of a particular satellite. The data is used along with an orbit propagator in
   * order to predict the motion of a satellite. The element set, or elset for short,
...
export interface OrbitdeterminationListParams extends OffsetPageParams {
  /**
