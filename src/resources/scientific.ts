...
export class Scientific extends APIResource {
   ...
   */
  create(body: ScientificCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
   ...
   */
  update(params: ScientificUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/scientific/${path_id}`, {
   ...
   */
  list(options?: Core.RequestOptions): Core.APIPromise<ScientificListResponse> {
  ...
  delete(id: string, options?: Core.RequestOptions): Core.APIPromise<void> {
    return this._client.delete(`/udl/scientific/${id}`, {
      ...options,
      headers: { Accept: '*/*', ...options?.headers },
    });
  }
   ...
   * path parameter.
   */
  get(id: string, options?: Core.RequestOptions): Core.APIPromise<ScientificGetResponse> {
    return this._client.get(`/udl/scientific/${id}`, options);
  }
   ...
   */
  tuple(
    query: ScientificTupleParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<ScientificTupleResponse> {
...
export interface ScientificCreateParams {
   ...
   * entity can have an operating unit, a location (if terrestrial), and statuses.
   */
  entity?: ScientificCreateParams.Entity;
...
export namespace ScientificCreateParams {
  /**
   * An entity is a generic representation of any object within a space/SSA system
   * such as sensors, on-orbit objects, RF Emitters, space craft buses, etc. An
   * entity can have an operating unit, a location (if terrestrial), and statuses.
...
export interface ScientificUpdateParams {
  /**
   * Path param: The ID of the Scientific to update.
   */
  path_id: string;
  ...
  /**
   * Body param: Sensor name from sera data, e.g. SEM/MAG (SEM / Magnetometer).
   */
  name: string;
   ...
   * and statuses.
   */
  entity?: ScientificUpdateParams.Entity;

  /**
   * Body param: Frequency band, e.g. Gamma.
   */
  frequencyBand?: string;
  ...
  /**
   * Body param: ID of the parent entity for this Scientific.
   */
  idEntity?: string;
  ...
  /**
   * Body param: Notes associated with the payload.
   */
  notes?: string;
  ...
  /**
   * Body param: Payload category, e.g. Magnetometer, Radiometer, Sensor, etc.
   */
  payloadCategory?: string;
}

export namespace ScientificUpdateParams {
  /**
   * An entity is a generic representation of any object within a space/SSA system
   * such as sensors, on-orbit objects, RF Emitters, space craft buses, etc. An
   * entity can have an operating unit, a location (if terrestrial), and statuses.
