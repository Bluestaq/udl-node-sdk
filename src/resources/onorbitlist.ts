...
export class Onorbitlist extends APIResource {
   ...
   */
  update(params: OnorbitlistUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/onorbitlist/${path_id}`, {
...
export interface OnorbitlistUpdateParams {
  /**
   * Path param: The ID of the OnorbitList to update.
   */
  path_id: string;
  ...
  /**
   * Body param: Unique name of the list.
   */
  name: string;
  ...
  /**
   * Body param: Description of the list.
   */
  description?: string;

  /**
   * Body param: Ordered array of Onorbit IDs belonging to this list.
   */
  onorbits?: Array<string>;
