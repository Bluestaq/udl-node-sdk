...
export type SoiobservationsetListResponse =
  Array<SoiobservationsetListResponse.SoiobservationsetListResponseItem>;
...
export namespace SoiobservationsetListResponse {
   ...
   * observation sets.
   */
  export interface SoiobservationsetListResponseItem {
    /**
     ...
     */
    calibrations?: Array<SoiobservationsetListResponseItem.Calibration>;
  ...
  export namespace SoiobservationsetListResponseItem {
    /**
...
export interface SoiobservationsetListParams {
  /**
   * Observation set detection start time in ISO 8601 UTC with microsecond precision.
