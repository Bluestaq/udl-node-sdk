...
import * as LogisticsSupportAPI from 'bluestaq@unified-data-library/resources/logistics-support/logistics-support';
import * as Shared from 'bluestaq@unified-data-library/resources/shared';
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/logistics-support/history';
import {
  History,
  HistoryAodrParams,
  HistoryCountParams,
...
} from 'bluestaq@unified-data-library/resources/logistics-support/history';
 ...
 */
export interface LogisticsDiscrepancyInfosFull {
  /**
 ...
 */
export interface LogisticsPartsFull {
  /**
   ...
   */
  logisticsStocks?: Array<LogisticsStocksFull>;
 ...
 */
export interface LogisticsRemarksAbridged {
  /**
 ...
 */
export interface LogisticsSpecialtiesFull {
  /**
 ...
 * The supply stocks for this support item.
 */
export interface LogisticsStocksFull {
  /**
 ...
 */
export interface LogisticsSupportItemsFull {
  /**
   ...
   * The parts associated with this support item.
   */
  logisticsParts?: Array<LogisticsPartsFull>;
   ...
   * The specialties required to implement this support item.
   */
  logisticsSpecialties?: Array<LogisticsSpecialtiesFull>;
 ...
 */
export interface LogisticsTransportationPlansFull {
  /**
   ...
   */
  logisticsSegments?: Array<LogisticsSegmentsFull>;

  /**
   * Remarks associated with this transportation plan.
   */
  logisticsTransportationPlansRemarks?: Array<LogisticsRemarksFull>;
...
export interface LogisticsSupportListResponse {
   ...
   * Remarks associated with this LogisticsSupport record.
   */
  logisticsRemarks?: Array<LogisticsRemarksAbridged>;
...
export namespace LogisticsSupportListResponse {
  ...
  export interface LogisticsSupportItem {
     ...
     * Remarks associated with this support item.
     */
    logisticsRemarks?: Array<LogisticsSupportAPI.LogisticsRemarksAbridged>;
  ...
  export interface LogisticsTransportationPlan {
     ...
     * Remarks associated with this transportation plan.
     */
    logisticsTransportationPlansRemarks?: Array<LogisticsSupportAPI.LogisticsRemarksAbridged>;
...
export interface LogisticsSupportGetResponse {
   ...
   * Discrepancy information associated with this LogisticsSupport record.
   */
  logisticsDiscrepancyInfos?: Array<LogisticsDiscrepancyInfosFull>;
   ...
   * Support items associated with this LogisticsSupport record.
   */
  logisticsSupportItems?: Array<LogisticsSupportItemsFull>;

  /**
   * Transportation plans associated with this LogisticsSupport record, used to
   * coordinate maintenance efforts.
   */
  logisticsTransportationPlans?: Array<LogisticsTransportationPlansFull>;
