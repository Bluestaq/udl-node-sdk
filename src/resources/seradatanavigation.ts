...
export class Seradatanavigation extends APIResource {
   ...
   */
  update(params: SeradatanavigationUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/seradatanavigation/${path_id}`, {
...
export type SeradatanavigationListResponse =
  Array<SeradatanavigationListResponse.SeradatanavigationListResponseItem>;

export namespace SeradatanavigationListResponse {
  /**
   * Details for a navigation payload from Seradata.
   */
  export interface SeradatanavigationListResponseItem {
    /**
...
export interface SeradatanavigationUpdateParams {
  /**
   * Path param: The ID of the SeradataNavigation to update.
   */
  path_id: string;
  ...
  /**
   * Body param: Area of coverage, e.g. Worldwide, India, etc.
   */
  areaCoverage?: string;

  /**
   * Body param: Type of clock, e.g. Rubidium, Hydrogen Maser, etc.
   */
  clockType?: string;
  ...
  /**
   * Body param: UUID of the parent Navigation record.
   */
  idNavigation?: string;

  /**
   * Body param: Location accuracy in meters.
   */
  locationAccuracy?: number;
  ...
  /**
   * Body param: Frequency for this payload.
   */
  modeFrequency?: string;

  /**
   * Body param: Modes of operation.
   */
  modes?: string;

  /**
   * Body param: Sensor name from Seradata, e.g. WAAS GEO-5, etc.
   */
  name?: string;
  ...
  /**
   * Body param: Navigation payload type, e.g. WAAS, GAGAN, etc.
   */
  payloadType?: string;
}
