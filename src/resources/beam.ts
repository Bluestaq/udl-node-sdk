...
export class Beam extends APIResource {
   ...
   * parameter.
   */
  retrieve(params: BeamRetrieveParams, options?: Core.RequestOptions): Core.APIPromise<BeamFull> {
    const { path_id, body_id } = params;
    return this._client.get(`/udl/beam/${path_id}`, options);
  }
   ...
   * hours ago.
   */
  tuple(params: BeamTupleParams, options?: Core.RequestOptions): Core.APIPromise<BeamTupleResponse> {
    const { columns } = params;
    return this._client.get('/udl/beam/tuple', options);
  }
}
...
export interface BeamRetrieveParams {
  ...
  /**
   * Body param: The ID of the Beam to find.
   */
  body_id: string;
}
