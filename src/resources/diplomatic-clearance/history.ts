...
export class History extends APIResource {
   ...
   * ```
   */
  list(query: HistoryListParams, options?: RequestOptions): PagePromise<DiplomaticclearanceFullsOffsetPage, Shared.DiplomaticclearanceFull> {
    return this._client.getAPIList('/udl/diplomaticclearance/history', OffsetPage<Shared.DiplomaticclearanceFull>, { query, ...options });
  }
  ...
  aodr(query: HistoryAodrParams, options?: RequestOptions): APIPromise<void> {
    return this._client.get('/udl/diplomaticclearance/history/aodr', { query, ...options, headers: buildHeaders([{Accept: '*/*'}, options?.headers]) });
  }
  ...
  count(query: HistoryCountParams, options?: RequestOptions): APIPromise<string> {
    return this._client.get('/udl/diplomaticclearance/history/count', { query, ...options, headers: buildHeaders([{Accept: 'text/plain'}, options?.headers]) });
  }
}
