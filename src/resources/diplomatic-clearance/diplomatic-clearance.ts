...
export interface DiplomaticClearanceUpdateParams {
   ...
   * departure, in ISO 8601 UTC format with millisecond precision.
   */
  firstDepDate: string;

  /**
   * Body param: Unique identifier of the Mission associated with this diplomatic
   * clearance record.
   */
  idMission: string;
  ...
  /**
   * Body param: Collection of diplomatic clearance remarks.
   */
  ...
  /**
   * Body param: Suspense date for the diplomatic clearance worksheet to be worked,
   * in ISO 8601 UTC format with millisecond precision.
   */
  docDeadline?: string;

  /**
   * Body param: Optional diplomatic clearance worksheet ID from external systems.
