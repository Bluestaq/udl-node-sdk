...
export class AircraftSorties extends APIResource {
   ...
   * @example
   * ```ts
   * await client.airOperations.aircraftSorties.create({
   ...
   * for await (const aircraftsortieAbridged of client.airOperations.aircraftSorties.list(
   ...
   * ```ts
   * const response =
   *   await client.airOperations.aircraftSorties.count({
   *     plannedDepTime: '2019-12-27T18:11:19.117Z',
   *   });
   * ```
   */
   ...
   * @example
   * ```ts
   * await client.airOperations.aircraftSorties.createBulk({
   *   body: [
   *     {
   *       classificationMarking: 'U',
   *       dataMode: 'TEST',
   ...
   * @example
   * ```ts
   * await client.airOperations.aircraftSorties.historyAodr({
   *   plannedDepTime: '2019-12-27T18:11:19.117Z',
   * });
   * ```
   */
  historyAodr(query: AircraftSortyHistoryAodrParams, options?: RequestOptions): APIPromise<void> {
   ...
   * ```ts
   * const response =
   *   await client.airOperations.aircraftSorties.historyCount({
   *     plannedDepTime: '2019-12-27T18:11:19.117Z',
   *   });
   * ```
   */
  historyCount(query: AircraftSortyHistoryCountParams, options?: RequestOptions): APIPromise<string> {
   ...
   *   await client.airOperations.aircraftSorties.historyQuery({
   *     plannedDepTime: '2019-12-27T18:11:19.117Z',
   *   });
   * ```
   */
  historyQuery(
    query: AircraftSortyHistoryQueryParams,
    options?: RequestOptions,
  ): APIPromise<AircraftSortyHistoryQueryResponse> {
...
export type AircraftSortyHistoryCountResponse = string;

export type AircraftSortyHistoryQueryResponse = Array<Shared.AircraftsortieFull>;
...
export interface AircraftSortyListParams extends OffsetPageParams {
  /**
   * The scheduled time that the Aircraft sortie is planned to depart, in ISO 8601
...
export interface AircraftSortyCountParams {
  /**
   * The scheduled time that the Aircraft sortie is planned to depart, in ISO 8601
   * UTC format with millisecond precision. (YYYY-MM-DDTHH:MM:SS.sssZ)
   */
...
export interface AircraftSortyCreateBulkParams {
  body: Array<AircraftSortyCreateBulkParams.Body>;
}

export namespace AircraftSortyCreateBulkParams {
  /**
   * Information related to the planning, load, status, and deployment or dispatch of
   * one aircraft to carry out a mission.
   */
...
export interface AircraftSortyHistoryAodrParams {
  /**
   * The scheduled time that the Aircraft sortie is planned to depart, in ISO 8601
   * UTC format with millisecond precision. (YYYY-MM-DDTHH:MM:SS.sssZ)
   */
...
export interface AircraftSortyHistoryCountParams {
  /**
   * The scheduled time that the Aircraft sortie is planned to depart, in ISO 8601
   * UTC format with millisecond precision. (YYYY-MM-DDTHH:MM:SS.sssZ)
   */
...
export interface AircraftSortyHistoryQueryParams {
  /**
   * The scheduled time that the Aircraft sortie is planned to depart, in ISO 8601
   * UTC format with millisecond precision. (YYYY-MM-DDTHH:MM:SS.sssZ)
   */
...
export interface AircraftSortyUnvalidatedPublishParams {
  body: Array<AircraftSortyUnvalidatedPublishParams.Body>;
}

export namespace AircraftSortyUnvalidatedPublishParams {
  /**
   * Information related to the planning, load, status, and deployment or dispatch of
   * one aircraft to carry out a mission.
   */
