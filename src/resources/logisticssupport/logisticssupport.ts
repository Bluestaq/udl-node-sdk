...
export class Logisticssupport extends APIResource {
   ...
   * assistance.
   */
  update(params: LogisticssupportUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/logisticssupport/${path_id}`, {
...
export interface LogisticssupportUpdateParams {
  /**
   * Path param: The ID of the logistics support clearance to update.
   */
  path_id: string;
  ...
  /**
   * Body param: The time this report was created, in ISO 8601 UTC format with
   * millisecond precision.
   */
  rptCreatedTime: string;
  ...
  /**
   * Body param: The current ICAO of the aircraft that is the subject of this
   * LogisticsSupportDetails record.
   */
  currICAO?: string;

  /**
   * Body param: The estimated time mission capable for the aircraft, in ISO 8601 UCT
   * format with millisecond precision. This is the estimated time when the aircraft
   * is mission ready.
   */
  etic?: string;

  /**
   * Body param: Logistics estimated time mission capable.
   */
  etmc?: string;

  /**
   * Body param: Optional system identifier from external systs. This field has no
  ...
  /**
   * Body param: This field identifies the pacing event for bringing the aircraft to
   * Mission Capable status. It is used in calculating the Estimated Time Mission
   * Capable (ETMC) value. Acceptable values are WA (Will Advise), INW (In Work),
   * P+hhh.h (where P=parts and hhh.h is the number of hours up to 999 plus tenths of
   * hours), EQ+hhh.h (EQ=equipment), MRT+hhh.h (MRT=maintenance recovery team).
   */
  logisticAction?: string;

  /**
   * Body param: Discrepancy information associated with this LogisticsSupport
   * record.
   */
  logisticsDiscrepancyInfos?: Array<LogisticssupportUpdateParams.LogisticsDiscrepancyInfo>;

  /**
   * Body param: The identifier that represents a Logistics Master Record.
   */
  logisticsRecordId?: string;

  /**
   * Body param: Remarks associated with this LogisticsSupport record.
   */
  logisticsRemarks?: Array<LogisticssupportUpdateParams.LogisticsRemark>;

  /**
   * Body param: Support items associated with this LogisticsSupport record.
   */
  logisticsSupportItems?: Array<LogisticssupportUpdateParams.LogisticsSupportItem>;

  /**
   * Body param: Transportation plans associated with this LogisticsSupport record,
   * used to coordinate maintenance efforts.
   */
  logisticsTransportationPlans?: Array<LogisticssupportUpdateParams.LogisticsTransportationPlan>;

  /**
   * Body param: The maintenance status code of the aircraft which may be based on
   * pilot descriptions or evaluation codes. Contact the source provider for details.
   */
  maintStatusCode?: string;

  /**
   * Body param: The time indicating when all mission essential problems with a given
   * aircraft have been fixed and is mission capable. This datetime should be in ISO
   * 8601 UTC format with millisecond precision.
   */
  mcTime?: string;

  /**
   * Body param: The time indicating when a given aircraft breaks for a mission
   * essential reason. This datetime should be in ISO 8601 UTC format with
   * millisecond precision.
   */
  meTime?: string;
  ...
  /**
   * Body param: The organization that owns this logistics record.
   */
  owner?: string;

  /**
   * Body param: This is used to indicate whether a closed master record has been
   * reopened.
   */
  reopenFlag?: boolean;

  /**
   * Body param: The time this report was closed, in ISO 8601 UTC format with
   * millisecond precision.
   */
  rptClosedTime?: string;

  /**
   * Body param: The supplying ICAO of the aircraft that is the subject of this
   * LogisticsSupportDetails record.
   */
  suppICAO?: string;

  /**
   * Body param: The tail number of the aircraft that is the subject of this
   * LogisticsSupportDetails record.
   */
  tailNumber?: string;
}
