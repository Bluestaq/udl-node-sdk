...
export class History extends APIResource {
  ...
  list(
    ...
    return this._client.get('/udl/logisticssupport/history', { query, ...options });
  }
...
export namespace HistoryListResponse {
  ...
  export interface HistoryListResponseItem {
     ...
     */
    logisticsDiscrepancyInfos?: Array<HistoryListResponseItem.LogisticsDiscrepancyInfo>;
     ...
     */
    logisticsSupportItems?: Array<HistoryListResponseItem.LogisticsSupportItem>;

    /**
     * Transportation plans associated with this LogisticsSupport record, used to
     * coordinate maintenance efforts.
     */
    logisticsTransportationPlans?: Array<HistoryListResponseItem.LogisticsTransportationPlan>;
