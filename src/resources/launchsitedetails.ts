...
export class Launchsitedetails extends APIResource {
   ...
   */
  update(params: LaunchsitedetailUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/launchsitedetails/${path_id}`, {
...
export namespace LaunchsitedetailGetResponse {
  /**
   * Model representation of a location, which is a specific fixed point on the earth
   * and is used to denote the locations of fixed sensors, operating units, etc.
   */
...
export interface LaunchsitedetailCreateParams {
   ...
   * and is used to denote the locations of fixed sensors, operating units, etc.
   */
  location?: LaunchsitedetailCreateParams.Location;
...
export namespace LaunchsitedetailCreateParams {
  /**
   * Model representation of a location, which is a specific fixed point on the earth
   * and is used to denote the locations of fixed sensors, operating units, etc.
   */
...
export interface LaunchsitedetailUpdateParams {
  /**
   * Path param: The ID of the LaunchSiteDetails to update.
   */
  path_id: string;
  ...
  /**
   * Body param: Identifier of the parent launch site record.
   */
  idLaunchSite: string;
  ...
  /**
   * Body param: Array of supported launch inclinations known for this site. The
   * array is always sized as a multiple of two and includes start/end values to
  ...
  /**
   * Body param: Notes/description of the launch site.
   */
  description?: string;

  /**
   * Body param: ID of the location data for the launch site, or null if mobile (e.g.
   * sea launch platform in international waters).
   */
  idLocation?: string;

  /**
   * Body param: Launch site group name. Multiple launch sites may be colocated
   ...
   * units, etc.
   */
  location?: LaunchsitedetailUpdateParams.Location;
...
export namespace LaunchsitedetailUpdateParams {
  /**
   * Model representation of a location, which is a specific fixed point on the earth
   * and is used to denote the locations of fixed sensors, operating units, etc.
   */
