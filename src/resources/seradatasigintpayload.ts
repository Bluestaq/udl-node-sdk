...
export class Seradatasigintpayload extends APIResource {
   ...
   * assistance.
   */
  update(params: SeradatasigintpayloadUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/seradatasigintpayload/${path_id}`, {
...
export interface SeradatasigintpayloadUpdateParams {
  /**
   * Path param: The ID of the SeradataSigIntPayload to update.
   */
  path_id: string;
  ...
  /**
   * Body param: Frequency coverage for this payload.
   */
  frequencyCoverage?: string;
  ...
  /**
   * Body param: Intercept parameters.
   */
  interceptParameters?: string;
  ...
  /**
   * Body param: Sensor name from Seradata.
   */
  name?: string;
  ...
  /**
   * Body param: Positional Accuracy for this payload.
   */
  positionalAccuracy?: string;
  ...
  /**
   * Body param: SIGINT Payload type, e.g. Comint, Elint, etc.
   */
  type?: string;
}
