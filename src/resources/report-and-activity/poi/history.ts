...
export class History extends APIResource {
   ...
   * for await (const historyListResponse of client.reportAndActivity.poi.history.list(
   ...
   * @example
   * ```ts
   * await client.reportAndActivity.poi.history.aodr({
   *   ts: '2019-12-27T18:11:19.117Z',
   * });
   * ```
   */
   ...
   * ```ts
   * const response =
   *   await client.reportAndActivity.poi.history.count({
   *     ts: '2019-12-27T18:11:19.117Z',
   *   });
   * ```
   */
