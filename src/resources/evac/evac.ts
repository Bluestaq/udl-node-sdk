...
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/evac/history';
import {
  History,
  HistoryCountParams,
  HistoryCountResponse,
  HistoryListParams,
} from 'bluestaq@unified-data-library/resources/evac/history';
import * as TupleAPI from 'bluestaq@unified-data-library/resources/evac/tuple';
import { Tuple, TupleListParams } from 'bluestaq@unified-data-library/resources/evac/tuple';
