...
export class Evac extends APIResource {
   ...
   * parameter.
   */
  retrieve(params: EvacRetrieveParams, options?: Core.RequestOptions): Core.APIPromise<Shared.EvacFull> {
    const { path_id, body_id } = params;
    return this._client.get(`/udl/evac/${path_id}`, options);
  }
   ...
   */
  list(params: EvacListParams, options?: Core.RequestOptions): Core.APIPromise<EvacListResponse> {
    const { reqTime } = params;
    return this._client.get('/udl/evac', options);
  }
   ...
   */
  count(params: EvacCountParams, options?: Core.RequestOptions): Core.APIPromise<string> {
    const { reqTime } = params;
...
export interface EvacRetrieveParams {
  ...
  /**
   * Body param: The ID of the Evac to retrieve.
   */
  body_id: string;
}
