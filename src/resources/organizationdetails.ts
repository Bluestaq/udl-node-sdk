...
export class Organizationdetails extends APIResource {
   ...
   */
  update(params: OrganizationdetailUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/organizationdetails/${path_id}`, {
   ...
   * have detail records from several sources.
   */
  get(id: string, options?: Core.RequestOptions): Core.APIPromise<OrganizationdetailGetResponse> {
 ...
 * particular source.
 */
export interface OrganizationdetailGetResponse {
  /**
   * Classification marking of the data in IC/CAPCO Portion-marked format.
   */
  classificationMarking: string;
...
export interface OrganizationdetailUpdateParams {
  /**
   * Path param: The ID of the OrganizationDetails to update.
   */
  path_id: string;
  ...
  /**
   * Body param: Unique identifier of the parent organization.
   */
  idOrganization: string;

  /**
   * Body param: Organization details name.
   */
  name: string;
  ...
  /**
   * Body param: Street number of the organization.
   */
  address1?: string;

  /**
   * Body param: Field for additional organization address information such as PO Box
   * and unit number.
   */
  address2?: string;

  /**
   * Body param: Contains the third line of address information for an organization.
   */
  address3?: string;

  /**
   * Body param: Designated broker for this organization.
   */
  broker?: string;

  /**
   * Body param: For organizations of type CORPORATION, the name of the Chief
   * Executive Officer.
   */
  ceo?: string;
  ...
  /**
   * Body param: For organizations of type CORPORATION, the company EBITDA value as
   * of financialYearEndDate in US Dollars.
   */
  ebitda?: number;

  /**
   * Body param: Listed contact email address for the organization.
   */
  email?: string;

  /**
   * Body param: For organizations of type CORPORATION, notes on company financials.
   */
  financialNotes?: string;

  /**
   * Body param: For organizations of type CORPORATION, the effective financial year
   * end date for revenue, EBITDA, and profit values.
   */
  financialYearEndDate?: string;

  /**
   * Body param: Satellite fleet planning notes for this organization.
   */
  fleetPlanNotes?: string;

  /**
   * Body param: Former organization ID (if this organization previously existed as
   * another organization).
   */
  formerOrgId?: string;

  /**
   * Body param: Total number of FTEs in this organization.
   */
  ftes?: number;

  /**
   * Body param: Administrative boundaries of the first sub-national level. Level 1
   * is simply the largest demarcation under whatever demarcation criteria has been
   * determined by the governing body. For example, this may be a state or province.
   */
  geoAdminLevel1?: string;

  /**
   * Body param: Administrative boundaries of the second sub-national level. Level 2
   * is simply the second largest demarcation under whatever demarcation criteria has
   * been determined by the governing body. For example, this may be a county or
   * district.
   */
  geoAdminLevel2?: string;

  /**
   * Body param: Administrative boundaries of the third sub-national level. Level 3
   * is simply the third largest demarcation under whatever demarcation criteria has
   * been determined by the governing body. For example, this may be a city or
   * township.
   */
  geoAdminLevel3?: string;

  /**
   * Body param: Mass ranking for this organization.
   */
  massRanking?: number;
  ...
  /**
   * Body param: Parent organization ID of this organization if it is a child
   * organization.
   */
  parentOrgId?: string;

  /**
   * Body param: A postal code, such as PIN or ZIP Code, is a series of letters or
   * digits or both included in the postal address of the organization.
   */
  postalCode?: string;

  /**
   * Body param: For organizations of type CORPORATION, total annual profit as of
   * financialYearEndDate in US Dollars.
   */
  profit?: number;

  /**
   * Body param: For organizations of type CORPORATION, total annual revenue as of
   * financialYearEndDate in US Dollars.
   */
  revenue?: number;

  /**
   * Body param: Revenue ranking for this organization.
   */
  revenueRanking?: number;

  /**
   * Body param: The name of the risk manager for the organization.
   */
  riskManager?: string;

  /**
   * Body param: Notes on the services provided by the organization.
   */
  servicesNotes?: string;
