...
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/attitude-sets/history';
import {
  History,
  HistoryAodrParams,
  HistoryCountParams,
  ...
  HistoryListParams,
} from 'bluestaq@unified-data-library/resources/attitude-sets/history';
