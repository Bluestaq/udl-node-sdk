...
export class AttitudeSets extends APIResource {
  ...
  list(
    ...
    return this._client.get('/udl/attitudeset', options);
  }
   ...
   */
  count(params: AttitudeSetCountParams, options?: Core.RequestOptions): Core.APIPromise<string> {
    const { startTime } = params;
  ...
  tuple(
    ...
    return this._client.get('/udl/attitudeset/tuple', options);
  }
}
