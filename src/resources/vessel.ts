...
export class Vessel extends APIResource {
   ...
   */
  update(params: VesselUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/vessel/${path_id}`, {
...
export interface VesselUpdateParams {
  /**
   * Path param: The ID of the Vessel to update.
   */
  path_id: string;
  ...
  /**
   * Body param: The original source Id for this vessel.
   */
  altVesselId?: string;

  /**
   * Body param: A uniquely designated identifier for the vessel's transmitter
   * station. All radio transmissions must be individually identified by the call
   * sign. Merchant and naval vessels are assigned call signs by their national
  ...
  /**
   * Body param: The date this vessel was first seen.
   */
  firstSeen?: string;

  /**
   * Body param: The vessel hull number designation of this maritime vessel. The hull
   * number is a 1-6 character alphanumeric entry assigned to a ship and painted on
   * the hull.
   */
  hullNum?: string;

  /**
   * Body param: Unique identifier of the parent entity. idEntity is required for
   * Put.
   */
  idEntity?: string;

  /**
   * Body param: The UDL ID of the organization that owns the vessel.
   */
  idOrganization?: string;

  /**
   * Body param: The International Maritime Organization Number of the vessel. IMON
   * is a seven-digit number that uniquely identifies the vessel.
   */
  imon?: number;

  /**
   * Body param: The overall length of the vessel, in meters. A value of 511
   * indicates a vessel length of 511 meters or greater.
   */
  length?: number;

  /**
   * Body param: The maximum static draught, in meters, of the vessel defined as the
   * distance between the ship’s keel and the waterline of the vessel.
   */
  maxDraught?: number;

  /**
   * Body param: The maximum possible speed of this vessel in meters per second.
   */
  maxSpeed?: number;

  /**
   * Body param: The Maritime Mobile Service Identity of the vessel. MMSI is a
   * nine-digit number that identifies the transmitter station of the vessel.
   */
  mmsi?: string;

  /**
   * Body param: The number of blades per shaft for this vessel.
   */
  numBlades?: number;

  /**
   * Body param: The number of shafts on this vessel.
   */
  numShafts?: number;
  ...
  /**
   * Body param: The type of propulsion employed by this vessel.
   */
  propType?: string;

  /**
   * Body param: The Ship Control Number (SCONUM) is a naval vessel identification
   * number (alphanumeric code) assigned by the Office of Naval Intelligence. SCONUM
   * is sometimes referred to as NOIC ID. SCONUMs are typically of the form A#####,
   * where A is an alpha character and # is numerical.
   */
  sconum?: string;

  /**
   * Body param: The status of this vessel.
   */
  status?: string;

  /**
   * Body param: The stern type code (Counter, Cruiser) associated with this vessel.
   */
  sternType?: string;

  /**
   * Body param: The shipbuilder who built this vessel.
   */
  vesselBuilder?: string;

  /**
   * Body param: The common name for a group of ships with similar design, usually
   * named for the first vessel of the class.
   */
  vesselClass?: string;

  /**
   * Body param: Further description or explanation of the vessel or type.
   */
  vesselDescription?: string;

  /**
   * Body param: The flag of the subject vessel.
   */
  vesselFlag?: string;

  /**
   * Body param: The name of this vessel. Vessel names that exceed the AIS 20
   * character are shortened (not truncated) to 15 character-spaces, followed by an
   * underscore and the last 4 characters-spaces of the vessel full name.
   */
  vesselName?: string;

  /**
   * Body param: The reported ship type (e.g. Passenger, Tanker, Cargo, Other, etc.).
   */
  vesselType?: string;

  /**
   * Body param: The weight in tons, of this vessel.
   */
  vslWt?: number;

  /**
   * Body param: The breadth of the vessel, in meters. A value of 63 indicates a
   * vessel breadth of 63 meters or greater.
   */
  width?: number;

  /**
   * Body param: Year the vessel went into service.
   */
  yearBuilt?: string;
}
