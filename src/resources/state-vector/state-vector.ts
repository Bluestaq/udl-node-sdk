...
import * as CurrentAPI from 'bluestaq@unified-data-library/resources/state-vector/current';
import {
  Current,
  CurrentListParams,
  CurrentTupleParams,
  CurrentTupleResponse,
} from 'bluestaq@unified-data-library/resources/state-vector/current';
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/state-vector/history';
import {
  History,
  HistoryAodrParams,
  HistoryCountParams,
  ...
  HistoryListParams,
} from 'bluestaq@unified-data-library/resources/state-vector/history';
