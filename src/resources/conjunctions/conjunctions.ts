...
export class Conjunctions extends APIResource {
   ...
   */
  create(body: ConjunctionCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
  ...
  ): Core.APIPromise<ConjunctionFull> {
    const { path_id, body_id } = params;
    return this._client.get(`/udl/conjunction/${path_id}`, options);
  }
  ...
  tuple(
    ...
    const { columns, tca } = params;
    return this._client.get('/udl/conjunction/tuple', options);
  }
}
...
export namespace ConjunctionFull {
  ...
  export interface OnOrbit1 {
     ...
     */
    antennas?: Array<OnOrbit1.Antenna>;

    /**
     * Read-only collection of batteries on this on-orbit object.
     */
    batteries?: Array<OnOrbit1.Battery>;
     ...
     */
    onorbitDetails?: Array<OnOrbit1.OnorbitDetail>;
     ...
     */
    solarArrays?: Array<OnOrbit1.SolarArray>;

    /**
     * Read-only collection of thrusters (engines) on this on-orbit object.
     */
    thrusters?: Array<OnOrbit1.Thruster>;
  ...
  export interface OnOrbit2 {
     ...
     * Read-only collection of antennas on this on-orbit object.
     */
    antennas?: Array<OnOrbit2.Antenna>;

    /**
     * Read-only collection of batteries on this on-orbit object.
     */
    batteries?: Array<OnOrbit2.Battery>;
     ...
     * Read-only collection of details for this on-orbit object.
     */
    onorbitDetails?: Array<OnOrbit2.OnorbitDetail>;
     ...
     * Read-only collection of solar arrays on this on-orbit object.
     */
    solarArrays?: Array<OnOrbit2.SolarArray>;

    /**
     * Read-only collection of thrusters (engines) on this on-orbit object.
     */
    thrusters?: Array<OnOrbit2.Thruster>;
...
export type ConjunctionCreateParams = Array<ConjunctionCreateParams.Body>;

export namespace ConjunctionCreateParams {
  /**
   * Stores the results of a particular Conjunction Assessment (CA) run.
   */
...
export interface ConjunctionRetrieveParams {
  ...
  /**
   * Body param: The ID of the conjunction to retrieve.
   */
  body_id: string;
}
