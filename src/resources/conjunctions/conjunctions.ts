...
export class Conjunctions extends APIResource {
   ...
   */
  fileCreate(body: ConjunctionFileCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
...
export type ConjunctionFileCreateParams = Array<ConjunctionFileCreateParams.Body>;

export namespace ConjunctionFileCreateParams {
  /**
   * Stores the results of a particular Conjunction Assessment (CA) run.
   */
  export interface Body {
