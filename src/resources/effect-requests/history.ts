...
import * as EffectRequestsAPI from '../mission-ops/effect-requests/effect-requests';
...
export class History extends APIResource {
  ...
  list(params: HistoryListParams, options?: Core.RequestOptions): Core.APIPromise<HistoryListResponse> {
    ...
    return this._client.get('/udl/effectrequest/history', options);
  }
...
export type HistoryListResponse = Array<EffectRequestsAPI.EffectRequest>;
