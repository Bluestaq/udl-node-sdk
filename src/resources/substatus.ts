...
export type SubstatusListResponse = Array<SubstatusListResponse.SubstatusListResponseItem>;

export namespace SubstatusListResponse {
  /**
   * Additional sub-system or capability status for the parent entity.
   */
  export interface SubstatusListResponseItem {
    /**
 ...
 * Additional sub-system or capability status for the parent entity.
 */
export interface SubstatusGetResponse {
  /**
   * Classification marking of the data in IC/CAPCO Portion-marked format.
   */
  classificationMarking: string;
...
export namespace SubstatusTupleResponse {
  /**
   * Additional sub-system or capability status for the parent entity.
   */
  export interface SubstatusTupleResponseItem {
    /**
     * Classification marking of the data in IC/CAPCO Portion-marked format.
     */
    classificationMarking: string;
