...
export class Substatus extends APIResource {
   ...
   */
  create(body: SubstatusCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
   ...
   * assistance.
   */
  update(params: SubstatusUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/substatus/${path_id}`, {
   ...
   */
  list(options?: Core.RequestOptions): Core.APIPromise<SubstatusListResponse> {
  ...
  delete(id: string, options?: Core.RequestOptions): Core.APIPromise<void> {
    return this._client.delete(`/udl/substatus/${id}`, {
      ...options,
      headers: { Accept: '*/*', ...options?.headers },
    });
  }
   ...
   * path parameter.
   */
  get(id: string, options?: Core.RequestOptions): Core.APIPromise<SubstatusGetResponse> {
    return this._client.get(`/udl/substatus/${id}`, options);
  }
   ...
   * hours ago.
   */
  tuple(query: SubstatusTupleParams, options?: Core.RequestOptions): Core.APIPromise<SubstatusTupleResponse> {
...
export interface SubstatusUpdateParams {
  /**
   * Path param: The ID of the Sub Status record to update.
   */
  path_id: string;
  ...
  /**
   * Body param: Descriptions and/or comments associated with the sub-status.
   */
  notes: string;
  ...
  /**
   * Body param: Status of the sub-system/capability, e.g. FMC, NMC, PMC, UNK.
   */
  status: 'FMC' | 'NMC' | 'PMC' | 'UNK';

  /**
   * Body param: Id of the parent status.
   */
  statusId: string;

  /**
   * Body param: Parent entity's sub-system or capability status: mwCap, mdCap,
   * ssCap, etc.
   */
  type: 'mwCap' | 'ssCap' | 'mdCap';
