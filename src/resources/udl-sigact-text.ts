...
export class UdlSigactText extends APIResource {
  /**
   ...
   */
  create(body: UdlSigactTextCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
...
export interface UdlSigactTextCreateParams {
  /**
   ...
   */
  relatedDocs?: Array<UdlSigactTextCreateParams.RelatedDoc>;
...
export namespace UdlSigactTextCreateParams {
  /**
   * Related document ids.
   */
...
export declare namespace UdlSigactText {
  export { type UdlSigactTextCreateParams as UdlSigactTextCreateParams };
}
