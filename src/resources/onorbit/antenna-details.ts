...
export interface AntennaDetailUpdateParams {
  ...
  /**
   * Body param: Boolean indicating if this is a beam forming antenna.
   */
  beamForming?: boolean;

  /**
   * Body param: Array of angles between the half-power (-3 dB) points of the main
  ...
  /**
   * Body param: Antenna diameter in meters.
   */
  diameter?: number;

  /**
   * Body param: Antenna end of frequency range in Mhz.
   */
  endFrequency?: number;

  /**
   * Body param: Antenna maximum gain in dBi.
   */
  gain?: number;

  /**
   * Body param: Antenna gain tolerance in dB.
   */
  gainTolerance?: number;

  /**
   * Body param: ID of the organization that manufactures the antenna.
   */
  manufacturerOrgId?: string;
  ...
  /**
   * Body param: Antenna position (e.g. Top, Nadir, Side).
   */
  position?: string;
  ...
  /**
   * Body param: Antenna start of frequency range in Mhz.
   */
  startFrequency?: number;

  /**
   * Body param: Boolean indicating if this antenna is steerable.
   */
  steerable?: boolean;
  ...
  /**
   * Body param: Type of antenna (e.g. Reflector, Double Reflector, Shaped Reflector,
   * Horn, Parabolic, etc.).
   */
  type?: string;
}
