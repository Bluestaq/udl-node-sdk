...
export class History extends APIResource {
   ...
   * @example
   * ```ts
   * const histories = await client.sensorPlan.history.retrieve({
...
export namespace HistoryRetrieveResponse {
  ...
  export interface HistoryRetrieveResponseItem {
     ...
     */
    collectRequests?: Array<HistoryRetrieveResponseItem.CollectRequest>;
  ...
  export namespace HistoryRetrieveResponseItem {
    /**
