...
export class History extends APIResource {
   ...
   * for await (const historyListResponse of client.sensorPlan.history.list(
  ...
  list(query: HistoryListParams, options?: RequestOptions): PagePromise<HistoryListResponsesOffsetPage, HistoryListResponse> {
    return this._client.getAPIList('/udl/sensorplan/history', OffsetPage<HistoryListResponse>, { query, ...options });
  }
   ...
   * @example
   * ```ts
   * await client.sensorPlan.history.aodr({
   *   startTime: '2019-12-27T18:11:19.117Z',
   * });
   * ```
   */
  aodr(query: HistoryAodrParams, options?: RequestOptions): APIPromise<void> {
    return this._client.get('/udl/sensorplan/history/aodr', { query, ...options, headers: buildHeaders([{Accept: '*/*'}, options?.headers]) });
  }
  ...
  count(query: HistoryCountParams, options?: RequestOptions): APIPromise<string> {
    return this._client.get('/udl/sensorplan/history/count', { query, ...options, headers: buildHeaders([{Accept: 'text/plain'}, options?.headers]) });
  }
}
...
export interface HistoryListResponse {
   ...
   */
  collectRequests?: Array<HistoryListResponse.CollectRequest>;
