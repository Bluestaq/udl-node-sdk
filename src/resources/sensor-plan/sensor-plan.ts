...
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/sensor-plan/history';
import {
  History,
  HistoryAodrParams,
  HistoryCountParams,
...
} from 'bluestaq@unified-data-library/resources/sensor-plan/history';
 ...
 */
export interface SensorPlanListResponse {
  /**
 ...
 * enabling resolution back to the parent.
 */
export interface SensorPlanGetResponse {
  /**
   * Classification marking of the data in IC/CAPCO Portion-marked format.
   */
  classificationMarking: string;
   ...
   */
  collectRequests?: Array<SensorPlanGetResponse.CollectRequest>;
...
export namespace SensorPlanGetResponse {
  /**
...
export namespace SensorPlanTupleResponse {
   ...
   * enabling resolution back to the parent.
   */
  export interface SensorPlanTupleResponseItem {
    /**
     * Classification marking of the data in IC/CAPCO Portion-marked format.
     */
    classificationMarking: string;
     ...
     * must have the same size as reqTotal.
     */
    collectRequests?: Array<SensorPlanTupleResponseItem.CollectRequest>;
  ...
  export namespace SensorPlanTupleResponseItem {
    /**
     * Collect Requests support several types of individual requests, or
     * planned/scheduled tasks on sensors and/or orbital objects. Options are provided
     * to accomodate most common sensor contact and collection applications, including
...
export interface SensorPlanListParams extends OffsetPageParams {
  /**
   * The start time of the plan or schedule, in ISO 8601 UTC format.
