...
import * as ConjunctionsAPI from './conjunctions/conjunctions';

export class Conjunction extends APIResource {
  /**
  ...
  list(
    ...
    const { tca } = params;
    return this._client.get('/udl/conjunction', options);
  }
   ...
   */
  count(params: ConjunctionCountParams, options?: Core.RequestOptions): Core.APIPromise<string> {
    const { tca } = params;
   ...
   */
  history(
    params: ConjunctionHistoryParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<ConjunctionHistoryResponse> {
    const { tca, columns } = params;
    return this._client.get('/udl/conjunction/history', options);
  }
}

export type ConjunctionListResponse = Array<ConjunctionsAPI.ConjunctionAbridged>;

export type ConjunctionCountResponse = string;

export type ConjunctionHistoryResponse = Array<ConjunctionsAPI.ConjunctionFull>;

export interface ConjunctionCreateParams {
  /**
   ...
   * provider.
   */
  stateVector1?: ConjunctionCreateParams.StateVector1;
   ...
   * provider.
   */
  stateVector2?: ConjunctionCreateParams.StateVector2;
...
export interface ConjunctionHistoryParams {
  /**
   * Time of closest approach (TCA) in UTC. (YYYY-MM-DDTHH:MM:SS.ssssssZ)
   */
  tca: string;
...
export declare namespace Conjunction {
  export {
