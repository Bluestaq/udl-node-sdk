...
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/event-evolution/history';
import {
  History,
  HistoryAodrParams,
  HistoryCountParams,
  ...
  HistoryListParams,
} from 'bluestaq@unified-data-library/resources/event-evolution/history';
