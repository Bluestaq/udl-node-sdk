...
export type EventEvolutionListResponse = Array<EventEvolutionListResponse.EventEvolutionListResponseItem>;

export namespace EventEvolutionListResponse {
  /**
   ...
   */
  export interface EventEvolutionListResponseItem {
    /**
