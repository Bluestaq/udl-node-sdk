...
export class Organization extends APIResource {
   ...
   */
  update(params: OrganizationUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/organization/${path_id}`, {
...
export interface OrganizationUpdateParams {
  /**
   * Path param: The ID of the Organization to update.
   */
  path_id: string;
  ...
  /**
   * Body param: Type of organization (e.g. GOVERNMENT, CORPORATION, CONSORTIUM,
   * ACADEMIC).
   */
  type: string;
  ...
  /**
   * Body param: Boolean indicating if this organization is currently active.
   */
  active?: boolean;

  /**
   * Body param: Subtype or category of the organization (e.g. Private company, stock
   * market quoted company, subsidiary, goverment department/agency, etc).
   */
  category?: string;

  /**
   * Body param: Country of the physical location of the organization. This value is
   * typically the ISO 3166 Alpha-2 two-character country code. However, it can also
   * represent various consortiums that do not appear in the ISO document. The code
   * must correspond to an existing country in the UDL’s country API. Call
   * udl/country/{code} to get any associated FIPS code, ISO Alpha-3 code, or
  ...
  /**
   * Body param: Organization description.
   */
  description?: string;

  /**
   * Body param: Optional externally provided identifier for this row.
   */
  externalId?: string;

  /**
   * Body param: Country of registration or ownership of the organization. This value
   * is typically the ISO 3166 Alpha-2 two-character country code, however it can
   * also represent various consortiums that do not appear in the ISO document. The
