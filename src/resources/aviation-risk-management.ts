...
export class AviationRiskManagement extends APIResource {
   ...
   * for await (const aviationRiskManagementListResponse of client.aviationRiskManagement.list(
   *   { idMission: 'idMission' },
   * )) {
   *   // ...
   * }
 ...
 * complexity.
 */
export interface AviationRiskManagementListResponse {
  /**
   * Classification marking of the data in IC/CAPCO Portion-marked format.
   */
  classificationMarking: string;
   ...
   * Collection of Aviation Risk Management Worksheet Records.
   */
  aviationRiskManagementWorksheetRecord?: Array<AviationRiskManagementListResponse.AviationRiskManagementWorksheetRecord>;
...
export namespace AviationRiskManagementListResponse {
  /**
   * Collection of Aviation Risk Management Worksheet Records.
   */
  export interface AviationRiskManagementWorksheetRecord {
...
export interface AviationRiskManagementListParams extends OffsetPageParams {
  /**
   * The unique identifier of the mission to which this risk management record is
   * assigned.
   */
