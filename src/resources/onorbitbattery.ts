...
export class Onorbitbattery extends APIResource {
   ...
   */
  update(params: OnorbitbatteryUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/onorbitbattery/${path_id}`, {
...
export interface OnorbitbatteryUpdateParams {
  /**
   * Path param: The ID of the OnorbitBattery to update.
   */
  path_id: string;
  ...
  /**
   * Body param: The number of batteries on the spacecraft of the type identified by
   * idBattery.
   */
  quantity?: number;
}
