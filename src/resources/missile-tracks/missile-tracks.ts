...
export type MissileTrackListResponse = Array<MissileTrackListResponse.MissileTrackListResponseItem>;
...
export namespace MissileTrackListResponse {
   ...
   */
  export interface MissileTrackListResponseItem {
    /**
     ...
     */
    vectors?: Array<MissileTrackListResponseItem.Vector>;
  }

  export namespace MissileTrackListResponseItem {
    /**
