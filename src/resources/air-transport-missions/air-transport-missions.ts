...
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/air-transport-missions/history';
import {
  History,
  HistoryAodrParams,
  HistoryCountParams,
  ...
  HistoryListParams,
} from 'bluestaq@unified-data-library/resources/air-transport-missions/history';
