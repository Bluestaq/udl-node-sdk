...
export class Site extends APIResource {
   ...
   */
  create(body: SiteCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
   ...
   */
  update(params: SiteUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/site/${path_id}`, {
   ...
   */
  list(options?: Core.RequestOptions): Core.APIPromise<SiteListResponse> {
   ...
   * parameter.
   */
  get(id: string, options?: Core.RequestOptions): Core.APIPromise<SiteGetResponse> {
    return this._client.get(`/udl/site/${id}`, options);
  }
   ...
   * hours ago.
   */
  tuple(query: SiteTupleParams, options?: Core.RequestOptions): Core.APIPromise<SiteTupleResponse> {
...
export interface SiteCreateParams {
   ...
   * entity can have an operating unit, a location (if terrestrial), and statuses.
   */
  entity?: SiteCreateParams.Entity;
...
export interface SiteUpdateParams {
  /**
   * Path param: The ID of the Site to update.
   */
  path_id: string;
  ...
  /**
   * Body param: The name of this site.
   */
  name: string;
  ...
  /**
   * Body param: Indicates the function or mission of an entity, which that entity
   * may or may not be engaged in at any particular time. Typically refers to a unit,
   * organization, or installation/site performing a specific function or mission
   ...
   * political entity to which the site owes its allegiance. This field will be set
  ...
  /**
   * Body param: The Basic Encyclopedia Number associated with the Site. Uniquely
   * identifies the installation of a site. The beNumber is generated based on the
   * value input for the COORD to determine the appropriate World Aeronautical Chart
   * (WAC) location identifier, the system assigned record originator and a
   * one-up-number.
   */
  beNumber?: string;

  /**
   * Body param: The category code that represents the associated site purpose within
   * the target system.
   */
  catCode?: string;

  /**
   * Body param: Textual Description of Site catCode.
   */
  catText?: string;

  /**
   * Body param: Indicates the importance of the entity to the OES or MIR system.
   ...
   * a point by reference to a fixed figure, system of lines, etc.
   *
   * Pos. 1-2. Latitude Degrees [00-90]
   *
   * Pos. 3-4. Latitude Minutes [00-59]
  ...
  /**
   * Body param: Ground elevation of the geographic coordinates referenced to (above
   * or below) Mean Sea Level (MSL) vertical datum, in meters.
   */
  elevMsl?: number;
   ...
   * vertically positioned to within a specified vertical accuracy.
   */
  elevMslConfLvl?: number;

  /**
   * Body param: Indicates the plus or minus error assessed against the method used
   * to derive the elevation.
   */
  elevMslDerivAcc?: number;
   ...
   * and statuses.
   */
  entity?: SiteUpdateParams.Entity;
  ...
  /**
   * Body param: The Federal Aviation Administration (FAA) Location ID of this site,
   * if applicable.
   */
  faa?: string;
  ...
  /**
   * Body param: Geographical region code used by the Requirements Management System
   * (RMS) as specified by National Geospatial Agency (NGA) in Flight Information
   * Publications (FIPS) 10-4, Appendix 3 - Country Code and Geographic Region Codes.
  ...
  /**
   * Body param: The distance between Mean Sea Level and a referenced ellipsoid, in
   * meters.
   */
  geoidalMslSep?: number;

  /**
   * Body param: Indicates the amount or degree of deviation from the horizontal
   * represented as a percent. Grade is determined by the formula: vertical distance
   * (VD) divided by horizontal distance (HD) times 100. VD is the difference between
   * the highest and lowest elevation within the entity. HD is the linear distance
   * between the highest and lowest elevation.
   */
  grade?: number;

  /**
   * Body param: The International Air Transport Association (IATA) code of this
   * site, if applicable.
   */
  iata?: string;

  /**
   * Body param: The International Civil Aviation Organization (ICAO) code of this
   * site, if applicable.
   */
  icao?: string;
  ...
  /**
   * Body param: Unique identifier of the Parent Site record associated with this
   * Site record.
   */
  idParentSite?: string;

  /**
   * Body param: Indicates the normal usage of the Landing Zone (LZ). Intended as,
   * but not constrained to MIDB Helocopter Landing Area usage value definitions:
   *
   * AF - Airfield
   *
   * FD - Field
  ...
  /**
   * Body param: The length of the longest runway at this site, if applicable, in
   * meters.
   */
  maxRunwayLength?: number;
  ...
  /**
   * Body param: Indicates the principal type of mission that an entity is organized
   * and equipped to perform. The specific usage and enumerations contained in this
   * field may be found in the documentation provided in the referenceDoc field. If
   * referenceDoc not provided, users may consult the data provider.
   */
  ...
  /**
   * Body param: Indicates the principal specialty type of mission that an entity is
  ...
  /**
   * Body param: Optional notes/comments for the site.
   */
  notes?: string;

  /**
   * Body param: A sites ability to conduct nuclear warfare. Valid Values are:
   *
   * A - Nuclear Ammo Or Warheads Available
   *
   * N - No Nuclear Offense
  ...
  /**
   * Body param: Unique identifier of the LZ record from the originating system.
   */
  origLzId?: string;

  /**
   * Body param: Unique identifier of the Site record from the originating system.
   */
  origSiteID?: string;

  /**
   * Body param: The O-suffix associated with this site. The O-suffix is a
   * five-character alpha/numeric system used to identify a site, or demographic
   * area, within an installation. The Installation Basic Encyclopedia (beNumber), in
   * conjunction with the O-suffix, uniquely identifies the Site. The Installation
   * beNumber and oSuffix are also used in conjunction with the catCode to classify
   * the function or purpose of the facility.
   */
  osuffix?: string;

  /**
   * Body param: Site number of a specific electronic site or its associated
   * equipment.
   */
  pin?: string;
  ...
  /**
   * Body param: Indicates whether the facility is in or outside of a populated area.
  ...
  /**
   * Body param: Indicates the distance to nearest populated area (over 1,000 people)
   * in nautical miles.
   */
  popAreaProx?: number;
  ...
  /**
   * Body param: The reference documentation that specifies the usage and
   ...
   * responsible analyst for accuracy and currency, in ISO8601 UTC format. This date
   * cannot be greater than the current date.
   */
  reviewDate?: string;

  /**
   * Body param: The number of runways at the site, if applicable.
   */
  runways?: number;
   ...
   * and supported by the element ident.
   */
  symCode?: string;

  /**
   * Body param: The type of this site (AIRBASE, AIRFIELD, AIRPORT, NAVAL STATION,
   * etc.).
   */
  type?: string;

  /**
   * Body param: The use authorization type of this site (e.g MILITARY, CIVIL,
   * JOINT-USE, etc.).
   */
  usage?: string;
  ...
  /**
   * Body param: Maximum expected height of the vegetation in the Landing Zone (LZ),
   * in meters.
   */
  vegHt?: number;

  /**
   * Body param: The predominant vegetation found in the Landing Zone (LZ). The
   * specific usage and enumerations contained in this field may be found in the
   * documentation provided in the referenceDoc field. If referenceDoc not provided,
   * users may consult the data provider.
   */
