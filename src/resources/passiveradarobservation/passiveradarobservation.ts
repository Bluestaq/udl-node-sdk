...
export class Passiveradarobservation extends APIResource {
  ...
  createBulk(
    body?: PassiveradarobservationCreateBulkParams | Core.RequestOptions,
    options?: Core.RequestOptions,
  ): Core.APIPromise<void> {
...
export type PassiveradarobservationListResponse =
  Array<PassiveradarobservationListResponse.PassiveradarobservationListResponseItem>;

export namespace PassiveradarobservationListResponse {
  /**
   ...
   */
  export interface PassiveradarobservationListResponseItem {
    /**
...
export type PassiveradarobservationTupleResponse =
  Array<PassiveradarobservationHistoryAPI.PassiveradarobservationFull>;
...
export interface PassiveradarobservationListParams {
  /**
   * Ob detection time in ISO 8601 UTC with microsecond precision.
