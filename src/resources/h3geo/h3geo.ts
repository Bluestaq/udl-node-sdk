...
export class H3geo extends APIResource {
   ...
   */
  create(body: H3geoCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
   ...
   */
  list(query: H3geoListParams, options?: Core.RequestOptions): Core.APIPromise<H3geoListResponse> {
   ...
   */
  count(query: H3geoCountParams, options?: Core.RequestOptions): Core.APIPromise<string> {
   ...
   * path parameter.
   */
  get(id: string, options?: Core.RequestOptions): Core.APIPromise<H3geoGetResponse> {
    return this._client.get(`/udl/h3geo/${id}`, options);
  }
   ...
   * hours ago.
   */
  tuple(query: H3geoTupleParams, options?: Core.RequestOptions): Core.APIPromise<H3geoTupleResponse> {
