...
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/personnelrecovery/history';
import {
  History,
  HistoryCountParams,
  HistoryCountResponse,
  HistoryListParams,
} from 'bluestaq@unified-data-library/resources/personnelrecovery/history';
 ...
 * situations involving personnel recovery.
 */
export interface PersonnelrecoveryListResponse {
  /**
   * Classification marking of the data in IC/CAPCO Portion-marked format.
   */
  classificationMarking: string;
  ...
  executionInfo?: PersonnelrecoveryListResponse.ExecutionInfo;
  ...
  objectiveAreaInfo?: PersonnelrecoveryListResponse.ObjectiveAreaInfo;
...
export interface PersonnelrecoveryListParams extends OffsetPageParams {
  /**
   * Time stamp of the original personnel recovery message, in ISO 8601 UTC format.
