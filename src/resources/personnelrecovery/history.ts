...
import * as PersonnelrecoveryAPI from 'bluestaq@unified-data-library/resources/personnelrecovery/personnelrecovery';
import { PersonnelRecoveryFullLsOffsetPage } from 'bluestaq@unified-data-library/resources/personnelrecovery/personnelrecovery';
...
export class History extends APIResource {
   ...
   * for await (const personnelRecoveryFullL of client.personnelrecovery.history.list(
   ...
   * ```ts
   * const response =
   *   await client.personnelrecovery.history.count({
   *     msgTime: '2019-12-27T18:11:19.117Z',
   *   });
   * ```
   */
