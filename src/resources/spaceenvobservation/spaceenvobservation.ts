...
export type SpaceenvobservationListResponse =
  Array<SpaceenvobservationListResponse.SpaceenvobservationListResponseItem>;

export namespace SpaceenvobservationListResponse {
  /**
   * SpaceEnvObservation data.
   */
  export interface SpaceenvobservationListResponseItem {
    /**
     ...
     */
    seoList?: Array<SpaceenvobservationListResponseItem.SeoList>;
  ...
  export namespace SpaceenvobservationListResponseItem {
    /**
...
export interface SpaceenvobservationListParams {
  /**
   * Time of the observation, in ISO 8601 UTC format with millisecond precision.
