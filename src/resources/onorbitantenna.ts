...
export class Onorbitantenna extends APIResource {
   ...
   */
  update(params: OnorbitantennaUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/onorbitantenna/${path_id}`, {
...
export interface OnorbitantennaUpdateParams {
  /**
   * Path param: The ID of the OnorbitAntenna to update.
   */
  path_id: string;
