...
export class DataTypes extends APIResource {
   ...
   */
  list(query: DataTypeListParams | null | undefined = {}, options?: RequestOptions): PagePromise<DataTypeListResponsesOffsetPage, DataTypeListResponse> {
    return this._client.getAPIList('/udl/dataowner/getDataTypes', OffsetPage<DataTypeListResponse>, { query, ...options });
  }
}
