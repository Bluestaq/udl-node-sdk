...
export class Onorbitdetails extends APIResource {
   ...
   * assistance.
   */
  update(params: OnorbitdetailUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/onorbitdetails/${path_id}`, {
...
export interface OnorbitdetailUpdateParams {
  /**
   * Path param: The ID of the OnorbitDetails to update.
   */
  path_id: string;
  ...
  /**
   * Body param: Mass of fuel and disposables at launch time in kilograms.
   */
  additionalMass?: number;

  /**
   * Body param: The radius used for long-term debris environment projection analyses
   * that is not as conservative as COLA Radius, in meters.
   */
  adeptRadius?: number;

  /**
   * Body param: The total beginning of life delta V of the spacecraft, in meters per
   * second.
   */
  bolDeltaV?: number;

  /**
   * Body param: Spacecraft beginning of life fuel mass, in orbit, in kilograms.
   */
  bolFuelMass?: number;

  /**
   * Body param: Average cross sectional area of the bus in meters squared.
   */
  busCrossSection?: number;

  /**
   * Body param: Type of the bus on the spacecraft.
   */
  busType?: string;

  /**
   * Body param: Maximum dimension of the box circumscribing the spacecraft (d =
   * sqrt(a*a + b*b + c\*c) where a is the tip-to-tip dimension, b and c are
   * perpendicular to that.) in meters.
   */
  colaRadius?: number;

  /**
   * Body param: Average cross sectional area in meters squared.
   */
  crossSection?: number;

  /**
   * Body param: The estimated total current mass of the spacecraft, in kilograms.
   */
  currentMass?: number;

  /**
   * Body param: The 1-sigma uncertainty of the total spacecraft delta V, in meters
   * per second.
   */
  deltaVUnc?: number;

  /**
   * Body param: Array of the estimated mass of each deployable object, in kilograms.
   * Must contain the same number of elements as the value of numDeployable.
   */
  depEstMasses?: Array<number>;

  /**
   * Body param: Array of the 1-sigma uncertainty of the mass for each deployable
   * object, in kilograms. Must contain the same number of elements as the value of
   * numDeployable.
   */
  depMassUncs?: Array<number>;

  /**
   * Body param: Array of satellite deployable objects. Must contain the same number
   * of elements as the value of numDeployable.
   */
  depNames?: Array<string>;

  /**
   * Body param: GEO drift rate, if applicable in degrees per day.
   */
  driftRate?: number;

  /**
   * Body param: Spacecraft dry mass (without fuel or disposables) in kilograms.
   */
  dryMass?: number;

  /**
   * Body param: Estimated maximum burn duration for the object, in seconds.
   */
  estDeltaVDuration?: number;

  /**
   * Body param: Estimated remaining fuel for the object in kilograms.
   */
  fuelRemaining?: number;

  /**
   * Body param: GEO slot if applicable, in degrees. -180 (West of Prime Meridian) to
   * 180 degrees (East of Prime Meridian). Prime Meridian is 0.
   */
  geoSlot?: number;

  /**
   * Body param: The name of the source who last provided an observation for this
   * idOnOrbit.
   */
  lastObSource?: string;

  /**
   * Body param: Time of last reported observation for this object in ISO 8601 UTC
   * with microsecond precision.
   */
  lastObTime?: string;

  /**
   * Body param: Nominal mass of spacecraft and fuel at launch time, in kilograms.
   */
  launchMass?: number;

  /**
   * Body param: Maximum (estimated) mass of spacecraft and fuel at launch time, in
   * kilograms.
   */
  launchMassMax?: number;

  /**
   * Body param: Minimum (estimated) mass of spacecraft and fuel at launch time, in
   * kilograms.
   */
  launchMassMin?: number;

  /**
   * Body param: Boolean indicating whether a spacecraft is maneuverable. Note that a
   * spacecraft may have propulsion capability but may not be maneuverable due to
   * lack of fuel, anomalous condition, or other operational constraints.
   */
  maneuverable?: boolean;

  /**
   * Body param: Maximum delta V available for this on-orbit spacecraft, in meters
   * per second.
   */
  maxDeltaV?: number;

  /**
   * Body param: Maximum dimension across the spacecraft (e.g., tip-to-tip across the
   * solar panel arrays) in meters.
   */
  maxRadius?: number;

  /**
   * Body param: Array of the type of missions the spacecraft performs. Must contain
   * the same number of elements as the value of numMission.
   */
  missionTypes?: Array<string>;

  /**
   * Body param: The number of sub-satellites or deployable objects on the
   * spacecraft.
   */
  numDeployable?: number;

  /**
   * Body param: The number of distinct missions the spacecraft performs.
   */
  numMission?: number;
  ...
  /**
   * Body param: Current/latest radar cross section in meters squared.
   */
  rcs?: number;

  /**
   * Body param: Maximum radar cross section in meters squared.
   */
  rcsMax?: number;

  /**
   * Body param: Mean radar cross section in meters squared.
   */
  rcsMean?: number;

  /**
   * Body param: Minimum radar cross section in meters squared.
   */
  rcsMin?: number;

  /**
   * Body param: The reference source, sources, or URL from which the data in this
   * record was obtained.
   */
  refSource?: string;

  /**
   * Body param: Spacecraft deployed area of solar array in meters squared.
   */
  solarArrayArea?: number;

  /**
   * Body param: The 1-sigma uncertainty of the total spacecraft mass, in kilograms.
   */
  totalMassUnc?: number;

  /**
   * Body param: Current/latest visual magnitude in M.
   */
  vismag?: number;

  /**
   * Body param: Maximum visual magnitude in M.
   */
  vismagMax?: number;

  /**
   * Body param: Mean visual magnitude in M.
   */
  vismagMean?: number;

  /**
   * Body param: Minimum visual magnitude in M.
   */
  vismagMin?: number;
}
