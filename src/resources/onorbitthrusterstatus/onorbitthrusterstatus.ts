...
export type OnorbitthrusterstatusListResponse =
  Array<OnorbitthrusterstatusListResponse.OnorbitthrusterstatusListResponseItem>;

export namespace OnorbitthrusterstatusListResponse {
  /**
   * Status information for OnorbitThruster objects.
   */
  export interface OnorbitthrusterstatusListResponseItem {
    /**
