...
import * as HistoryAPI from 'bluestaq@unified-data-library/resources/sensor/calibration/history';
import {
  History,
  HistoryCountParams,
...
} from 'bluestaq@unified-data-library/resources/sensor/calibration/history';
...
export type CalibrationQueryResponse = Array<CalibrationQueryResponse.CalibrationQueryResponseItem>;

export namespace CalibrationQueryResponse {
  /**
   * The Sensor Calibration service records data about a sensor's overall accuracy
   * and is used to adjust sensor settings to achieve and maintain that accuracy in
   * reported sensor observations. Calibration occurs periodically when needed to
   * maintain sensor accuracy or on-demand to adjust a sensor for a specific reading.
   */
  export interface CalibrationQueryResponseItem {
    /**
     * Classification marking of the data in IC/CAPCO Portion-marked format.
     */
    classificationMarking: string;
