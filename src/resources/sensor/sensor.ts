...
export namespace SensorListResponse {
  ...
  export interface Sensorcharacteristic {
     ...
     */
    acceptableSatIdFormats?: Array<string>;
    ...
    /**
     * The beam width of a Sensor's Fan (range), in radians. The values for this range
     * from (0.0 to PI).
     */
    fanBeamWidth?: number;
     ...
     */
    maxDataTransmissionRate?: number;
    ...
    /**
     * Maximum number of simultaneous tracks. For phased array radars, this includes
     * the capability to form multiple beams. For all sensors, it includes capability
     * to distinguish multiple objects within a single beam or field-of-view.
     */
    maxNumTracks?: number;
    ...
    /**
     * Signal to Noise Ratio, in decibels. The values for this range from 0.0 - +
     * 99.99.
     */
    ...
    /**
     * Array of available tasking channels (e.g. AD-HOC, CTL, DAILY, EVENT-ONLY,
     * VOICE-ONLY, etc.).
     */
    taskingChannels?: Array<string>;
    ...
    /**
     * Performance zone-1 maximum range, in kilometers. Note that the zones apply only
     * to the PSR/Search radars.
     */
    z1MaxRange?: number;

    /**
     * Performance zone-1 minimum range, in kilometers. Note that the zones apply only
     * to the PSR/Search radars.
     */
    z1MinRange?: number;

    /**
     * Performance zone-2 maximum range, in kilometers. Note that the zones apply only
     * to the PSR/Search radars.
     */
    z2MaxRange?: number;

    /**
     * Performance zone-2 minimum range, in kilometers. Note that the zones apply only
     * to the PSR/Search radars.
     */
    z2MinRange?: number;
  }
...
export namespace SensorGetResponse {
  ...
  export interface Sensorcharacteristic {
     ...
     */
    searchPatternPoints?: Array<number>;
