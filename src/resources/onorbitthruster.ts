...
export class Onorbitthruster extends APIResource {
   ...
   */
  update(params: OnorbitthrusterUpdateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
    const { path_id, body_id, ...body } = params;
    return this._client.put(`/udl/onorbitthruster/${path_id}`, {
...
export interface OnorbitthrusterUpdateParams {
  /**
   * Path param: The ID of the OnorbitThruster to update.
   */
  path_id: string;
  ...
  /**
   * Body param: ID of the Engine.
   */
  idEngine: string;

  /**
   * Body param: ID of the on-orbit object.
   */
  idOnOrbit: string;
  ...
  /**
   * Body param: The number of engines/thrusters on the spacecraft of the type
   * identified by idEngine.
   */
  quantity?: number;

  /**
   * Body param: The type of thruster associated with this record (e.g. LAE,
   * Hydrazine REA, etc.).
   */
  type?: string;
}
