...
export class UdlSpaceenvobs extends APIResource {
  /**
   ...
   */
  create(body: UdlSpaceenvobCreateParams, options?: Core.RequestOptions): Core.APIPromise<void> {
...
export type UdlSpaceenvobCreateParams = Array<UdlSpaceenvobCreateParams.Body>;

export namespace UdlSpaceenvobCreateParams {
  /**
...
export declare namespace UdlSpaceenvobs {
  export { type UdlSpaceenvobCreateParams as UdlSpaceenvobCreateParams };
}
