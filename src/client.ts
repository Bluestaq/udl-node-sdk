...
import { AirEventCountParams, AirEventCountResponse, AirEventCreateBulkParams, AirEventCreateParams, AirEventGetParams, AirEventGetResponse, AirEventListParams, AirEventListResponse, AirEventListResponsesOffsetPage, AirEventQueryhelpResponse, AirEventTupleParams, AirEventTupleResponse, AirEventUnvalidatedPublishParams, AirEventUpdateParams, AirEvents } from './resources/air-events';
import { Aircraft, AircraftAbridged, AircraftAbridgedsOffsetPage, AircraftCountParams, AircraftCountResponse, AircraftCreateParams, AircraftListParams, AircraftQueryhelpResponse, AircraftRetrieveParams, AircraftTupleParams, AircraftTupleResponse, AircraftUpdateParams } from './resources/aircraft';
import { AircraftSorties, AircraftSortyQueryhelpResponse, AircraftSortyRetrieveParams, AircraftSortyTupleParams, AircraftSortyTupleResponse, AircraftSortyUpdateParams } from './resources/aircraft-sorties';
import { AircraftStatusRemarkCountParams, AircraftStatusRemarkCountResponse, AircraftStatusRemarkCreateParams, AircraftStatusRemarkListParams, AircraftStatusRemarkQueryhelpResponse, AircraftStatusRemarkRetrieveParams, AircraftStatusRemarkTupleParams, AircraftStatusRemarkTupleResponse, AircraftStatusRemarkUpdateParams, AircraftStatusRemarks, AircraftstatusremarkAbridged, AircraftstatusremarkAbridgedsOffsetPage } from './resources/aircraft-status-remarks';
import { AirfieldSlotConsumptionCountParams, AirfieldSlotConsumptionCountResponse, AirfieldSlotConsumptionCreateParams, AirfieldSlotConsumptionListParams, AirfieldSlotConsumptionQueryhelpResponse, AirfieldSlotConsumptionRetrieveParams, AirfieldSlotConsumptionTupleParams, AirfieldSlotConsumptionTupleResponse, AirfieldSlotConsumptionUpdateParams, AirfieldSlotConsumptions, AirfieldslotconsumptionAbridged, AirfieldslotconsumptionAbridgedsOffsetPage } from './resources/airfield-slot-consumptions';
import { AirfieldSlotCountParams, AirfieldSlotCountResponse, AirfieldSlotCreateParams, AirfieldSlotListParams, AirfieldSlotQueryhelpResponse, AirfieldSlotRetrieveParams, AirfieldSlotTupleParams, AirfieldSlotTupleResponse, AirfieldSlotUpdateParams, AirfieldSlots, AirfieldslotAbridged, AirfieldslotAbridgedsOffsetPage } from './resources/airfield-slots';
import { AirfieldAbridged, AirfieldAbridgedsOffsetPage, AirfieldCountParams, AirfieldCountResponse, AirfieldCreateParams, AirfieldListParams, AirfieldQueryhelpResponse, AirfieldRetrieveParams, AirfieldTupleParams, AirfieldTupleResponse, AirfieldUpdateParams, Airfields } from './resources/airfields';
import { AirloadPlanCountParams, AirloadPlanCountResponse, AirloadPlanCreateParams, AirloadPlanListParams, AirloadPlanQueryhelpResponse, AirloadPlanRetrieveParams, AirloadPlanTupleParams, AirloadPlanTupleResponse, AirloadPlanUpdateParams, AirloadPlans, AirloadplanAbridged, AirloadplanAbridgedsOffsetPage } from './resources/airload-plans';
import { AirspaceControlOrderCountParams, AirspaceControlOrderCountResponse, AirspaceControlOrderCreateBulkParams, AirspaceControlOrderCreateParams, AirspaceControlOrderListParams, AirspaceControlOrderQueryHelpResponse, AirspaceControlOrderRetrieveParams, AirspaceControlOrderTupleParams, AirspaceControlOrderTupleResponse, AirspaceControlOrders, AirspacecontrolorderAbridged, AirspacecontrolorderAbridgedsOffsetPage } from './resources/airspace-control-orders';
import { AIsObjectUnvalidatedPublishParams, AIsObjects } from './resources/ais-objects';
import { AntennaAbridged, AntennaAbridgedsOffsetPage, AntennaCountParams, AntennaCountResponse, AntennaCreateParams, AntennaListParams, AntennaQueryhelpResponse, AntennaRetrieveParams, AntennaTupleParams, AntennaTupleResponse, AntennaUpdateParams, Antennas } from './resources/antennas';
import { AttitudeData, AttitudeDataQueryHelpResponse, AttitudeDataTupleParams, AttitudeDataTupleResponse } from './resources/attitude-data';
import { AviationRiskManagement, AviationRiskManagementCountParams, AviationRiskManagementCountResponse, AviationRiskManagementCreateBulkParams, AviationRiskManagementCreateParams, AviationRiskManagementListParams, AviationRiskManagementListResponse, AviationRiskManagementListResponsesOffsetPage, AviationRiskManagementQueryHelpResponse, AviationRiskManagementRetrieveParams, AviationRiskManagementRetrieveResponse, AviationRiskManagementTupleParams, AviationRiskManagementTupleResponse, AviationRiskManagementUnvalidatedPublishParams, AviationRiskManagementUpdateParams } from './resources/aviation-risk-management';
import { Batteries, BatteryAbridged, BatteryAbridgedsOffsetPage, BatteryCountParams, BatteryCountResponse, BatteryCreateParams, BatteryListParams, BatteryQueryhelpResponse, BatteryRetrieveParams, BatteryTupleParams, BatteryTupleResponse, BatteryUpdateParams } from './resources/batteries';
import { BatterydetailCreateParams, BatterydetailListParams, BatterydetailRetrieveParams, BatterydetailUpdateParams, Batterydetails, BatterydetailsAbridged, BatterydetailsAbridgedsOffsetPage } from './resources/batterydetails';
import { Beam, BeamAbridged, BeamAbridgedsOffsetPage, BeamCountParams, BeamCountResponse, BeamCreateParams, BeamListParams, BeamQueryHelpResponse, BeamRetrieveParams, BeamTupleParams, BeamTupleResponse, BeamUpdateParams } from './resources/beam';
import { BeamContourCountParams, BeamContourCountResponse, BeamContourCreateBulkParams, BeamContourCreateParams, BeamContourListParams, BeamContourQueryHelpResponse, BeamContourRetrieveParams, BeamContourTupleParams, BeamContourTupleResponse, BeamContourUpdateParams, BeamContours, BeamcontourAbridged, BeamcontourAbridgedsOffsetPage } from './resources/beam-contours';
import { BusAbridged, BusAbridgedsOffsetPage, BusCountParams, BusCountResponse, BusCreateParams, BusListParams, BusQueryHelpResponse, BusRetrieveParams, BusTupleParams, BusTupleResponse, BusUpdateParams, Buses } from './resources/buses';
import { ChannelAbridged, ChannelAbridgedsOffsetPage, ChannelCountParams, ChannelCountResponse, ChannelCreateParams, ChannelListParams, ChannelQueryhelpResponse, ChannelRetrieveParams, ChannelTupleParams, ChannelTupleResponse, ChannelUpdateParams, Channels } from './resources/channels';
import { Comm, CommAbridged, CommAbridgedsOffsetPage, CommCountParams, CommCountResponse, CommCreateParams, CommListParams, CommQueryhelpResponse, CommRetrieveParams, CommTupleParams, CommTupleResponse, CommUpdateParams } from './resources/comm';
import { CotCreateParams, Cots } from './resources/cots';
import { Countries, CountryAbridged, CountryAbridgedsOffsetPage, CountryCountParams, CountryCountResponse, CountryCreateParams, CountryListParams, CountryQueryhelpResponse, CountryRetrieveParams, CountryTupleParams, CountryTupleResponse, CountryUpdateParams } from './resources/countries';
import { Crew, CrewAbridged, CrewAbridgedsOffsetPage, CrewCountParams, CrewCountResponse, CrewCreateParams, CrewListParams, CrewQueryhelpResponse, CrewRetrieveParams, CrewTupleParams, CrewTupleResponse, CrewUnvalidatedPublishParams, CrewUpdateParams } from './resources/crew';
import { DriftHistory, DriftHistoryCountParams, DriftHistoryCountResponse, DriftHistoryListParams, DriftHistoryQueryhelpResponse, DriftHistoryRetrieveParams, DriftHistoryTupleParams, DriftHistoryTupleResponse } from './resources/drift-history';
import { Dropzone, DropzoneCountParams, DropzoneCountResponse, DropzoneCreateBulkParams, DropzoneCreateParams, DropzoneListParams, DropzoneListResponse, DropzoneListResponsesOffsetPage, DropzoneQueryHelpResponse, DropzoneRetrieveParams, DropzoneRetrieveResponse, DropzoneTupleParams, DropzoneTupleResponse, DropzoneUnvalidatedPublishParams, DropzoneUpdateParams } from './resources/dropzone';
import { EmitterGeolocation, EmitterGeolocationCountParams, EmitterGeolocationCountResponse, EmitterGeolocationCreateBulkParams, EmitterGeolocationCreateParams, EmitterGeolocationListParams, EmitterGeolocationListResponse, EmitterGeolocationListResponsesOffsetPage, EmitterGeolocationQueryHelpResponse, EmitterGeolocationRetrieveParams, EmitterGeolocationRetrieveResponse, EmitterGeolocationTupleParams, EmitterGeolocationTupleResponse, EmitterGeolocationUnvalidatedPublishParams } from './resources/emitter-geolocation';
import { EngineDetailCreateParams, EngineDetailListParams, EngineDetailRetrieveParams, EngineDetailUpdateParams, EngineDetails, EngineDetailsAbridged, EngineDetailsAbridgedsOffsetPage } from './resources/engine-details';
import { EngineAbridged, EngineAbridgedsOffsetPage, EngineCountParams, EngineCountResponse, EngineCreateParams, EngineListParams, EngineQueryhelpResponse, EngineRetrieveParams, EngineTupleParams, EngineTupleResponse, EngineUpdateParams, Engines } from './resources/engines';
import { Entities, EntityAbridged, EntityAbridgedsOffsetPage, EntityCountParams, EntityCountResponse, EntityCreateParams, EntityGetAllTypesParams, EntityGetAllTypesResponse, EntityIngest, EntityListParams, EntityQueryHelpResponse, EntityRetrieveParams, EntityTupleParams, EntityTupleResponse, EntityUpdateParams } from './resources/entities';
import { Equipment, EquipmentAbridged, EquipmentAbridgedsOffsetPage, EquipmentCountParams, EquipmentCountResponse, EquipmentCreateBulkParams, EquipmentCreateParams, EquipmentFull, EquipmentListParams, EquipmentQueryHelpResponse, EquipmentRetrieveParams, EquipmentTupleParams, EquipmentTupleResponse, EquipmentUpdateParams } from './resources/equipment';
import { EquipmentRemarkAbridged, EquipmentRemarkAbridgedsOffsetPage, EquipmentRemarkCountParams, EquipmentRemarkCountResponse, EquipmentRemarkCreateBulkParams, EquipmentRemarkCreateParams, EquipmentRemarkFull, EquipmentRemarkListParams, EquipmentRemarkQueryHelpResponse, EquipmentRemarkRetrieveParams, EquipmentRemarkTupleParams, EquipmentRemarkTupleResponse, EquipmentRemarks } from './resources/equipment-remarks';
import { FlightPlanAbridged, FlightPlanAbridgedsOffsetPage, Flightplan, FlightplanCountParams, FlightplanCountResponse, FlightplanCreateParams, FlightplanListParams, FlightplanQueryhelpResponse, FlightplanRetrieveParams, FlightplanTupleParams, FlightplanTupleResponse, FlightplanUnvalidatedPublishParams, FlightplanUpdateParams } from './resources/flightplan';
import { H3GeoHexCell, H3GeoHexCellCountParams, H3GeoHexCellCountResponse, H3GeoHexCellListParams, H3GeoHexCellListResponse, H3GeoHexCellListResponsesOffsetPage, H3GeoHexCellQueryhelpResponse, H3GeoHexCellTupleParams, H3GeoHexCellTupleResponse } from './resources/h3-geo-hex-cell';
import { Ir, IrCountParams, IrCountResponse, IrCreateParams, IrGetParams, IrGetResponse, IrListParams, IrListResponse, IrListResponsesOffsetPage, IrQueryhelpResponse, IrTupleParams, IrTupleResponse, IrUpdateParams } from './resources/ir';
import { Item, ItemCountParams, ItemCountResponse, ItemCreateParams, ItemGetParams, ItemGetResponse, ItemListParams, ItemListResponse, ItemListResponsesOffsetPage, ItemQueryhelpResponse, ItemTupleParams, ItemTupleResponse, ItemUnvalidatedPublishParams, ItemUpdateParams } from './resources/item';
import { LaunchDetection, LaunchDetectionCountParams, LaunchDetectionCountResponse, LaunchDetectionCreateParams, LaunchDetectionGetParams, LaunchDetectionGetResponse, LaunchDetectionListParams, LaunchDetectionListResponse, LaunchDetectionListResponsesOffsetPage, LaunchDetectionQueryhelpResponse, LaunchDetectionTupleParams, LaunchDetectionTupleResponse, LaunchDetectionUpdateParams } from './resources/launch-detection';
import { LaunchSite, LaunchSiteCountParams, LaunchSiteCountResponse, LaunchSiteCreateParams, LaunchSiteGetParams, LaunchSiteGetResponse, LaunchSiteListParams, LaunchSiteListResponse, LaunchSiteListResponsesOffsetPage, LaunchSiteQueryhelpResponse, LaunchSiteTupleParams, LaunchSiteTupleResponse, LaunchSiteUpdateParams } from './resources/launch-site';
import { LaunchSiteDetailCreateParams, LaunchSiteDetailFindBySourceParams, LaunchSiteDetailFindBySourceResponse, LaunchSiteDetailGetParams, LaunchSiteDetailGetResponse, LaunchSiteDetailListParams, LaunchSiteDetailListResponse, LaunchSiteDetailListResponsesOffsetPage, LaunchSiteDetailUpdateParams, LaunchSiteDetails } from './resources/launch-site-details';
import { LaunchVehicle, LaunchVehicleCountParams, LaunchVehicleCountResponse, LaunchVehicleCreateParams, LaunchVehicleGetParams, LaunchVehicleGetResponse, LaunchVehicleListParams, LaunchVehicleListResponse, LaunchVehicleListResponsesOffsetPage, LaunchVehicleQueryhelpResponse, LaunchVehicleTupleParams, LaunchVehicleTupleResponse, LaunchVehicleUpdateParams } from './resources/launch-vehicle';
import { LaunchVehicleDetailCreateParams, LaunchVehicleDetailGetParams, LaunchVehicleDetailGetResponse, LaunchVehicleDetailListParams, LaunchVehicleDetailListResponse, LaunchVehicleDetailListResponsesOffsetPage, LaunchVehicleDetailUpdateParams, LaunchVehicleDetails } from './resources/launch-vehicle-details';
import { Linkstatus, LinkstatusUpdateParams } from './resources/linkstatus';
import { Location, LocationCountParams, LocationCountResponse, LocationCreateParams, LocationGetParams, LocationIngest, LocationListParams, LocationQueryhelpResponse, LocationTupleParams, LocationTupleResponse, LocationUpdateParams } from './resources/location';
import { Manifold, ManifoldCountParams, ManifoldCountResponse, ManifoldCreateBulkParams, ManifoldCreateParams, ManifoldGetParams, ManifoldGetResponse, ManifoldListParams, ManifoldListResponse, ManifoldListResponsesOffsetPage, ManifoldQueryhelpResponse, ManifoldTupleParams, ManifoldTupleResponse, ManifoldUpdateParams } from './resources/manifold';
import { Manifoldelset, ManifoldelsetCountParams, ManifoldelsetCountResponse, ManifoldelsetCreateBulkParams, ManifoldelsetCreateParams, ManifoldelsetGetParams, ManifoldelsetGetResponse, ManifoldelsetListParams, ManifoldelsetListResponse, ManifoldelsetListResponsesOffsetPage, ManifoldelsetQueryhelpResponse, ManifoldelsetTupleParams, ManifoldelsetTupleResponse, ManifoldelsetUpdateParams } from './resources/manifoldelset';
import { Navigation, NavigationCountParams, NavigationCountResponse, NavigationCreateParams, NavigationGetParams, NavigationGetResponse, NavigationListParams, NavigationListResponse, NavigationListResponsesOffsetPage, NavigationQueryhelpResponse, NavigationTupleParams, NavigationTupleResponse, NavigationUpdateParams } from './resources/navigation';
import { NavigationalObstruction, NavigationalObstructionCountParams, NavigationalObstructionCountResponse, NavigationalObstructionCreateBulkParams, NavigationalObstructionCreateParams, NavigationalObstructionGetParams, NavigationalObstructionGetResponse, NavigationalObstructionListParams, NavigationalObstructionListResponse, NavigationalObstructionListResponsesOffsetPage, NavigationalObstructionQueryhelpResponse, NavigationalObstructionTupleParams, NavigationalObstructionTupleResponse, NavigationalObstructionUpdateParams } from './resources/navigational-obstruction';
import { ObjectOfInterest, ObjectOfInterestCountParams, ObjectOfInterestCountResponse, ObjectOfInterestCreateParams, ObjectOfInterestGetParams, ObjectOfInterestGetResponse, ObjectOfInterestListParams, ObjectOfInterestListResponse, ObjectOfInterestListResponsesOffsetPage, ObjectOfInterestQueryhelpResponse, ObjectOfInterestTupleParams, ObjectOfInterestTupleResponse, ObjectOfInterestUpdateParams } from './resources/object-of-interest';
import { Onorbitantenna, OnorbitantennaCreateParams, OnorbitantennaGetParams, OnorbitantennaListParams, OnorbitantennaListResponse, OnorbitantennaListResponsesOffsetPage, OnorbitantennaUpdateParams } from './resources/onorbitantenna';
import { Onorbitbattery, OnorbitbatteryCreateParams, OnorbitbatteryGetParams, OnorbitbatteryListParams, OnorbitbatteryListResponse, OnorbitbatteryListResponsesOffsetPage, OnorbitbatteryUpdateParams } from './resources/onorbitbattery';
import { OnorbitdetailCreateParams, OnorbitdetailGetParams, OnorbitdetailListParams, OnorbitdetailListResponse, OnorbitdetailListResponsesOffsetPage, OnorbitdetailUpdateParams, Onorbitdetails } from './resources/onorbitdetails';
import { Onorbitevent, OnorbiteventCountParams, OnorbiteventCountResponse, OnorbiteventCreateParams, OnorbiteventGetParams, OnorbiteventGetResponse, OnorbiteventListParams, OnorbiteventListResponse, OnorbiteventListResponsesOffsetPage, OnorbiteventQueryhelpResponse, OnorbiteventTupleParams, OnorbiteventTupleResponse, OnorbiteventUpdateParams } from './resources/onorbitevent';
import { Onorbitlist, OnorbitlistCountParams, OnorbitlistCountResponse, OnorbitlistCreateParams, OnorbitlistGetParams, OnorbitlistGetResponse, OnorbitlistListParams, OnorbitlistListResponse, OnorbitlistListResponsesOffsetPage, OnorbitlistQueryhelpResponse, OnorbitlistTupleParams, OnorbitlistTupleResponse, OnorbitlistUpdateParams } from './resources/onorbitlist';
import { Onorbitsolararray, OnorbitsolararrayCreateParams, OnorbitsolararrayGetParams, OnorbitsolararrayListParams, OnorbitsolararrayListResponse, OnorbitsolararrayListResponsesOffsetPage, OnorbitsolararrayUpdateParams } from './resources/onorbitsolararray';
import { Onorbitthruster, OnorbitthrusterCreateParams, OnorbitthrusterGetParams, OnorbitthrusterListParams, OnorbitthrusterListResponse, OnorbitthrusterListResponsesOffsetPage, OnorbitthrusterUpdateParams } from './resources/onorbitthruster';
import { Operatingunit, OperatingunitCountParams, OperatingunitCountResponse, OperatingunitCreateParams, OperatingunitGetParams, OperatingunitListParams, OperatingunitListResponse, OperatingunitListResponsesOffsetPage, OperatingunitQueryhelpResponse, OperatingunitTupleParams, OperatingunitTupleResponse, OperatingunitUpdateParams } from './resources/operatingunit';
import { Operatingunitremark, OperatingunitremarkCountParams, OperatingunitremarkCountResponse, OperatingunitremarkCreateBulkParams, OperatingunitremarkCreateParams, OperatingunitremarkGetParams, OperatingunitremarkListParams, OperatingunitremarkListResponse, OperatingunitremarkListResponsesOffsetPage, OperatingunitremarkQueryhelpResponse, OperatingunitremarkTupleParams, OperatingunitremarkTupleResponse } from './resources/operatingunitremark';
import { Organization, OrganizationCountParams, OrganizationCountResponse, OrganizationCreateParams, OrganizationGetOrganizationCategoriesParams, OrganizationGetOrganizationCategoriesResponse, OrganizationGetOrganizationTypesParams, OrganizationGetOrganizationTypesResponse, OrganizationGetParams, OrganizationListParams, OrganizationListResponse, OrganizationListResponsesOffsetPage, OrganizationQueryhelpResponse, OrganizationTupleParams, OrganizationTupleResponse, OrganizationUpdateParams } from './resources/organization';
import { OrganizationdetailCreateParams, OrganizationdetailFindBySourceParams, OrganizationdetailFindBySourceResponse, OrganizationdetailGetParams, OrganizationdetailListParams, OrganizationdetailListResponse, OrganizationdetailListResponsesOffsetPage, OrganizationdetailUpdateParams, Organizationdetails } from './resources/organizationdetails';
import { Poi, PoiCountParams, PoiCountResponse, PoiCreateBulkParams, PoiCreateParams, PoiGetParams, PoiGetResponse, PoiListParams, PoiListResponse, PoiListResponsesOffsetPage, PoiQueryhelpResponse, PoiTupleParams, PoiTupleResponse, PoiUnvalidatedPublishParams } from './resources/poi';
import { Port, PortCountParams, PortCountResponse, PortCreateBulkParams, PortCreateParams, PortGetParams, PortGetResponse, PortListParams, PortListResponse, PortListResponsesOffsetPage, PortQueryhelpResponse, PortTupleParams, PortTupleResponse, PortUpdateParams } from './resources/port';
import { RfBand, RfBandCountParams, RfBandCountResponse, RfBandCreateParams, RfBandGetParams, RfBandListParams, RfBandListResponse, RfBandListResponsesOffsetPage, RfBandQueryhelpResponse, RfBandTupleParams, RfBandTupleResponse, RfBandUpdateParams } from './resources/rf-band';
import { RfBandType, RfBandTypeCountParams, RfBandTypeCountResponse, RfBandTypeCreateParams, RfBandTypeGetParams, RfBandTypeGetResponse, RfBandTypeListParams, RfBandTypeListResponse, RfBandTypeListResponsesOffsetPage, RfBandTypeQueryhelpResponse, RfBandTypeTupleParams, RfBandTypeTupleResponse, RfBandTypeUpdateParams } from './resources/rf-band-type';
import { RouteStatCountParams, RouteStatCountResponse, RouteStatCreateBulkParams, RouteStatCreateParams, RouteStatListParams, RouteStatListResponse, RouteStatListResponsesOffsetPage, RouteStatQueryHelpResponse, RouteStatRetrieveParams, RouteStatRetrieveResponse, RouteStatTupleParams, RouteStatTupleResponse, RouteStatUnvalidatedPublishParams, RouteStatUpdateParams, RouteStats } from './resources/route-stats';
import { Scientific, ScientificCountParams, ScientificCountResponse, ScientificCreateParams, ScientificGetParams, ScientificGetResponse, ScientificListParams, ScientificListResponse, ScientificListResponsesOffsetPage, ScientificQueryhelpResponse, ScientificTupleParams, ScientificTupleResponse, ScientificUpdateParams } from './resources/scientific';
import { SecureMessaging, SecureMessagingDescribeTopicParams, SecureMessagingGetLatestOffsetParams, SecureMessagingGetMessagesParams, SecureMessagingListTopicsResponse, TopicDetails } from './resources/secure-messaging';
import { SensorObservationType, SensorObservationTypeGetParams, SensorObservationTypeGetResponse, SensorObservationTypeListParams, SensorObservationTypeListResponse, SensorObservationTypeListResponsesOffsetPage } from './resources/sensor-observation-type';
import { SensorStating, SensorStatingCreateBulkParams, SensorStatingCreateParams, SensorStatingGetParams, SensorStatingGetResponse, SensorStatingListParams, SensorStatingListResponse, SensorStatingListResponsesOffsetPage, SensorStatingQueryhelpResponse, SensorStatingUpdateParams } from './resources/sensor-stating';
import { SensorType, SensorTypeGetParams, SensorTypeGetResponse, SensorTypeListParams, SensorTypeListResponse, SensorTypeListResponsesOffsetPage } from './resources/sensor-type';
import { SeraDataCommDetailCountParams, SeraDataCommDetailCountResponse, SeraDataCommDetailCreateParams, SeraDataCommDetailGetParams, SeraDataCommDetailGetResponse, SeraDataCommDetailListParams, SeraDataCommDetailListResponse, SeraDataCommDetailListResponsesOffsetPage, SeraDataCommDetailQueryhelpResponse, SeraDataCommDetailTupleParams, SeraDataCommDetailTupleResponse, SeraDataCommDetailUpdateParams, SeraDataCommDetails } from './resources/sera-data-comm-details';
import { SeraDataEarlyWarning, SeraDataEarlyWarningCountParams, SeraDataEarlyWarningCountResponse, SeraDataEarlyWarningCreateParams, SeraDataEarlyWarningGetParams, SeraDataEarlyWarningGetResponse, SeraDataEarlyWarningListParams, SeraDataEarlyWarningListResponse, SeraDataEarlyWarningListResponsesOffsetPage, SeraDataEarlyWarningQueryhelpResponse, SeraDataEarlyWarningTupleParams, SeraDataEarlyWarningTupleResponse, SeraDataEarlyWarningUpdateParams } from './resources/sera-data-early-warning';
import { SeraDataNavigation, SeraDataNavigationCountParams, SeraDataNavigationCountResponse, SeraDataNavigationCreateParams, SeraDataNavigationGetParams, SeraDataNavigationGetResponse, SeraDataNavigationListParams, SeraDataNavigationListResponse, SeraDataNavigationListResponsesOffsetPage, SeraDataNavigationQueryhelpResponse, SeraDataNavigationTupleParams, SeraDataNavigationTupleResponse, SeraDataNavigationUpdateParams } from './resources/sera-data-navigation';
import { SeradataOpticalPayload, SeradataOpticalPayloadCountParams, SeradataOpticalPayloadCountResponse, SeradataOpticalPayloadCreateParams, SeradataOpticalPayloadGetParams, SeradataOpticalPayloadGetResponse, SeradataOpticalPayloadListParams, SeradataOpticalPayloadListResponse, SeradataOpticalPayloadListResponsesOffsetPage, SeradataOpticalPayloadQueryhelpResponse, SeradataOpticalPayloadTupleParams, SeradataOpticalPayloadTupleResponse, SeradataOpticalPayloadUpdateParams } from './resources/seradata-optical-payload';
import { SeradataRadarPayload, SeradataRadarPayloadCountParams, SeradataRadarPayloadCountResponse, SeradataRadarPayloadCreateParams, SeradataRadarPayloadGetParams, SeradataRadarPayloadGetResponse, SeradataRadarPayloadListParams, SeradataRadarPayloadListResponse, SeradataRadarPayloadListResponsesOffsetPage, SeradataRadarPayloadQueryhelpResponse, SeradataRadarPayloadTupleParams, SeradataRadarPayloadTupleResponse, SeradataRadarPayloadUpdateParams } from './resources/seradata-radar-payload';
import { SeradataSigintPayload, SeradataSigintPayloadCountParams, SeradataSigintPayloadCountResponse, SeradataSigintPayloadCreateParams, SeradataSigintPayloadGetParams, SeradataSigintPayloadGetResponse, SeradataSigintPayloadListParams, SeradataSigintPayloadListResponse, SeradataSigintPayloadListResponsesOffsetPage, SeradataSigintPayloadQueryhelpResponse, SeradataSigintPayloadTupleParams, SeradataSigintPayloadTupleResponse, SeradataSigintPayloadUpdateParams } from './resources/seradata-sigint-payload';
import { SeradataSpacecraftDetailCountParams, SeradataSpacecraftDetailCountResponse, SeradataSpacecraftDetailCreateParams, SeradataSpacecraftDetailGetParams, SeradataSpacecraftDetailGetResponse, SeradataSpacecraftDetailListParams, SeradataSpacecraftDetailListResponse, SeradataSpacecraftDetailListResponsesOffsetPage, SeradataSpacecraftDetailQueryhelpResponse, SeradataSpacecraftDetailTupleParams, SeradataSpacecraftDetailTupleResponse, SeradataSpacecraftDetailUpdateParams, SeradataSpacecraftDetails } from './resources/seradata-spacecraft-details';
import { SiteRemark, SiteRemarkCountParams, SiteRemarkCountResponse, SiteRemarkCreateParams, SiteRemarkGetParams, SiteRemarkGetResponse, SiteRemarkListParams, SiteRemarkListResponse, SiteRemarkListResponsesOffsetPage, SiteRemarkQueryhelpResponse, SiteRemarkTupleParams, SiteRemarkTupleResponse } from './resources/site-remark';
import { SolarArray, SolarArrayCountParams, SolarArrayCountResponse, SolarArrayCreateParams, SolarArrayGetParams, SolarArrayListParams, SolarArrayListResponse, SolarArrayListResponsesOffsetPage, SolarArrayQueryhelpResponse, SolarArrayTupleParams, SolarArrayTupleResponse, SolarArrayUpdateParams } from './resources/solar-array';
import { SolarArrayDetailCreateParams, SolarArrayDetailGetParams, SolarArrayDetailListParams, SolarArrayDetailListResponse, SolarArrayDetailListResponsesOffsetPage, SolarArrayDetailUpdateParams, SolarArrayDetails } from './resources/solar-array-details';
import { Stage, StageCountParams, StageCountResponse, StageCreateParams, StageGetParams, StageGetResponse, StageListParams, StageListResponse, StageListResponsesOffsetPage, StageQueryhelpResponse, StageTupleParams, StageTupleResponse, StageUpdateParams } from './resources/stage';
import { Status, StatusCountParams, StatusCountResponse, StatusCreateParams, StatusGetByEntityIDParams, StatusGetByEntityIDResponse, StatusGetByEntityTypeParams, StatusGetByEntityTypeResponse, StatusGetParams, StatusListParams, StatusListResponse, StatusListResponsesOffsetPage, StatusQueryhelpResponse, StatusTupleParams, StatusTupleResponse, StatusUpdateParams } from './resources/status';
import { Substatus, SubstatusCountParams, SubstatusCountResponse, SubstatusCreateParams, SubstatusGetParams, SubstatusListParams, SubstatusListResponse, SubstatusListResponsesOffsetPage, SubstatusQueryhelpResponse, SubstatusTupleParams, SubstatusTupleResponse, SubstatusUpdateParams } from './resources/substatus';
import { Surface, SurfaceCountParams, SurfaceCountResponse, SurfaceCreateParams, SurfaceGetParams, SurfaceGetResponse, SurfaceListParams, SurfaceListResponse, SurfaceListResponsesOffsetPage, SurfaceQueryhelpResponse, SurfaceTupleParams, SurfaceTupleResponse, SurfaceUpdateParams } from './resources/surface';
import { SurfaceObstruction, SurfaceObstructionCountParams, SurfaceObstructionCountResponse, SurfaceObstructionCreateParams, SurfaceObstructionGetParams, SurfaceObstructionGetResponse, SurfaceObstructionListParams, SurfaceObstructionListResponse, SurfaceObstructionListResponsesOffsetPage, SurfaceObstructionQueryhelpResponse, SurfaceObstructionTupleParams, SurfaceObstructionTupleResponse, SurfaceObstructionUnvalidatedPublishParams, SurfaceObstructionUpdateParams } from './resources/surface-obstruction';
import { Transponder, TransponderCountParams, TransponderCountResponse, TransponderCreateParams, TransponderGetParams, TransponderGetResponse, TransponderListParams, TransponderListResponse, TransponderListResponsesOffsetPage, TransponderQueryhelpResponse, TransponderTupleParams, TransponderTupleResponse, TransponderUpdateParams } from './resources/transponder';
import { User, UserAuthResponse } from './resources/user';
import { Vessel, VesselCountParams, VesselCountResponse, VesselCreateBulkParams, VesselCreateParams, VesselGetParams, VesselGetResponse, VesselListParams, VesselListResponse, VesselListResponsesOffsetPage, VesselQueryhelpResponse, VesselTupleParams, VesselTupleResponse, VesselUpdateParams } from './resources/vessel';
import { AirOperations } from './resources/air-operations/air-operations';
import { AirTransportMissionAbridged, AirTransportMissionAbridgedsOffsetPage, AirTransportMissionCountParams, AirTransportMissionCountResponse, AirTransportMissionCreateParams, AirTransportMissionListParams, AirTransportMissionQueryhelpResponse, AirTransportMissionRetrieveParams, AirTransportMissionTupleParams, AirTransportMissionTupleResponse, AirTransportMissionUpdateParams, AirTransportMissions } from './resources/air-transport-missions/air-transport-missions';
import { AircraftStatusCountParams, AircraftStatusCountResponse, AircraftStatusCreateParams, AircraftStatusListParams, AircraftStatusQueryhelpResponse, AircraftStatusRetrieveParams, AircraftStatusTupleParams, AircraftStatusTupleResponse, AircraftStatusUpdateParams, AircraftStatuses, AircraftstatusAbridged, AircraftstatusAbridgedsOffsetPage } from './resources/aircraft-statuses/aircraft-statuses';
import { AirfieldStatus, AirfieldStatusCountParams, AirfieldStatusCountResponse, AirfieldStatusCreateParams, AirfieldStatusListParams, AirfieldStatusQueryhelpResponse, AirfieldStatusRetrieveParams, AirfieldStatusTupleParams, AirfieldStatusTupleResponse, AirfieldStatusUpdateParams, AirfieldstatusAbridged, AirfieldstatusAbridgedsOffsetPage } from './resources/airfield-status/airfield-status';
import { AICountParams, AICountResponse, AICreateBulkParams, AIListParams, AIQueryhelpResponse, AITupleParams, AITupleResponse, AIs, AIsAbridged, AIsAbridgedsOffsetPage } from './resources/ais/ais';
import { AnalyticImagery, AnalyticImageryAbridged, AnalyticImageryAbridgedsOffsetPage, AnalyticImageryCountParams, AnalyticImageryCountResponse, AnalyticImageryFileGetParams, AnalyticImageryListParams, AnalyticImageryQueryhelpResponse, AnalyticImageryRetrieveParams, AnalyticImageryTupleParams, AnalyticImageryTupleResponse, AnalyticImageryUnvalidatedPublishParams } from './resources/analytic-imagery/analytic-imagery';
import { AttitudeSetCountParams, AttitudeSetCountResponse, AttitudeSetCreateParams, AttitudeSetListParams, AttitudeSetQueryHelpResponse, AttitudeSetRetrieveParams, AttitudeSetTupleParams, AttitudeSetTupleResponse, AttitudeSetUnvalidatedPublishParams, AttitudeSets, AttitudesetAbridged, AttitudesetAbridgedsOffsetPage } from './resources/attitude-sets/attitude-sets';
import { CloselyspacedobjectCountParams, CloselyspacedobjectCountResponse, CloselyspacedobjectCreateBulkParams, CloselyspacedobjectCreateParams, CloselyspacedobjectListParams, CloselyspacedobjectQueryHelpResponse, CloselyspacedobjectRetrieveParams, CloselyspacedobjectRetrieveResponse, CloselyspacedobjectTupleParams, CloselyspacedobjectTupleResponse, CloselyspacedobjectUnvalidatedPublishParams, Closelyspacedobjects, CloselyspacedobjectsAbridged, CloselyspacedobjectsAbridgedsOffsetPage } from './resources/closelyspacedobjects/closelyspacedobjects';
import { CollectRequestAbridged, CollectRequestAbridgedsOffsetPage, CollectRequestCountParams, CollectRequestCountResponse, CollectRequestCreateBulkParams, CollectRequestCreateParams, CollectRequestListParams, CollectRequestQueryHelpResponse, CollectRequestRetrieveParams, CollectRequestTupleParams, CollectRequestTupleResponse, CollectRequestUnvalidatedPublishParams, CollectRequests } from './resources/collect-requests/collect-requests';
import { CollectResponseAbridged, CollectResponseAbridgedsOffsetPage, CollectResponseCountParams, CollectResponseCountResponse, CollectResponseCreateBulkParams, CollectResponseCreateParams, CollectResponseListParams, CollectResponseQueryHelpResponse, CollectResponseRetrieveParams, CollectResponseUnvalidatedPublishParams, CollectResponses } from './resources/collect-responses/collect-responses';
import { ConjunctionAbridged, ConjunctionAbridgedsOffsetPage, ConjunctionCountParams, ConjunctionCountResponse, ConjunctionCreateBulkParams, ConjunctionCreateUdlParams, ConjunctionGetHistoryParams, ConjunctionGetHistoryResponse, ConjunctionListParams, ConjunctionQueryhelpResponse, ConjunctionRetrieveParams, ConjunctionTupleParams, ConjunctionTupleResponse, ConjunctionUnvalidatedPublishParams, ConjunctionUploadConjunctionDataMessageParams, Conjunctions } from './resources/conjunctions/conjunctions';
import { Deconflictset, DeconflictsetCountParams, DeconflictsetCountResponse, DeconflictsetCreateParams, DeconflictsetGetParams, DeconflictsetGetResponse, DeconflictsetListParams, DeconflictsetListResponse, DeconflictsetListResponsesOffsetPage, DeconflictsetQueryhelpResponse, DeconflictsetTupleParams, DeconflictsetTupleResponse, DeconflictsetUnvalidatedPublishParams } from './resources/deconflictset/deconflictset';
import { DiffOfArrival, DiffOfArrivalQueryhelpResponse, DiffOfArrivalRetrieveParams, DiffOfArrivalTupleParams, DiffOfArrivalTupleResponse, DiffOfArrivalUnvalidatedPublishParams } from './resources/diff-of-arrival/diff-of-arrival';
import { DiplomaticClearance, DiplomaticClearanceCountParams, DiplomaticClearanceCountResponse, DiplomaticClearanceCreateBulkParams, DiplomaticClearanceCreateParams, DiplomaticClearanceListParams, DiplomaticClearanceQueryhelpResponse, DiplomaticClearanceRetrieveParams, DiplomaticClearanceTupleParams, DiplomaticClearanceTupleResponse, DiplomaticClearanceUpdateParams } from './resources/diplomatic-clearance/diplomatic-clearance';
import { Ecpedr, EcpedrCountParams, EcpedrCountResponse, EcpedrCreateBulkParams, EcpedrCreateParams, EcpedrListParams, EcpedrListResponse, EcpedrListResponsesOffsetPage, EcpedrQueryhelpResponse, EcpedrTupleParams, EcpedrTupleResponse, EcpedrUnvalidatedPublishParams } from './resources/ecpedr/ecpedr';
import { EffectRequestCountParams, EffectRequestCountResponse, EffectRequestCreateBulkParams, EffectRequestCreateParams, EffectRequestListParams, EffectRequestListResponse, EffectRequestListResponsesOffsetPage, EffectRequestQueryHelpResponse, EffectRequestRetrieveParams, EffectRequestRetrieveResponse, EffectRequestTupleParams, EffectRequestTupleResponse, EffectRequestUnvalidatedPublishParams, EffectRequests } from './resources/effect-requests/effect-requests';
import { EffectResponseActionsListFull, EffectResponseCountParams, EffectResponseCountResponse, EffectResponseCreateBulkParams, EffectResponseCreateParams, EffectResponseListParams, EffectResponseListResponse, EffectResponseListResponsesOffsetPage, EffectResponseMetricsFull, EffectResponseQueryHelpResponse, EffectResponseRetrieveParams, EffectResponseRetrieveResponse, EffectResponseTupleParams, EffectResponseTupleResponse, EffectResponseUnvalidatedPublishParams, EffectResponses } from './resources/effect-responses/effect-responses';
import { Elset, ElsetAbridged, ElsetAbridgedsOffsetPage, ElsetCountParams, ElsetCountResponse, ElsetCreateBulkFromTleParams, ElsetCreateBulkParams, ElsetCreateParams, ElsetIngest, ElsetListParams, ElsetQueryCurrentElsetHelpResponse, ElsetQueryhelpResponse, ElsetRetrieveParams, ElsetTupleParams, ElsetTupleResponse, ElsetUnvalidatedPublishParams, Elsets } from './resources/elsets/elsets';
import { Emireport, EmireportCountParams, EmireportCountResponse, EmireportCreateBulkParams, EmireportCreateParams, EmireportGetParams, EmireportGetResponse, EmireportListParams, EmireportListResponse, EmireportListResponsesOffsetPage, EmireportQueryhelpResponse, EmireportTupleParams, EmireportTupleResponse, EmireportUnvalidatedPublishParams } from './resources/emireport/emireport';
import { Eop, EopAbridged, EopAbridgedsOffsetPage, EopCountParams, EopCountResponse, EopCreateParams, EopListParams, EopListTupleParams, EopListTupleResponse, EopQueryhelpResponse, EopRetrieveParams, EopUpdateParams } from './resources/eop/eop';
import { EphemerisSet, EphemerisSetAbridged, EphemerisSetAbridgedsOffsetPage, EphemerisSetCountParams, EphemerisSetCountResponse, EphemerisSetCreateParams, EphemerisSetFileRetrieveParams, EphemerisSetListParams, EphemerisSetQueryhelpResponse, EphemerisSetRetrieveParams, EphemerisSetTupleParams, EphemerisSetTupleResponse, EphemerisSets } from './resources/ephemeris-sets/ephemeris-sets';
import { Ephemeris, EphemerisAbridged, EphemerisAbridgedsOffsetPage, EphemerisCountParams, EphemerisCountResponse, EphemerisFileUploadParams, EphemerisListParams, EphemerisQueryhelpResponse, EphemerisTupleParams, EphemerisTupleResponse, EphemerisUnvalidatedPublishParams } from './resources/ephemeris/ephemeris';
import { Evac, EvacAbridged, EvacAbridgedsOffsetPage, EvacCountParams, EvacCountResponse, EvacCreateBulkParams, EvacCreateParams, EvacListParams, EvacQueryHelpResponse, EvacRetrieveParams, EvacUnvalidatedPublishParams } from './resources/evac/evac';
import { EventEvolution, EventEvolutionCountParams, EventEvolutionCountResponse, EventEvolutionCreateBulkParams, EventEvolutionCreateParams, EventEvolutionListParams, EventEvolutionListResponse, EventEvolutionListResponsesOffsetPage, EventEvolutionQueryhelpResponse, EventEvolutionRetrieveParams, EventEvolutionTupleParams, EventEvolutionTupleResponse, EventEvolutionUnvalidatedPublishParams } from './resources/event-evolution/event-evolution';
import { FeatureAssessment, FeatureAssessmentCountParams, FeatureAssessmentCountResponse, FeatureAssessmentCreateBulkParams, FeatureAssessmentCreateParams, FeatureAssessmentListParams, FeatureAssessmentListResponse, FeatureAssessmentListResponsesOffsetPage, FeatureAssessmentQueryHelpResponse, FeatureAssessmentRetrieveParams, FeatureAssessmentRetrieveResponse, FeatureAssessmentTupleParams, FeatureAssessmentTupleResponse, FeatureAssessmentUnvalidatedPublishParams } from './resources/feature-assessment/feature-assessment';
import { GeoStatus, GeoStatusCountParams, GeoStatusCountResponse, GeoStatusCreateBulkParams, GeoStatusCreateParams, GeoStatusGetParams, GeoStatusListParams, GeoStatusListResponse, GeoStatusListResponsesOffsetPage, GeoStatusQueryhelpResponse, GeoStatusTupleParams, GeoStatusTupleResponse } from './resources/geo-status/geo-status';
import { GlobalAtmosphericModel, GlobalAtmosphericModelCountParams, GlobalAtmosphericModelCountResponse, GlobalAtmosphericModelGetFileParams, GlobalAtmosphericModelListParams, GlobalAtmosphericModelListResponse, GlobalAtmosphericModelListResponsesOffsetPage, GlobalAtmosphericModelQueryHelpResponse, GlobalAtmosphericModelRetrieveParams, GlobalAtmosphericModelRetrieveResponse, GlobalAtmosphericModelTupleParams, GlobalAtmosphericModelTupleResponse, GlobalAtmosphericModelUnvalidatedPublishParams } from './resources/global-atmospheric-model/global-atmospheric-model';
import { GnssObservations } from './resources/gnss-observations/gnss-observations';
import { GnssObservationset, GnssObservationsetCountParams, GnssObservationsetCountResponse, GnssObservationsetCreateBulkParams, GnssObservationsetListParams, GnssObservationsetListResponse, GnssObservationsetListResponsesOffsetPage, GnssObservationsetQueryhelpResponse, GnssObservationsetTupleParams, GnssObservationsetTupleResponse, GnssObservationsetUnvalidatedPublishParams } from './resources/gnss-observationset/gnss-observationset';
import { GnssRawIf, GnssRawIfCountParams, GnssRawIfCountResponse, GnssRawIfFileGetParams, GnssRawIfGetParams, GnssRawIfGetResponse, GnssRawIfListParams, GnssRawIfListResponse, GnssRawIfListResponsesOffsetPage, GnssRawIfQueryhelpResponse, GnssRawIfTupleParams, GnssRawIfTupleResponse, GnssRawIfUploadZipParams } from './resources/gnss-raw-if/gnss-raw-if';
import { GroundImagery, GroundImageryAodrParams, GroundImageryCountParams, GroundImageryCountResponse, GroundImageryCreateParams, GroundImageryGetFileParams, GroundImageryGetParams, GroundImageryGetResponse, GroundImageryListParams, GroundImageryListResponse, GroundImageryListResponsesOffsetPage, GroundImageryQueryhelpResponse, GroundImageryTupleParams, GroundImageryTupleResponse, GroundImageryUploadZipParams } from './resources/ground-imagery/ground-imagery';
import { H3Geo, H3GeoCountParams, H3GeoCountResponse, H3GeoCreateParams, H3GeoGetParams, H3GeoGetResponse, H3GeoListParams, H3GeoListResponse, H3GeoListResponsesOffsetPage, H3GeoQueryhelpResponse, H3GeoTupleParams, H3GeoTupleResponse } from './resources/h3-geo/h3-geo';
import { Hazard, HazardCountParams, HazardCountResponse, HazardCreateBulkParams, HazardCreateParams, HazardGetParams, HazardGetResponse, HazardListParams, HazardListResponse, HazardListResponsesOffsetPage, HazardQueryhelpResponse, HazardTupleParams, HazardTupleResponse } from './resources/hazard/hazard';
import { IonoObservationCountParams, IonoObservationCountResponse, IonoObservationCreateBulkParams, IonoObservationListParams, IonoObservationListResponse, IonoObservationListResponsesOffsetPage, IonoObservationQueryhelpResponse, IonoObservationTupleParams, IonoObservationTupleResponse, IonoObservationUnvalidatedPublishParams, IonoObservations } from './resources/iono-observations/iono-observations';
import { IsrCollectionCountParams, IsrCollectionCountResponse, IsrCollectionCreateBulkParams, IsrCollectionCriticalTimesFull, IsrCollectionExploitationRequirementFull, IsrCollectionListParams, IsrCollectionListResponse, IsrCollectionListResponsesOffsetPage, IsrCollectionPocFull, IsrCollectionQueryhelpResponse, IsrCollectionRequirementsFull, IsrCollectionTupleParams, IsrCollectionTupleResponse, IsrCollectionUnvalidatedPublishParams, IsrCollections } from './resources/isr-collections/isr-collections';
import { ItemTrackingCountParams, ItemTrackingCountResponse, ItemTrackingCreateParams, ItemTrackingGetParams, ItemTrackingGetResponse, ItemTrackingListParams, ItemTrackingListResponse, ItemTrackingListResponsesOffsetPage, ItemTrackingQueryhelpResponse, ItemTrackingTupleParams, ItemTrackingTupleResponse, ItemTrackingUnvalidatedPublishParams, ItemTrackings } from './resources/item-trackings/item-trackings';
import { FixedPointFull, Laserdeconflictrequest, LaserdeconflictrequestCountParams, LaserdeconflictrequestCountResponse, LaserdeconflictrequestCreateParams, LaserdeconflictrequestGetParams, LaserdeconflictrequestGetResponse, LaserdeconflictrequestListParams, LaserdeconflictrequestListResponse, LaserdeconflictrequestListResponsesOffsetPage, LaserdeconflictrequestQueryhelpResponse, LaserdeconflictrequestTupleParams, LaserdeconflictrequestTupleResponse, LaserdeconflictrequestUnvalidatedPublishParams } from './resources/laserdeconflictrequest/laserdeconflictrequest';
import { Laseremitter, LaseremitterCountParams, LaseremitterCountResponse, LaseremitterCreateParams, LaseremitterGetParams, LaseremitterGetResponse, LaseremitterListParams, LaseremitterListResponse, LaseremitterListResponsesOffsetPage, LaseremitterQueryhelpResponse, LaseremitterTupleParams, LaseremitterTupleResponse, LaseremitterUpdateParams } from './resources/laseremitter/laseremitter';
import { LaunchEvent, LaunchEventCountParams, LaunchEventCountResponse, LaunchEventCreateBulkParams, LaunchEventCreateParams, LaunchEventGetParams, LaunchEventGetResponse, LaunchEventListParams, LaunchEventListResponse, LaunchEventListResponsesOffsetPage, LaunchEventQueryhelpResponse, LaunchEventTupleParams, LaunchEventTupleResponse, LaunchEventUnvalidatedPublishParams } from './resources/launch-event/launch-event';
import { LinkStatus, LinkStatusCountParams, LinkStatusCountResponse, LinkStatusCreateParams, LinkStatusGetParams, LinkStatusGetResponse, LinkStatusListParams, LinkStatusListResponse, LinkStatusListResponsesOffsetPage, LinkStatusQueryhelpResponse, LinkStatusTupleParams, LinkStatusTupleResponse } from './resources/link-status/link-status';
import { LogisticsDiscrepancyInfosFull, LogisticsPartsFull, LogisticsRemarksAbridged, LogisticsRemarksFull, LogisticsRemarksIngest, LogisticsSegmentsFull, LogisticsSpecialtiesFull, LogisticsStocksFull, LogisticsSupport, LogisticsSupportCountParams, LogisticsSupportCountResponse, LogisticsSupportCreateBulkParams, LogisticsSupportCreateParams, LogisticsSupportGetParams, LogisticsSupportGetResponse, LogisticsSupportItemsFull, LogisticsSupportListParams, LogisticsSupportListResponse, LogisticsSupportListResponsesOffsetPage, LogisticsSupportQueryhelpResponse, LogisticsSupportTupleParams, LogisticsSupportTupleResponse, LogisticsSupportUnvalidatedPublishParams, LogisticsSupportUpdateParams, LogisticsTransportationPlansFull } from './resources/logistics-support/logistics-support';
import { ManeuverCountParams, ManeuverCountResponse, ManeuverCreateBulkParams, ManeuverCreateParams, ManeuverGetParams, ManeuverGetResponse, ManeuverListParams, ManeuverListResponse, ManeuverListResponsesOffsetPage, ManeuverQueryhelpResponse, ManeuverTupleParams, ManeuverTupleResponse, ManeuverUnvalidatedPublishParams, Maneuvers } from './resources/maneuvers/maneuvers';
import { MissileTrackCountParams, MissileTrackCountResponse, MissileTrackCreateBulkParams, MissileTrackListParams, MissileTrackListResponse, MissileTrackListResponsesOffsetPage, MissileTrackQueryhelpResponse, MissileTrackTupleParams, MissileTrackTupleResponse, MissileTrackUnvalidatedPublishParams, MissileTracks } from './resources/missile-tracks/missile-tracks';
import { MissionAssignment, MissionAssignmentCountParams, MissionAssignmentCountResponse, MissionAssignmentCreateBulkParams, MissionAssignmentCreateParams, MissionAssignmentGetParams, MissionAssignmentGetResponse, MissionAssignmentListParams, MissionAssignmentListResponse, MissionAssignmentListResponsesOffsetPage, MissionAssignmentQueryhelpResponse, MissionAssignmentTupleParams, MissionAssignmentTupleResponse, MissionAssignmentUpdateParams } from './resources/mission-assignment/mission-assignment';
import { Mti, MtiCountParams, MtiCountResponse, MtiCreateBulkParams, MtiListParams, MtiListResponse, MtiListResponsesOffsetPage, MtiQueryhelpResponse, MtiTupleParams, MtiTupleResponse, MtiUnvalidatedPublishParams } from './resources/mti/mti';
import { Notification, NotificationCountParams, NotificationCountResponse, NotificationCreateParams, NotificationCreateRawParams, NotificationGetParams, NotificationListParams, NotificationListResponse, NotificationListResponsesOffsetPage, NotificationQueryhelpResponse, NotificationTupleParams, NotificationTupleResponse } from './resources/notification/notification';
import { Observations } from './resources/observations/observations';
import { Onboardnavigation, OnboardnavigationCountParams, OnboardnavigationCountResponse, OnboardnavigationCreateBulkParams, OnboardnavigationListParams, OnboardnavigationListResponse, OnboardnavigationListResponsesOffsetPage, OnboardnavigationQueryhelpResponse, OnboardnavigationTupleParams, OnboardnavigationTupleResponse, OnboardnavigationUnvalidatedPublishParams } from './resources/onboardnavigation/onboardnavigation';
import { Onorbit, OnorbitCountParams, OnorbitCountResponse, OnorbitCreateParams, OnorbitGetParams, OnorbitGetSignatureParams, OnorbitGetSignatureResponse, OnorbitIngest, OnorbitListParams, OnorbitListResponse, OnorbitListResponsesOffsetPage, OnorbitQueryhelpResponse, OnorbitTupleParams, OnorbitTupleResponse, OnorbitUpdateParams } from './resources/onorbit/onorbit';
import { Onorbitassessment, OnorbitassessmentCountParams, OnorbitassessmentCountResponse, OnorbitassessmentCreateBulkParams, OnorbitassessmentCreateParams, OnorbitassessmentGetParams, OnorbitassessmentGetResponse, OnorbitassessmentListParams, OnorbitassessmentListResponse, OnorbitassessmentListResponsesOffsetPage, OnorbitassessmentQueryhelpResponse, OnorbitassessmentTupleParams, OnorbitassessmentTupleResponse, OnorbitassessmentUnvalidatedPublishParams } from './resources/onorbitassessment/onorbitassessment';
import { Onorbitthrusterstatus, OnorbitthrusterstatusCountParams, OnorbitthrusterstatusCountResponse, OnorbitthrusterstatusCreateBulkParams, OnorbitthrusterstatusCreateParams, OnorbitthrusterstatusGetParams, OnorbitthrusterstatusListParams, OnorbitthrusterstatusListResponse, OnorbitthrusterstatusListResponsesOffsetPage, OnorbitthrusterstatusQueryhelpResponse, OnorbitthrusterstatusTupleParams, OnorbitthrusterstatusTupleResponse } from './resources/onorbitthrusterstatus/onorbitthrusterstatus';
import { Orbitdetermination, OrbitdeterminationCountParams, OrbitdeterminationCountResponse, OrbitdeterminationCreateBulkParams, OrbitdeterminationCreateParams, OrbitdeterminationGetParams, OrbitdeterminationGetResponse, OrbitdeterminationListParams, OrbitdeterminationListResponse, OrbitdeterminationListResponsesOffsetPage, OrbitdeterminationQueryhelpResponse, OrbitdeterminationTupleParams, OrbitdeterminationTupleResponse, OrbitdeterminationUnvalidatedPublishParams } from './resources/orbitdetermination/orbitdetermination';
import { Orbittrack, OrbittrackCountParams, OrbittrackCountResponse, OrbittrackCreateBulkParams, OrbittrackListParams, OrbittrackListResponse, OrbittrackListResponsesOffsetPage, OrbittrackQueryhelpResponse, OrbittrackTupleParams, OrbittrackTupleResponse, OrbittrackUnvalidatedPublishParams } from './resources/orbittrack/orbittrack';
import { PersonnelRecoveryFullL, Personnelrecovery, PersonnelrecoveryCountParams, PersonnelrecoveryCountResponse, PersonnelrecoveryCreateBulkParams, PersonnelrecoveryCreateParams, PersonnelrecoveryFileCreateParams, PersonnelrecoveryGetParams, PersonnelrecoveryListParams, PersonnelrecoveryListResponse, PersonnelrecoveryListResponsesOffsetPage, PersonnelrecoveryQueryhelpResponse, PersonnelrecoveryTupleParams, PersonnelrecoveryTupleResponse } from './resources/personnelrecovery/personnelrecovery';
import { ReportAndActivities } from './resources/report-and-activities/report-and-activities';
import { RfEmitter, RfEmitterCountParams, RfEmitterCountResponse, RfEmitterCreateParams, RfEmitterGetParams, RfEmitterGetResponse, RfEmitterListParams, RfEmitterListResponse, RfEmitterListResponsesOffsetPage, RfEmitterQueryhelpResponse, RfEmitterTupleParams, RfEmitterTupleResponse, RfEmitterUpdateParams } from './resources/rf-emitter/rf-emitter';
import { SarObservation, SarObservationCountParams, SarObservationCountResponse, SarObservationCreateBulkParams, SarObservationCreateParams, SarObservationGetParams, SarObservationGetResponse, SarObservationListParams, SarObservationListResponse, SarObservationListResponsesOffsetPage, SarObservationQueryhelpResponse, SarObservationTupleParams, SarObservationTupleResponse, SarObservationUnvalidatedPublishParams } from './resources/sar-observation/sar-observation';
import { ScAllowableFileExtensionsResponse, ScAllowableFileMimesResponse, ScCopyParams, ScCopyResponse, ScDeleteParams, ScDownloadParams, ScFileDownloadParams, ScFileUploadParams, ScFileUploadResponse, ScHasWriteAccessParams, ScHasWriteAccessResponse, ScMoveParams, ScMoveResponse, ScRenameParams, ScSearchParams, ScSearchResponse, Scs, SearchCriterion, SearchLogicalCriterion } from './resources/scs/scs';
import { SensorMaintenance, SensorMaintenanceCountParams, SensorMaintenanceCountResponse, SensorMaintenanceCreateBulkParams, SensorMaintenanceCreateParams, SensorMaintenanceGetParams, SensorMaintenanceGetResponse, SensorMaintenanceListCurrentParams, SensorMaintenanceListCurrentResponse, SensorMaintenanceListCurrentResponsesOffsetPage, SensorMaintenanceListParams, SensorMaintenanceListResponse, SensorMaintenanceListResponsesOffsetPage, SensorMaintenanceQueryHelpResponse, SensorMaintenanceTupleParams, SensorMaintenanceTupleResponse, SensorMaintenanceUpdateParams } from './resources/sensor-maintenance/sensor-maintenance';
import { SensorPlan, SensorPlanCountParams, SensorPlanCountResponse, SensorPlanCreateParams, SensorPlanGetParams, SensorPlanGetResponse, SensorPlanListParams, SensorPlanListResponse, SensorPlanListResponsesOffsetPage, SensorPlanQueryhelpResponse, SensorPlanTupleParams, SensorPlanTupleResponse, SensorPlanUnvalidatedPublishParams, SensorPlanUpdateParams } from './resources/sensor-plan/sensor-plan';
import { Sensor, SensorCountParams, SensorCountResponse, SensorCreateParams, SensorGetParams, SensorGetResponse, SensorListParams, SensorListResponse, SensorListResponsesOffsetPage, SensorQueryhelpResponse, SensorTupleParams, SensorTupleResponse, SensorUpdateParams } from './resources/sensor/sensor';
import { Sgi, SgiCountParams, SgiCountResponse, SgiCreateBulkParams, SgiCreateParams, SgiGetDataByEffectiveAsOfDateParams, SgiGetDataByEffectiveAsOfDateResponse, SgiGetParams, SgiGetResponse, SgiListParams, SgiListResponse, SgiListResponsesOffsetPage, SgiQueryhelpResponse, SgiTupleParams, SgiTupleResponse, SgiUnvalidatedPublishParams, SgiUpdateParams } from './resources/sgi/sgi';
import { Sigact, SigactCountParams, SigactCountResponse, SigactCreateBulkParams, SigactListParams, SigactListResponse, SigactListResponsesOffsetPage, SigactQueryhelpResponse, SigactTupleParams, SigactTupleResponse, SigactUploadZipParams } from './resources/sigact/sigact';
import { SiteStatus, SiteStatusCountParams, SiteStatusCountResponse, SiteStatusCreateParams, SiteStatusGetParams, SiteStatusGetResponse, SiteStatusListParams, SiteStatusListResponse, SiteStatusListResponsesOffsetPage, SiteStatusQueryhelpResponse, SiteStatusTupleParams, SiteStatusTupleResponse, SiteStatusUpdateParams } from './resources/site-status/site-status';
import { Site, SiteCountParams, SiteCountResponse, SiteCreateParams, SiteGetParams, SiteGetResponse, SiteListParams, SiteListResponse, SiteListResponsesOffsetPage, SiteQueryhelpResponse, SiteTupleParams, SiteTupleResponse, SiteUpdateParams } from './resources/site/site';
import { SkyImagery, SkyImageryCountParams, SkyImageryCountResponse, SkyImageryFileGetParams, SkyImageryGetParams, SkyImageryGetResponse, SkyImageryListParams, SkyImageryListResponse, SkyImageryListResponsesOffsetPage, SkyImageryQueryhelpResponse, SkyImageryTupleParams, SkyImageryTupleResponse, SkyImageryUploadZipParams } from './resources/sky-imagery/sky-imagery';
import { SoiObservationSet, SoiObservationSetCountParams, SoiObservationSetCountResponse, SoiObservationSetCreateBulkParams, SoiObservationSetCreateParams, SoiObservationSetGetParams, SoiObservationSetListParams, SoiObservationSetListResponse, SoiObservationSetListResponsesOffsetPage, SoiObservationSetQueryhelpResponse, SoiObservationSetTupleParams, SoiObservationSetTupleResponse, SoiObservationSetUnvalidatedPublishParams } from './resources/soi-observation-set/soi-observation-set';
import { SortiePpr, SortiePprCountParams, SortiePprCountResponse, SortiePprCreateBulkParams, SortiePprCreateParams, SortiePprGetParams, SortiePprListParams, SortiePprListResponse, SortiePprListResponsesOffsetPage, SortiePprQueryhelpResponse, SortiePprTupleParams, SortiePprTupleResponse, SortiePprUnvalidatedPublishParams, SortiePprUpdateParams } from './resources/sortie-ppr/sortie-ppr';
import { SpaceEnvObservation, SpaceEnvObservationCountParams, SpaceEnvObservationCountResponse, SpaceEnvObservationCreateBulkParams, SpaceEnvObservationListParams, SpaceEnvObservationListResponse, SpaceEnvObservationListResponsesOffsetPage, SpaceEnvObservationQueryhelpResponse, SpaceEnvObservationTupleParams, SpaceEnvObservationTupleResponse, SpaceEnvObservationUnvalidatedPublishParams } from './resources/space-env-observation/space-env-observation';
import { StarCatalog, StarCatalogCountParams, StarCatalogCountResponse, StarCatalogCreateBulkParams, StarCatalogCreateParams, StarCatalogGetParams, StarCatalogGetResponse, StarCatalogListParams, StarCatalogListResponse, StarCatalogListResponsesOffsetPage, StarCatalogQueryhelpResponse, StarCatalogTupleParams, StarCatalogTupleResponse, StarCatalogUnvalidatedPublishParams, StarCatalogUpdateParams } from './resources/star-catalog/star-catalog';
import { StateVector, StateVectorAbridged, StateVectorAbridgedsOffsetPage, StateVectorCountParams, StateVectorCountResponse, StateVectorCreateBulkParams, StateVectorCreateParams, StateVectorGetParams, StateVectorIngest, StateVectorListParams, StateVectorQueryhelpResponse, StateVectorTupleParams, StateVectorTupleResponse, StateVectorUnvalidatedPublishParams } from './resources/state-vector/state-vector';
import { SupportingData } from './resources/supporting-data/supporting-data';
import { Swir, SwirCountParams, SwirCountResponse, SwirCreateBulkParams, SwirCreateParams, SwirGetParams, SwirListParams, SwirListResponse, SwirListResponsesOffsetPage, SwirQueryhelpResponse, SwirTupleParams, SwirTupleResponse } from './resources/swir/swir';
import { TaiUtc, TaiUtcCountParams, TaiUtcCountResponse, TaiUtcCreateParams, TaiUtcGetParams, TaiUtcListParams, TaiUtcListResponse, TaiUtcListResponsesOffsetPage, TaiUtcQueryhelpResponse, TaiUtcTupleParams, TaiUtcTupleResponse, TaiUtcUpdateParams } from './resources/tai-utc/tai-utc';
import { TdoaFdoa } from './resources/tdoa-fdoa/tdoa-fdoa';
import { TrackDetailCountParams, TrackDetailCountResponse, TrackDetailCreateBulkParams, TrackDetailListParams, TrackDetailListResponse, TrackDetailListResponsesOffsetPage, TrackDetailQueryhelpResponse, TrackDetailTupleParams, TrackDetailTupleResponse, TrackDetails } from './resources/track-details/track-details';
import { AltitudeBlocksIngest, PointOfContactIngest, RoutePointsIngest, TrackRoute, TrackRouteCountParams, TrackRouteCountResponse, TrackRouteCreateBulkParams, TrackRouteCreateParams, TrackRouteGetParams, TrackRouteIngest, TrackRouteListParams, TrackRouteListResponse, TrackRouteListResponsesOffsetPage, TrackRouteQueryhelpResponse, TrackRouteTupleParams, TrackRouteTupleResponse, TrackRouteUnvalidatedPublishParams, TrackRouteUpdateParams } from './resources/track-route/track-route';
import { Track, TrackCountParams, TrackCountResponse, TrackCreateBulkParams, TrackListParams, TrackListResponse, TrackListResponsesOffsetPage, TrackQueryhelpResponse, TrackTupleParams, TrackTupleResponse, TrackUnvalidatedPublishParams } from './resources/track/track';
import { WeatherData, WeatherDataCountParams, WeatherDataCountResponse, WeatherDataCreateBulkParams, WeatherDataCreateParams, WeatherDataGetParams, WeatherDataListParams, WeatherDataListResponse, WeatherDataListResponsesOffsetPage, WeatherDataQueryhelpResponse, WeatherDataTupleParams, WeatherDataTupleResponse, WeatherDataUnvalidatedPublishParams } from './resources/weather-data/weather-data';
import { WeatherReport, WeatherReportCountParams, WeatherReportCountResponse, WeatherReportCreateParams, WeatherReportGetParams, WeatherReportListParams, WeatherReportListResponse, WeatherReportListResponsesOffsetPage, WeatherReportQueryhelpResponse, WeatherReportTupleParams, WeatherReportTupleResponse, WeatherReportUnvalidatedPublishParams } from './resources/weather-report/weather-report';
...
export class Unifieddatalibrary {
  ...
  constructor({
    ...
    this.logLevel = parseLogLevel(options.logLevel, 'ClientOptions.logLevel', this) ?? parseLogLevel(readEnv('UNIFIEDDATALIBRARY_LOG'), 'process.env[\'UNIFIEDDATALIBRARY_LOG\']', this) ?? defaultLogLevel;
  ...
  protected validateHeaders({ values, nulls }: NullableHeaders) {
    ...
    throw new Error('Could not resolve authentication method. Expected either username, password or accessToken to be set. Or for one of the "Authorization" or "Authorization" headers to be explicitly omitted')
  }
...
export {
  AirOperations as AirOperations
};
...
export {
  ReportAndActivities as ReportAndActivities
};
...
export {
  SupportingData as SupportingData
};
