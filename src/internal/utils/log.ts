...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: Unifieddatalibrary): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: Unifieddatalibrary): Logger {
