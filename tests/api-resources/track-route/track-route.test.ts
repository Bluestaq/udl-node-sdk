...
describe('resource trackRoute', () => {
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.trackRoute.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    lastUpdateDate: '2024-09-17T16:00:00.123Z',
    source: 'Bluestaq',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.trackRoute.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    lastUpdateDate: '2024-09-17T16:00:00.123Z',
    source: 'Bluestaq',
  ...
  test('get: request options and params are passed correctly', async () => {
    ...
    await expect(client.trackRoute.get('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.trackRoute.tuple({ columns: 'columns', lastUpdateDate: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
