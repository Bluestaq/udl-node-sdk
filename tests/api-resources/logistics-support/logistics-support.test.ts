...
describe('resource logisticsSupport', () => {
  ...
  test('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.logisticsSupport.list({ firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('count: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.logisticsSupport.count({ firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Unifieddatalibrary.NotFoundError);
  });

  test('createBulk: only required params', async () => {
    const responsePromise = client.logisticsSupport.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    rptCreatedTime: '2023-07-13T13:47:00.123Z',
    source: 'Bluestaq',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.logisticsSupport.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    rptCreatedTime: '2023-07-13T13:47:00.123Z',
    source: 'Bluestaq',
  ...
  test('get: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.logisticsSupport.get('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Unifieddatalibrary.NotFoundError);
  });
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.logisticsSupport.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    rptCreatedTime: '2023-07-13T13:47:00.123Z',
    source: 'Bluestaq',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.logisticsSupport.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    rptCreatedTime: '2023-07-13T13:47:00.123Z',
    source: 'Bluestaq',
