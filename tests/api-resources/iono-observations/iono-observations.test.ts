...
describe('resource ionoObservations', () => {
  test('list: only required params', async () => {
    const responsePromise = client.ionoObservations.list({ startTimeUTC: '2019-12-27T18:11:19.117Z' });
  ...
  test('list: required and optional params', async () => {
    const response = await client.ionoObservations.list({
  ...
  test('count: only required params', async () => {
    const responsePromise = client.ionoObservations.count({ startTimeUTC: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('count: required and optional params', async () => {
    const response = await client.ionoObservations.count({
    startTimeUTC: '2019-12-27T18:11:19.117Z',
    firstResult: 0,
    maxResults: 0,
  });
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.ionoObservations.createBulk({ body: [{
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.ionoObservations.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    startTimeUTC: '2021-01-01T01:01:01.123456Z',
    ...
    parabolic: { description: 'Best-fit algorithm in NHPC software.', parabolicItems: [{
    f: 3.621,
    layer: 'E',
    y: 11.1,
    z: 110.2,
    ...
    shiftedChebyshev: { description: 'Best-fit Huang-Reinisch formalism based on shifted Chebyshev expansion.', shiftedChebyshevs: [{
    ...
    receiveCoordinates: [[45.5, 179.3, 35.6], [-80.2, -20.5, 43.2]],
    ...
    transmitCoordinates: [[45.5, 179.3, 35.6], [-80.2, -20.5, 43.2]],
  ...
  test('queryhelp', async () => {
    const responsePromise = client.ionoObservations.queryhelp();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.ionoObservations.tuple({ columns: 'columns', startTimeUTC: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('tuple: required and optional params', async () => {
    const response = await client.ionoObservations.tuple({
    columns: 'columns',
    startTimeUTC: '2019-12-27T18:11:19.117Z',
    firstResult: 0,
    maxResults: 0,
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.ionoObservations.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    startTimeUTC: '2021-01-01T01:01:01.123456Z',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.ionoObservations.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    startTimeUTC: '2021-01-01T01:01:01.123456Z',
