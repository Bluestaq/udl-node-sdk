...
describe('resource ionoObservations', () => {
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.ionoObservations.createBulk({
      body: [
        {
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.ionoObservations.createBulk({
      body: [
        {
          classificationMarking: 'U',
          dataMode: 'TEST',
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.ionoObservations.tuple({
      columns: 'columns',
      startTimeUTC: '2019-12-27T18:11:19.117Z',
    });
    const rawResponse = await responsePromise.asResponse();
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.ionoObservations.unvalidatedPublish({
      body: [
        {
          classificationMarking: 'U',
          dataMode: 'TEST',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.ionoObservations.unvalidatedPublish({
      body: [
        {
          classificationMarking: 'U',
          dataMode: 'TEST',
