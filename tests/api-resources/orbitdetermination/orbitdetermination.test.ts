...
describe('resource orbitdetermination', () => {
  ...
  test('create: required and optional params', async () => {
    ...
    msgTs: '2018-01-01T16:00:00.123456Z',
    obsAvailable: 376,
    obsUsed: 374,
    origin: 'THIRD_PARTY_DATASOURCE',
    origObjectId: 'ORIGOBJECT-ID',
  ...
  test('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.orbitdetermination.list({
    firstResult: 0,
    idOnOrbit: 'idOnOrbit',
    maxResults: 0,
  ...
  test('count: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.orbitdetermination.count({
    firstResult: 0,
    idOnOrbit: 'idOnOrbit',
    maxResults: 0,
    startTime: '2019-12-27T18:11:19.117Z',
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.orbitdetermination.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    endTime: '2023-08-28T15:20:21.247192Z',
    initialOD: false,
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.orbitdetermination.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    endTime: '2023-08-28T15:20:21.247192Z',
    initialOD: false,
  ...
  test('get: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.orbitdetermination.get('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Unifieddatalibrary.NotFoundError);
  });
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.orbitdetermination.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    endTime: '2023-08-28T15:20:21.247192Z',
    initialOD: false,
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.orbitdetermination.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    endTime: '2023-08-28T15:20:21.247192Z',
    initialOD: false,
