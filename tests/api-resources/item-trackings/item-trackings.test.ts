...
describe('resource itemTrackings', () => {
  ...
  test('get: request options and params are passed correctly', async () => {
    ...
    await expect(client.itemTrackings.get('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.itemTrackings.tuple({ columns: 'columns', ts: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.itemTrackings.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    scanCode: 'ABC1234',
    scannerId: '2051M',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.itemTrackings.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    scanCode: 'ABC1234',
    scannerId: '2051M',
