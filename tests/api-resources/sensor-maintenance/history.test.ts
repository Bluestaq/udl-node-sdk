...
describe('resource history', () => {
  ...
  test('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.sensorMaintenance.history.list({
    columns: 'columns',
  ...
  test('aodr: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.sensorMaintenance.history.aodr({
    columns: 'columns',
    endTime: '2019-12-27T18:11:19.117Z',
    firstResult: 0,
    maxResults: 0,
  ...
  test('count: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.sensorMaintenance.history.count({
    endTime: '2019-12-27T18:11:19.117Z',
    firstResult: 0,
    maxResults: 0,
    startTime: '2019-12-27T18:11:19.117Z',
