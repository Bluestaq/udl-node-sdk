...
describe('resource weatherReport', () => {
  ...
  test('get: request options and params are passed correctly', async () => {
    ...
    await expect(client.weatherReport.get('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.weatherReport.tuple({ columns: 'columns', obTime: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.weatherReport.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    lat: 56.12,
    lon: -156.6,
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.weatherReport.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    lat: 56.12,
    lon: -156.6,
