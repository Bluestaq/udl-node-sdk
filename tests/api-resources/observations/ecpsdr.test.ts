...
describe('resource ecpsdr', () => {
  ...
  test('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.observations.ecpsdr.retrieve('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.observations.ecpsdr.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    msgTime: '2018-01-01T16:00:00.123Z',
    source: 'Bluestaq',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.observations.ecpsdr.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    msgTime: '2018-01-01T16:00:00.123Z',
    source: 'Bluestaq',
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.observations.ecpsdr.tuple({ columns: 'columns', msgTime: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.observations.ecpsdr.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    msgTime: '2018-01-01T16:00:00.123Z',
    source: 'Bluestaq',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.observations.ecpsdr.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    msgTime: '2018-01-01T16:00:00.123Z',
    source: 'Bluestaq',
