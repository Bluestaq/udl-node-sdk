...
describe('resource passiveRadarObservation', () => {
  ...
  test('list: only required params', async () => {
    const responsePromise = client.observations.passiveRadarObservation.list({ obTime: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('count: only required params', async () => {
    const responsePromise = client.observations.passiveRadarObservation.count({ obTime: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.observations.passiveRadarObservation.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    obTime: '2023-01-24T23:35:26.518152Z',
    source: 'Bluestaq',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.observations.passiveRadarObservation.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    obTime: '2023-01-24T23:35:26.518152Z',
    source: 'Bluestaq',
  ...
  test('fileCreate: only required params', async () => {
    const responsePromise = client.observations.passiveRadarObservation.fileCreate({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    obTime: '2023-01-24T23:35:26.518152Z',
    source: 'Bluestaq',
  ...
  test('fileCreate: required and optional params', async () => {
    const response = await client.observations.passiveRadarObservation.fileCreate({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    obTime: '2023-01-24T23:35:26.518152Z',
    source: 'Bluestaq',
  ...
  test('get: request options and params are passed correctly', async () => {
    ...
    await expect(client.observations.passiveRadarObservation.get('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.observations.passiveRadarObservation.tuple({ columns: 'columns', obTime: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
