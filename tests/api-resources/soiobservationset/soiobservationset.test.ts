...
describe('resource soiobservationset', () => {
  ...
  test('list: required and optional params', async () => {
    const response = await client.soiobservationset.list({ startTime: '2019-12-27T18:11:19.117Z' });
  });
  ...
  test('count: required and optional params', async () => {
    const response = await client.soiobservationset.count({ startTime: '2019-12-27T18:11:19.117Z' });
  });
  ...
  test('get: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.soiobservationset.get('id', { path: '/_stainless_unknown_path' })).rejects.toThrow(
  ...
  test('queryhelp: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.soiobservationset.queryhelp({ path: '/_stainless_unknown_path' })).rejects.toThrow(
      Unifieddatalibrary.NotFoundError,
    );
  });
