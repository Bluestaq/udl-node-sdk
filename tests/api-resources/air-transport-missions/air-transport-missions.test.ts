...
describe('resource airTransportMissions', () => {
  ...
  test('create: required and optional params', async () => {
    ...
    requirements: [{
    bulkWeight: 1.3,
    ead: '2024-01-01T16:00:00.123Z',
    gdssReqId: '23a1fb67-cc2d-5ebe-6b99-68130cb1aa6c',
    lad: '2024-01-01T16:00:00.123Z',
    numAmbulatory: 10,
    numAttendant: 10,
    numLitter: 10,
    numPax: 44,
  ...
  test('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.airTransportMissions.retrieve('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.airTransportMissions.tuple({ columns: 'columns', createdAt: '2019-12-27' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
