...
describe('resource ais', () => {
  ...
  test('list: required and optional params', async () => {
    const response = await client.ais.list({
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.ais.createBulk({ body: [{
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.ais.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    ts: '2021-02-25T12:00:00.123456Z',
  ...
  test('tuple: required and optional params', async () => {
    const response = await client.ais.tuple({
    columns: 'columns',
    ts: '2019-12-27T18:11:19.117Z',
    firstResult: 0,
    maxResults: 0,
