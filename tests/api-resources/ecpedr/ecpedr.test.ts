...
describe('resource ecpedr', () => {
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.ecpedr.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    ecpedrMeasurements: [{ obType: 'FLUX', obUoM: '#/MeV/cm^2/sr/s' }],
    obTime: '2025-03-13T17:00:00.123456Z',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.ecpedr.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    ecpedrMeasurements: [{
    obType: 'FLUX',
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.ecpedr.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    ecpedrMeasurements: [{ obType: 'FLUX', obUoM: '#/MeV/cm^2/sr/s' }],
    obTime: '2025-03-13T17:00:00.123456Z',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.ecpedr.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    ecpedrMeasurements: [{
    obType: 'FLUX',
