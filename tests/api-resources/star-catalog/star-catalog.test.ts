...
describe('resource starCatalog', () => {
  ...
  test('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.starCatalog.list({
    dec: 0,
    firstResult: 0,
    maxResults: 0,
    ra: 0,
  ...
  test('count: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.starCatalog.count({
    dec: 0,
    firstResult: 0,
    maxResults: 0,
    ra: 0,
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.starCatalog.createBulk({ body: [{
    astrometryOrigin: 'GA',
    classificationMarking: 'U',
    csId: 12345,
    dataMode: 'TEST',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.starCatalog.createBulk({ body: [{
    astrometryOrigin: 'GA',
    classificationMarking: 'U',
    csId: 12345,
    dataMode: 'TEST',
  ...
  test('get: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.starCatalog.get('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Unifieddatalibrary.NotFoundError);
  });
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.starCatalog.unvalidatedPublish({ body: [{
    astrometryOrigin: 'GA',
    classificationMarking: 'U',
    csId: 12345,
    dataMode: 'TEST',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.starCatalog.unvalidatedPublish({ body: [{
    astrometryOrigin: 'GA',
    classificationMarking: 'U',
    csId: 12345,
    dataMode: 'TEST',
