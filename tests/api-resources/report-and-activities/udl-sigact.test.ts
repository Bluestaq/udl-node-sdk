...
describe('resource udlSigact', () => {
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.reportAndActivities.udlSigact.unvalidatedPublish({
      body: [
        {
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.reportAndActivities.udlSigact.unvalidatedPublish({
      body: [
        {
          classificationMarking: 'U',
          dataMode: 'TEST',
