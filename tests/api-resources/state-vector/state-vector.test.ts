...
describe('resource stateVector', () => {
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.stateVector.createBulk({
      body: [
        {
          classificationMarking: 'U',
          dataMode: 'TEST',
  ...
  test('get: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.stateVector.get('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }),
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.stateVector.unvalidatedPublish({
      body: [
        {
          classificationMarking: 'U',
          dataMode: 'TEST',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.stateVector.unvalidatedPublish({
      body: [
        {
          classificationMarking: 'U',
          dataMode: 'TEST',
