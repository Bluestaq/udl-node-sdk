...
describe('resource datalink', () => {
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.linkStatus.datalink.tuple({ columns: 'columns', startTime: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.linkStatus.datalink.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    opExName: 'DESERT WIND',
    originator: 'USCENTCOM',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.linkStatus.datalink.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    opExName: 'DESERT WIND',
    originator: 'USCENTCOM',
