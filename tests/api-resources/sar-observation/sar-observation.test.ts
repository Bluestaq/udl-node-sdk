...
describe('resource sarObservation', () => {
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.sarObservation.createBulk({ body: [{
    classificationMarking: 'U',
    collectionEnd: '2023-04-22T17:38:10.201770Z',
    collectionStart: '2023-04-22T17:35:00.123456Z',
    dataMode: 'TEST',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.sarObservation.createBulk({ body: [{
    classificationMarking: 'U',
    collectionEnd: '2023-04-22T17:38:10.201770Z',
    collectionStart: '2023-04-22T17:35:00.123456Z',
    dataMode: 'TEST',
  ...
  test('get: request options and params are passed correctly', async () => {
    ...
    await expect(client.sarObservation.get('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.sarObservation.tuple({ collectionStart: '2019-12-27T18:11:19.117Z', columns: 'columns' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.sarObservation.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    collectionEnd: '2023-04-22T17:38:10.201770Z',
    collectionStart: '2023-04-22T17:35:00.123456Z',
    dataMode: 'TEST',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.sarObservation.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    collectionEnd: '2023-04-22T17:38:10.201770Z',
    collectionStart: '2023-04-22T17:35:00.123456Z',
    dataMode: 'TEST',
