...
describe('resource gnssObservationset', () => {
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.gnssObservationset.createBulk({ body: [{
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.gnssObservationset.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    ts: '2022-01-01T00:00:00.123456Z',
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.gnssObservationset.tuple({ columns: 'columns', ts: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.gnssObservationset.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    ts: '2022-01-01T00:00:00.123456Z',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.gnssObservationset.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    ts: '2022-01-01T00:00:00.123456Z',
