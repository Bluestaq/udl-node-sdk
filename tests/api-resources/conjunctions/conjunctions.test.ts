...
describe('resource conjunctions', () => {
  ...
  test('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.conjunctions.retrieve('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.conjunctions.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    tca: '2021-01-01T01:01:01.123456Z',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.conjunctions.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    tca: '2021-01-01T01:01:01.123456Z',
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.conjunctions.tuple({ columns: 'columns', tca: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.conjunctions.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    tca: '2021-01-01T01:01:01.123456Z',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.conjunctions.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    tca: '2021-01-01T01:01:01.123456Z',
  ...
  test('uploadConjunctionDataMessage: only required params', async () => {
    const responsePromise = client.conjunctions.uploadConjunctionDataMessage(await toFile(Buffer.from('Example data'), 'README.md'), {
  ...
  test('uploadConjunctionDataMessage: required and optional params', async () => {
    const response = await client.conjunctions.uploadConjunctionDataMessage(await toFile(Buffer.from('Example data'), 'README.md'), {
    classification: 'classification',
    dataMode: 'REAL',
    filename: 'filename',
    source: 'source',
