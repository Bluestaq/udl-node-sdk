...
describe('resource calibration', () => {
  ...
  test('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.sensor.calibration.retrieve('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Unifieddatalibrary.NotFoundError);
  });

  test('list: only required params', async () => {
    const responsePromise = client.sensor.calibration.list({ startTime: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('list: required and optional params', async () => {
    const response = await client.sensor.calibration.list({
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.sensor.calibration.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    idSensor: '09f2c68c-5e24-4b72-9cc8-ba9b1efa82f0',
    source: 'Bluestaq',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.sensor.calibration.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    idSensor: '09f2c68c-5e24-4b72-9cc8-ba9b1efa82f0',
    source: 'Bluestaq',
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.sensor.calibration.tuple({ columns: 'columns', startTime: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.sensor.calibration.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    idSensor: '09f2c68c-5e24-4b72-9cc8-ba9b1efa82f0',
    source: 'Bluestaq',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.sensor.calibration.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    idSensor: '09f2c68c-5e24-4b72-9cc8-ba9b1efa82f0',
    source: 'Bluestaq',
