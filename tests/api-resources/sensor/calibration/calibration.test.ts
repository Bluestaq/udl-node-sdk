...
describe('resource calibration', () => {
  ...
  test('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.sensor.calibration.retrieve('id', { path: '/_stainless_unknown_path' }),
  ...
  test('count: required and optional params', async () => {
    const response = await client.sensor.calibration.count({ startTime: '2019-12-27T18:11:19.117Z' });
  });
  ...
  test('createBulkV2: only required params', async () => {
    const responsePromise = client.sensor.calibration.createBulkV2([
      {
        classificationMarking: 'U',
        dataMode: 'TEST',
        idSensor: '09f2c68c-5e24-4b72-9cc8-ba9b1efa82f0',
  ...
  test('createBulkV2: required and optional params', async () => {
    const response = await client.sensor.calibration.createBulkV2([
      {
        classificationMarking: 'U',
        dataMode: 'TEST',
        idSensor: '09f2c68c-5e24-4b72-9cc8-ba9b1efa82f0',
  ...
  test('query: required and optional params', async () => {
    const response = await client.sensor.calibration.query({ startTime: '2019-12-27T18:11:19.117Z' });
  });
  ...
  test('queryHelp: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.sensor.calibration.queryHelp({ path: '/_stainless_unknown_path' })).rejects.toThrow(
