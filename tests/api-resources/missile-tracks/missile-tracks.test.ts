...
describe('resource missileTracks', () => {
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.missileTracks.createBulk({ body: [{
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.missileTracks.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    ts: '2021-02-25T12:00:00.123456Z',
    ...
    callSign: 'Charlie',
    containment: 90.64,
    contextKeys: ['MsnID_DescLabel', 'msnVer', 'serVer', 'velTs', 'accelTs'],
    contextValues: ['MissionID Descriptive Label text', '1', '001.9b', '2024-06-07T14:17:39.234Z', '2024-06-07T14:17:39.123Z'],
    dropPtInd: true,
    emgInd: true,
    env: 'AIR',
    impactAlt: 0.02,
    ...
    lostTrkInd: false,
    maneuverEnd: '2021-01-01T01:01:15.456789Z',
    maneuverStart: '2021-01-01T01:01:01.123456Z',
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.missileTracks.tuple({ columns: 'columns', ts: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.missileTracks.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    ts: '2021-02-25T12:00:00.123456Z',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.missileTracks.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    ts: '2021-02-25T12:00:00.123456Z',
