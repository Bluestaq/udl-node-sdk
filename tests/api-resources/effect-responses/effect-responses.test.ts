...
describe('resource effectResponses', () => {
  ...
  test('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.effectResponses.retrieve('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.effectResponses.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    type: 'COA',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.effectResponses.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    type: 'COA',
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.effectResponses.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    type: 'COA',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.effectResponses.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    type: 'COA',
