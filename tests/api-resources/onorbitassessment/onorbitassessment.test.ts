...
describe('resource onorbitassessment', () => {
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.onorbitassessment.createBulk({ body: [{
    assmtTime: '2025-08-10T02:44:02.000Z',
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.onorbitassessment.createBulk({ body: [{
    assmtTime: '2025-08-10T02:44:02.000Z',
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
  ...
  test('get: request options and params are passed correctly', async () => {
    ...
    await expect(client.onorbitassessment.get('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.onorbitassessment.tuple({ assmtTime: '2019-12-27T18:11:19.117Z', columns: 'columns' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.onorbitassessment.unvalidatedPublish({ body: [{
    assmtTime: '2025-08-10T02:44:02.000Z',
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.onorbitassessment.unvalidatedPublish({ body: [{
    assmtTime: '2025-08-10T02:44:02.000Z',
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
