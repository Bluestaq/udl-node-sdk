...
describe('resource spaceEnvObservation', () => {
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.spaceEnvObservation.createBulk({ body: [{
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.spaceEnvObservation.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    obTime: '2023-06-07T14:17:39.653Z',
    source: 'Bluestaq',
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.spaceEnvObservation.tuple({ columns: 'columns', obTime: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.spaceEnvObservation.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    obTime: '2023-06-07T14:17:39.653Z',
    source: 'Bluestaq',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.spaceEnvObservation.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    obTime: '2023-06-07T14:17:39.653Z',
    source: 'Bluestaq',
