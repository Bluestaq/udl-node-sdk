...
describe('resource airspaceControlOrders', () => {
  ...
  test('retrieve: only required params', async () => {
    const responsePromise = client.airspaceControlOrders.retrieve({ path_id: 'id', body_id: 'id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('retrieve: required and optional params', async () => {
    const response = await client.airspaceControlOrders.retrieve({ path_id: 'id', body_id: 'id' });
  });
  ...
  test('list: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.airspaceControlOrders.list({ path: '/_stainless_unknown_path' })).rejects.toThrow(
  ...
  test('count: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.airspaceControlOrders.count({ path: '/_stainless_unknown_path' })).rejects.toThrow(
      Unifieddatalibrary.NotFoundError,
    );
  });
  ...
  test('queryHelp: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.airspaceControlOrders.queryHelp({ path: '/_stainless_unknown_path' }),
