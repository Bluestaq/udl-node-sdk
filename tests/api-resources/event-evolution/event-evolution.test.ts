...
describe('resource eventEvolution', () => {
  ...
  test('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.eventEvolution.retrieve('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('list: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.eventEvolution.list({
    eventId: 'eventId',
    firstResult: 0,
    maxResults: 0,
  ...
  test('count: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.eventEvolution.count({
    eventId: 'eventId',
    firstResult: 0,
    maxResults: 0,
    startTime: '2019-12-27T18:11:19.117Z',
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.eventEvolution.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    eventId: 'EVENT_ID',
    source: 'Bluestaq',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.eventEvolution.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    eventId: 'EVENT_ID',
    source: 'Bluestaq',
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.eventEvolution.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    eventId: 'EVENT_ID',
    source: 'Bluestaq',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.eventEvolution.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    eventId: 'EVENT_ID',
    source: 'Bluestaq',
