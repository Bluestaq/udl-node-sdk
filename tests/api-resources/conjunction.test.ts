...
describe('resource conjunction', () => {
  test('create: only required params', async () => {
    const responsePromise = client.conjunction.create({
  ...
  test('create: required and optional params', async () => {
    const response = await client.conjunction.create({
      classificationMarking: 'classificationMarking',
      dataMode: 'dataMode',
      source: 'source',
      tca: '2019-12-27T18:11:19.117Z',
  ...
  test('list: only required params', async () => {
    const responsePromise = client.conjunction.list({ tca: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('list: required and optional params', async () => {
    const response = await client.conjunction.list({ tca: '2019-12-27T18:11:19.117Z' });
  });

  test('count: only required params', async () => {
    const responsePromise = client.conjunction.count({ tca: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('count: required and optional params', async () => {
    const response = await client.conjunction.count({ tca: '2019-12-27T18:11:19.117Z' });
  });

  test('createBulk: only required params', async () => {
    const responsePromise = client.conjunction.createBulk([
      {
        classificationMarking: 'classificationMarking',
        dataMode: 'dataMode',
        source: 'source',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.conjunction.createBulk([
      {
        classificationMarking: 'classificationMarking',
        dataMode: 'dataMode',
        source: 'source',
  ...
  test('history: only required params', async () => {
    const responsePromise = client.conjunction.history({ tca: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('history: required and optional params', async () => {
    const response = await client.conjunction.history({
      tca: '2019-12-27T18:11:19.117Z',
      columns: 'columns',
    });
  });
