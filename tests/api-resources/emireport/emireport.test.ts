...
describe('resource emireport', () => {
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.emireport.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    isr: true,
    reportId: 'REPORT-ID',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.emireport.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    isr: true,
    reportId: 'REPORT-ID',
  ...
  test('get: request options and params are passed correctly', async () => {
    ...
    await expect(client.emireport.get('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.emireport.tuple({ columns: 'columns', reportTime: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.emireport.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    isr: true,
    reportId: 'REPORT-ID',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.emireport.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    isr: true,
    reportId: 'REPORT-ID',
