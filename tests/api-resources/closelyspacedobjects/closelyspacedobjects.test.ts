...
describe('resource closelyspacedobjects', () => {
  ...
  test('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.closelyspacedobjects.retrieve('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.closelyspacedobjects.createBulk({ body: [{
    classificationMarking: 'U',
    csoState: 'POSSIBLE',
    dataMode: 'TEST',
    eventStartTime: '2019-12-27T18:11:19.117Z',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.closelyspacedobjects.createBulk({ body: [{
    classificationMarking: 'U',
    csoState: 'POSSIBLE',
    dataMode: 'TEST',
    eventStartTime: '2019-12-27T18:11:19.117Z',
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.closelyspacedobjects.tuple({ columns: 'columns', eventStartTime: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.closelyspacedobjects.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    csoState: 'POSSIBLE',
    dataMode: 'TEST',
    eventStartTime: '2019-12-27T18:11:19.117Z',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.closelyspacedobjects.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    csoState: 'POSSIBLE',
    dataMode: 'TEST',
    eventStartTime: '2019-12-27T18:11:19.117Z',
