...
describe('resource track', () => {
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.track.createBulk({ body: [{
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.track.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    ts: '2021-06-07T14:17:39.653043Z',
    ...
    ecefAcc: [-0.0265, -0.2764, -0.1773],
    ecefPos: [-1273011.47, -48108810.77, 3979360.49],
    ecefVel: [25.635, -1.097, 57.373],
    eNUAcc: [0.0003, 0.014, 0.0003],
    eNUGroundVel: [1.23, 2.34, 3.45],
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.track.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    ts: '2021-06-07T14:17:39.653043Z',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.track.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    ts: '2021-06-07T14:17:39.653043Z',
