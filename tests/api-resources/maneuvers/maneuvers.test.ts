...
describe('resource maneuvers', () => {
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.maneuvers.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    eventStartTime: '2023-11-16T01:05:16.835689Z',
    source: 'Bluestaq',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.maneuvers.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    eventStartTime: '2023-11-16T01:05:16.835689Z',
    source: 'Bluestaq',
  ...
  test('get: request options and params are passed correctly', async () => {
    ...
    await expect(client.maneuvers.get('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.maneuvers.tuple({ columns: 'columns', eventStartTime: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.maneuvers.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    eventStartTime: '2023-11-16T01:05:16.835689Z',
    source: 'Bluestaq',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.maneuvers.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    eventStartTime: '2023-11-16T01:05:16.835689Z',
    source: 'Bluestaq',
