...
describe('resource sigact', () => {
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.sigact.createBulk({ body: [{
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.sigact.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    reportDate: '2018-01-01T16:00:00.123Z',
    source: 'Bluestaq',
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.sigact.tuple({ columns: 'columns', reportDate: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('uploadZip: only required params', async () => {
    const responsePromise = client.sigact.uploadZip({ file: await toFile(Buffer.from('Example data'), 'README.md') });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('uploadZip: required and optional params', async () => {
    const response = await client.sigact.uploadZip({ file: await toFile(Buffer.from('Example data'), 'README.md') });
  });
});
