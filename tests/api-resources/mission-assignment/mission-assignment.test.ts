...
describe('resource missionAssignment', () => {
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.missionAssignment.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    mad: 'MAD',
    source: 'Bluestaq',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.missionAssignment.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    mad: 'MAD',
    source: 'Bluestaq',
  ...
  test('get: request options and params are passed correctly', async () => {
    ...
    await expect(client.missionAssignment.get('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.missionAssignment.tuple({ columns: 'columns', ts: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
