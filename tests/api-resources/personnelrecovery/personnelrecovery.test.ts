...
describe('resource personnelrecovery', () => {
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.personnelrecovery.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    msgTime: '2021-10-15T16:00:00.123Z',
    pickupLat: 75.1234,
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.personnelrecovery.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    msgTime: '2021-10-15T16:00:00.123Z',
    pickupLat: 75.1234,
  ...
  test('fileCreate: only required params', async () => {
    const responsePromise = client.personnelrecovery.fileCreate({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    msgTime: '2021-10-15T16:00:00.123Z',
    pickupLat: 75.1234,
  ...
  test('fileCreate: required and optional params', async () => {
    const response = await client.personnelrecovery.fileCreate({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    msgTime: '2021-10-15T16:00:00.123Z',
    pickupLat: 75.1234,
  ...
  test('get: request options and params are passed correctly', async () => {
    ...
    await expect(client.personnelrecovery.get('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.personnelrecovery.tuple({ columns: 'columns', msgTime: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
