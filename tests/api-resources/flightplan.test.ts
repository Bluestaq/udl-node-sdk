...
describe('resource flightplan', () => {
  ...
  test('retrieve', async () => {
    const responsePromise = client.flightplan.retrieve('id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.flightplan.retrieve('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('update: required and optional params', async () => {
    const response = await client.flightplan.update('id', {
    arrAirfield: 'KCHS',
    classificationMarking: 'U',
    dataMode: 'TEST',
    depAirfield: 'KSLV',
  ...
  test('list: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.flightplan.list({ firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Unifieddatalibrary.NotFoundError);
  });
  ...
  test('count: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.flightplan.count({ firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Unifieddatalibrary.NotFoundError);
  });
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.flightplan.unvalidatedPublish({ body: [{
    arrAirfield: 'KCHS',
    classificationMarking: 'U',
    dataMode: 'TEST',
    depAirfield: 'KSLV',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.flightplan.unvalidatedPublish({ body: [{
    arrAirfield: 'KCHS',
    classificationMarking: 'U',
    dataMode: 'TEST',
    depAirfield: 'KSLV',
