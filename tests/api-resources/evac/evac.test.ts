...
describe('resource evac', () => {
  ...
  test('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.evac.retrieve('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.evac.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    pickupLat: 75.1234,
    pickupLon: 175.1234,
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.evac.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    pickupLat: 75.1234,
    pickupLon: 175.1234,
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.evac.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    pickupLat: 75.1234,
    pickupLon: 175.1234,
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.evac.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    pickupLat: 75.1234,
    pickupLon: 175.1234,
