...
describe('resource emitterGeolocation', () => {
  ...
  test('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.emitterGeolocation.retrieve('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.emitterGeolocation.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    signalOfInterestType: 'RF',
    source: 'Bluestaq',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.emitterGeolocation.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    signalOfInterestType: 'RF',
    source: 'Bluestaq',
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.emitterGeolocation.tuple({ columns: 'columns', startTime: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.emitterGeolocation.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    signalOfInterestType: 'RF',
    source: 'Bluestaq',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.emitterGeolocation.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    signalOfInterestType: 'RF',
    source: 'Bluestaq',
