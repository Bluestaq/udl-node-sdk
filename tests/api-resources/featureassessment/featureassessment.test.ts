...
describe('resource featureassessment', () => {
  ...
  test('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.featureassessment.retrieve('id', { path: '/_stainless_unknown_path' }),
  ...
  test('createBulkV2: only required params', async () => {
    const responsePromise = client.featureassessment.createBulkV2([
      {
        classificationMarking: 'U',
        dataMode: 'TEST',
        featureTs: '2024-06-22T17:53:06.123Z',
  ...
  test('createBulkV2: required and optional params', async () => {
    const response = await client.featureassessment.createBulkV2([
      {
        classificationMarking: 'U',
        dataMode: 'TEST',
        featureTs: '2024-06-22T17:53:06.123Z',
  ...
  test('queryHelp: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.featureassessment.queryHelp({ path: '/_stainless_unknown_path' })).rejects.toThrow(
