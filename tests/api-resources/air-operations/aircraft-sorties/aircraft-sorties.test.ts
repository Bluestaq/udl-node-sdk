...
describe('resource aircraftSorties', () => {
  ...
  test('list: only required params', async () => {
    const responsePromise = client.airOperations.aircraftSorties.list({ plannedDepTime: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('count: only required params', async () => {
    const responsePromise = client.airOperations.aircraftSorties.count({ plannedDepTime: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.airOperations.aircraftSorties.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    plannedDepTime: '2021-01-01T01:01:01.123Z',
    source: 'Bluestaq',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.airOperations.aircraftSorties.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    plannedDepTime: '2021-01-01T01:01:01.123Z',
    source: 'Bluestaq',
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.airOperations.aircraftSorties.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    plannedDepTime: '2021-01-01T01:01:01.123Z',
    source: 'Bluestaq',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.airOperations.aircraftSorties.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    plannedDepTime: '2021-01-01T01:01:01.123Z',
    source: 'Bluestaq',
