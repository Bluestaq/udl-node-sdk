...
describe('resource airspaceControlOrders', () => {
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.airOperations.airspaceControlOrders.unvalidatedPublish({ body: [{
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.airOperations.airspaceControlOrders.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    opExName: 'DESERT WIND',
    originator: 'USCENTCOM',
