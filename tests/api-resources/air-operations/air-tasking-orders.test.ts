...
describe('resource airTaskingOrders', () => {
  ...
  test('retrieve', async () => {
    const responsePromise = client.airOperations.airTaskingOrders.retrieve('id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.airOperations.airTaskingOrders.retrieve('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Unifieddatalibrary.NotFoundError);
  });

  test('list', async () => {
    const responsePromise = client.airOperations.airTaskingOrders.list();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('list: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.airOperations.airTaskingOrders.list({ firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Unifieddatalibrary.NotFoundError);
  });

  test('count', async () => {
    const responsePromise = client.airOperations.airTaskingOrders.count();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('count: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.airOperations.airTaskingOrders.count({ firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Unifieddatalibrary.NotFoundError);
  });

  test('queryHelp', async () => {
    const responsePromise = client.airOperations.airTaskingOrders.queryHelp();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.airOperations.airTaskingOrders.tuple({ columns: 'columns' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('tuple: required and optional params', async () => {
    const response = await client.airOperations.airTaskingOrders.tuple({
    columns: 'columns',
    firstResult: 0,
    maxResults: 0,
  });
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.airOperations.airTaskingOrders.unvalidatedPublish({ body: [{
    beginTs: '2023-10-25T12:00:00.123Z',
    classificationMarking: 'U',
    dataMode: 'TEST',
    opExerName: 'DESERT WIND',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.airOperations.airTaskingOrders.unvalidatedPublish({ body: [{
    beginTs: '2023-10-25T12:00:00.123Z',
    classificationMarking: 'U',
    dataMode: 'TEST',
    opExerName: 'DESERT WIND',
