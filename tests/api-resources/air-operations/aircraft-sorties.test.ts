...
describe('resource aircraftSorties', () => {
  test('create: only required params', async () => {
    const responsePromise = client.airOperations.aircraftSorties.create({
  ...
  test('create: required and optional params', async () => {
    const response = await client.airOperations.aircraftSorties.create({
      classificationMarking: 'U',
      dataMode: 'TEST',
      plannedDepTime: '2021-01-01T01:01:01.123Z',
      source: 'Bluestaq',
  ...
  test('list: only required params', async () => {
    const responsePromise = client.airOperations.aircraftSorties.list({
  ...
  test('list: required and optional params', async () => {
    const response = await client.airOperations.aircraftSorties.list({
      plannedDepTime: '2019-12-27T18:11:19.117Z',
      firstResult: 0,
      maxResults: 0,
    });
  ...
  test('count: only required params', async () => {
    const responsePromise = client.airOperations.aircraftSorties.count({
      plannedDepTime: '2019-12-27T18:11:19.117Z',
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test('count: required and optional params', async () => {
    const response = await client.airOperations.aircraftSorties.count({
      plannedDepTime: '2019-12-27T18:11:19.117Z',
      firstResult: 0,
      maxResults: 0,
    });
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.airOperations.aircraftSorties.createBulk({
      body: [
        {
          classificationMarking: 'U',
          dataMode: 'TEST',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.airOperations.aircraftSorties.createBulk({
      body: [
        {
          classificationMarking: 'U',
          dataMode: 'TEST',
  ...
  test('historyAodr: only required params', async () => {
    const responsePromise = client.airOperations.aircraftSorties.historyAodr({
      plannedDepTime: '2019-12-27T18:11:19.117Z',
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test('historyAodr: required and optional params', async () => {
    const response = await client.airOperations.aircraftSorties.historyAodr({
      plannedDepTime: '2019-12-27T18:11:19.117Z',
      columns: 'columns',
      firstResult: 0,
      maxResults: 0,
  ...
  test('historyCount: only required params', async () => {
    const responsePromise = client.airOperations.aircraftSorties.historyCount({
      plannedDepTime: '2019-12-27T18:11:19.117Z',
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test('historyCount: required and optional params', async () => {
    const response = await client.airOperations.aircraftSorties.historyCount({
      plannedDepTime: '2019-12-27T18:11:19.117Z',
      firstResult: 0,
      maxResults: 0,
    });
  ...
  test('historyQuery: only required params', async () => {
    const responsePromise = client.airOperations.aircraftSorties.historyQuery({
      plannedDepTime: '2019-12-27T18:11:19.117Z',
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test('historyQuery: required and optional params', async () => {
    const response = await client.airOperations.aircraftSorties.historyQuery({
      plannedDepTime: '2019-12-27T18:11:19.117Z',
      columns: 'columns',
      firstResult: 0,
      maxResults: 0,
