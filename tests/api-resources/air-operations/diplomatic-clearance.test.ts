...
describe('resource diplomaticClearance', () => {
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.airOperations.diplomaticClearance.unvalidatedPublish({ body: [{
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.airOperations.diplomaticClearance.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    firstDepDate: '2024-01-01T01:01:01.123Z',
    idMission: '0dba1363-2d09-49fa-a784-4bb4cbb1674a',
