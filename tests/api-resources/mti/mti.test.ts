...
describe('resource mti', () => {
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.mti.createBulk({ body: [{
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.mti.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    id: 'MTI-ID',
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.mti.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
  }] });
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.mti.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    id: 'MTI-ID',
