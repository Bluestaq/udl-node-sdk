...
describe('resource diplomaticClearance', () => {
  ...
  test('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.diplomaticClearance.retrieve('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.diplomaticClearance.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    firstDepDate: '2024-01-01T01:01:01.123Z',
    idMission: '0dba1363-2d09-49fa-a784-4bb4cbb1674a',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.diplomaticClearance.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    firstDepDate: '2024-01-01T01:01:01.123Z',
    idMission: '0dba1363-2d09-49fa-a784-4bb4cbb1674a',
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.diplomaticClearance.tuple({ columns: 'columns', firstDepDate: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
