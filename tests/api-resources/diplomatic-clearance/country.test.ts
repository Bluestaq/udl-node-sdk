...
describe('resource country', () => {
  ...
  test('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.diplomaticClearance.country.retrieve('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('list: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.diplomaticClearance.country.list({ firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Unifieddatalibrary.NotFoundError);
  });
  ...
  test('count: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.diplomaticClearance.country.count({ firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Unifieddatalibrary.NotFoundError);
  });

  test('createBulk: only required params', async () => {
    const responsePromise = client.diplomaticClearance.country.createBulk({ body: [{
    classificationMarking: 'U',
    countryCode: 'NL',
    dataMode: 'TEST',
    lastChangedDate: '2024-01-01T16:00:00.123Z',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.diplomaticClearance.country.createBulk({ body: [{
    classificationMarking: 'U',
    countryCode: 'NL',
    dataMode: 'TEST',
    lastChangedDate: '2024-01-01T16:00:00.123Z',
  ...
  test('tuple: required and optional params', async () => {
    const response = await client.diplomaticClearance.country.tuple({
    columns: 'columns',
    firstResult: 0,
    maxResults: 0,
  });
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.diplomaticClearance.country.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    countryCode: 'NL',
    dataMode: 'TEST',
    lastChangedDate: '2024-01-01T16:00:00.123Z',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.diplomaticClearance.country.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    countryCode: 'NL',
    dataMode: 'TEST',
    lastChangedDate: '2024-01-01T16:00:00.123Z',
