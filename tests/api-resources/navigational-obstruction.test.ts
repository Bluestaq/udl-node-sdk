...
describe('resource navigationalObstruction', () => {
  ...
  test('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.navigationalObstruction.list({
  ...
  test('count: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.navigationalObstruction.count({
    cycleDate: '2019-12-27',
    firstResult: 0,
    maxResults: 0,
    obstacleId: 'obstacleId',
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.navigationalObstruction.createBulk({ body: [{
    classificationMarking: 'U',
    cycleDate: '2024-06-13',
    dataMode: 'TEST',
    obstacleId: '359655',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.navigationalObstruction.createBulk({ body: [{
    classificationMarking: 'U',
    cycleDate: '2024-06-13',
    dataMode: 'TEST',
    obstacleId: '359655',
  ...
  test('get: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.navigationalObstruction.get('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Unifieddatalibrary.NotFoundError);
  });
