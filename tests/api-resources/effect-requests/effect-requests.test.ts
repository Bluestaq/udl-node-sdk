...
describe('resource effectRequests', () => {
  ...
  test('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.effectRequests.retrieve('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.effectRequests.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    effectList: ['COVER', 'DECEIVE'],
    source: 'Bluestaq',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.effectRequests.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    effectList: ['COVER', 'DECEIVE'],
    source: 'Bluestaq',
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.effectRequests.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    effectList: ['COVER', 'DECEIVE'],
    source: 'Bluestaq',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.effectRequests.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    effectList: ['COVER', 'DECEIVE'],
    source: 'Bluestaq',
