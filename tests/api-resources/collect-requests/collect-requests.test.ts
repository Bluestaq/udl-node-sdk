...
describe('resource collectRequests', () => {
  ...
  test('retrieve: only required params', async () => {
    const responsePromise = client.collectRequests.retrieve({ path_id: 'id', body_id: 'id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('retrieve: required and optional params', async () => {
    const response = await client.collectRequests.retrieve({ path_id: 'id', body_id: 'id' });
  });
  ...
  test('queryHelp: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.collectRequests.queryHelp({ path: '/_stainless_unknown_path' })).rejects.toThrow(
