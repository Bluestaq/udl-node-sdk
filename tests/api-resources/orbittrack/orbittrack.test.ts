...
describe('resource orbittrack', () => {
  ...
  test('list: required and optional params', async () => {
    const response = await client.orbittrack.list({
  ...
  test('count: required and optional params', async () => {
    const response = await client.orbittrack.count({
    ts: '2019-12-27T18:11:19.117Z',
    firstResult: 0,
    maxResults: 0,
  });
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.orbittrack.createBulk({ body: [{
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.orbittrack.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    lat: 19.88550102,
    lon: 46.74596844,
  ...
  test('tuple: required and optional params', async () => {
    const response = await client.orbittrack.tuple({
    columns: 'columns',
    ts: '2019-12-27T18:11:19.117Z',
    firstResult: 0,
    maxResults: 0,
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.orbittrack.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    lat: 19.88550102,
    lon: 46.74596844,
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.orbittrack.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    lat: 19.88550102,
    lon: 46.74596844,
