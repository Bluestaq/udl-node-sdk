...
describe('resource ephemeris', () => {
  test('create: only required params', async () => {
    const responsePromise = client.ephemeris.create({
      category: 'category',
  ...
  test('create: required and optional params', async () => {
    const response = await client.ephemeris.create({
      category: 'category',
      classification: 'classification',
      dataMode: 'REAL',
      ephemFormatType: 'ModITC',
  ...
  test('fileCreate: only required params', async () => {
    const responsePromise = client.ephemeris.fileCreate({
      category: 'ANALYST',
  ...
  test('fileCreate: required and optional params', async () => {
    const response = await client.ephemeris.fileCreate({
      category: 'ANALYST',
      classificationMarking: 'U',
      dataMode: 'REAL',
      numPoints: 1,
  ...
  test('queryhelp: request options instead of params are passed correctly', async () => {
    ...
    await expect(client.ephemeris.queryhelp({ path: '/_stainless_unknown_path' })).rejects.toThrow(
