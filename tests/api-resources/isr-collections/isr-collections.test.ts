...
describe('resource isrCollections', () => {
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.isrCollections.createBulk({ body: [{
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.isrCollections.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    id: 'ISRCOLLECTION-ID',
    ...
    country: 'VE',
    cridNumbers: 'CRID',
    criticalTimes: { earliestImagingTime: '2021-01-19T01:01:15.001Z', latestImagingTime: '2021-01-19T01:11:15.001Z' },
    emphasized: false,
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.isrCollections.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
  }] });
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.isrCollections.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    source: 'Bluestaq',
    id: 'ISRCOLLECTION-ID',
