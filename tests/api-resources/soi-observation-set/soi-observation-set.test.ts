...
describe('resource soiObservationSet', () => {
  ...
  test('create: required and optional params', async () => {
    ...
    declinationRates: [3.4, 2.2, 0.8],
    declinations: [-0.45, -0.45, -0.45],
    expDuration: 0.455,
    extinctionCoeffs: [0.32, 0.32, 0.32],
    extinctionCoeffsUnc: [0.06, 0.06, 0.06],
    intensities: [1.1, 1.1, 1.1],
    intensityTimes: ['2018-01-01T16:00:00.888456Z', '2018-01-01T16:00:00.898456Z', '2018-01-01T16:00:00.998456Z'],
  ...
  test('createBulk: only required params', async () => {
    const responsePromise = client.soiObservationSet.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    numObs: 1,
    source: 'Bluestaq',
  ...
  test('createBulk: required and optional params', async () => {
    const response = await client.soiObservationSet.createBulk({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    numObs: 1,
    source: 'Bluestaq',
  ...
  test('get: request options and params are passed correctly', async () => {
    ...
    await expect(client.soiObservationSet.get('id', { firstResult: 0, maxResults: 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('tuple: only required params', async () => {
    const responsePromise = client.soiObservationSet.tuple({ columns: 'columns', startTime: '2019-12-27T18:11:19.117Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('unvalidatedPublish: only required params', async () => {
    const responsePromise = client.soiObservationSet.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    numObs: 1,
    source: 'Bluestaq',
  ...
  test('unvalidatedPublish: required and optional params', async () => {
    const response = await client.soiObservationSet.unvalidatedPublish({ body: [{
    classificationMarking: 'U',
    dataMode: 'TEST',
    numObs: 1,
    source: 'Bluestaq',
